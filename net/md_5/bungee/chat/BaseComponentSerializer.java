...
/*     */     {
/*  46 */       component.setExtra(java.util.Arrays.asList((Object[])context.deserialize(object.get("extra"), BaseComponent[].class)));
/*     */     }
/*     */     
/*     */ 
...
/*     */       BaseComponent[] res;
/*  61 */       BaseComponent[] res; if (event.get("value").isJsonArray())
/*     */       {
...
/*     */     {
/*  80 */       first = true;
/*  81 */       ComponentSerializer.serializedComponents.set(new HashSet());
/*     */     }
/*     */     try
/*     */     {
/*  85 */       Preconditions.checkArgument(!((HashSet)ComponentSerializer.serializedComponents.get()).contains(component), "Component loop");
/*  86 */       ((HashSet)ComponentSerializer.serializedComponents.get()).add(component);
...
/* 123 */         object.add("clickEvent", clickEvent);
/*     */       }
...
/* 130 */         object.add("hoverEvent", hoverEvent);
/*     */       }
/*     */     }
/*     */     finally {

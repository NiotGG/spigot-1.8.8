...
/*     */ {
/*  15 */   public void setText(String text) { this.text = text; } @ConstructorProperties({"text"})
...
/*     */   {
/*  33 */     ArrayList<BaseComponent> components = new ArrayList();
...
/*     */           {
/*  98 */             TextComponent old = component;
/*  99 */             component = new TextComponent(old);
/* 100 */             old.setText(builder.toString());
/* 101 */             builder = new StringBuilder();
/* 102 */             components.add(old);
/*     */           }
/*     */           
...
/* 109 */           component.setClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "http://" + urlString));
/*     */           
...
/*     */     }
/*     */     
/* 130 */     return (BaseComponent[])components.toArray(new BaseComponent[components.size()]);
/*     */   }
/*     */   
/*     */ 
...
/*     */   {
/* 158 */     setText("");
/* 159 */     setExtra(new ArrayList(Arrays.asList(extras)));
/*     */   }
/*     */   
/*     */ 
/*     */ 

...
/*     */   {
/*  51 */     this((File)options.valueOf("config"));
/*     */     
/*  53 */     this.options = options;
/*     */   }
/*     */   
/*     */   private <T> T getOverride(String name, T value) {
/*  57 */     if ((this.options != null) && (this.options.has(name)) && (!name.equals("online-mode"))) {
/*  58 */       return (T)this.options.valueOf(name);
/*     */     }
/*     */     
/*  61 */     return value;
/*     */   }
...
/*     */   public void a()
/*     */   {
/*  66 */     a.info("Generating new properties file");
...
/* 103 */     if (!this.properties.containsKey(s)) {
/* 104 */       this.properties.setProperty(s, s1);
/* 105 */       savePropertiesFile();
/* 106 */       savePropertiesFile();
/*     */     }
/*     */     
/* 109 */     return (String)getOverride(s, this.properties.getProperty(s, s1));
/*     */   }
/*     */   
/*     */   public int getInt(String s, int i) {
/*     */     try {
/* 114 */       return ((Integer)getOverride(s, Integer.valueOf(Integer.parseInt(getString(s, i))))).intValue();
/*     */     } catch (Exception localException) {
/* 116 */       this.properties.setProperty(s, i);
/* 117 */       savePropertiesFile(); }
/* 118 */     return ((Integer)getOverride(s, Integer.valueOf(i))).intValue();
/*     */   }
/*     */   
/*     */   public long getLong(String s, long i)
/*     */   {
/*     */     try {
/* 124 */       return ((Long)getOverride(s, Long.valueOf(Long.parseLong(getString(s, i))))).longValue();
/*     */     } catch (Exception localException) {
/* 126 */       this.properties.setProperty(s, i);
/* 127 */       savePropertiesFile(); }
/* 128 */     return ((Long)getOverride(s, Long.valueOf(i))).longValue();
/*     */   }
/*     */   
/*     */   public boolean getBoolean(String s, boolean flag)
/*     */   {
/*     */     try {
/* 134 */       return ((Boolean)getOverride(s, Boolean.valueOf(Boolean.parseBoolean(getString(s, flag))))).booleanValue();
/*     */     } catch (Exception localException) {
/* 136 */       this.properties.setProperty(s, flag);
/* 137 */       savePropertiesFile(); }
/* 138 */     return ((Boolean)getOverride(s, Boolean.valueOf(flag))).booleanValue();
/*     */   }
/*     */   
/*     */   public void setProperty(String s, Object object)
/*     */   {
/* 143 */     this.properties.setProperty(s, object);
/*     */   }
/*     */ }


/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\net\minecraft\server\v1_8_R3\PropertyManager.class

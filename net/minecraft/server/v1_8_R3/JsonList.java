...
/*     */ {
/*  34 */   protected static final Logger a = ;
/*     */   protected final Gson b;
/*     */   private final File c;
/*  37 */   private final Map<String, V> d = Maps.newHashMap();
/*  38 */   private boolean e = true;
/*  39 */   private static final ParameterizedType f = new ParameterizedType() {
/*     */     public Type[] getActualTypeArguments() {
/*  41 */       return new Type[] { JsonListEntry.class };
/*     */     }
/*     */     
...
/*     */     
/*  57 */     gsonbuilder.registerTypeHierarchyAdapter(JsonListEntry.class, new JsonListEntrySerializer(null));
/*  58 */     this.b = gsonbuilder.create();
/*     */   }
/*     */   
...
/*  74 */     this.d.put(a(v0.getKey()), v0);
/*     */     try
/*     */     {
/*  77 */       save();
/*     */     } catch (IOException ioexception) {
/*  79 */       a.warn("Could not save the list after adding a user.", ioexception);
/*     */     }
/*     */   }
/*     */   
/*     */   public V get(K k0)
/*     */   {
/*  85 */     h();
/*  86 */     return (JsonListEntry)this.d.get(a(k0));
/*     */   }
/*     */   
/*     */   public void remove(K k0) {
/*  90 */     this.d.remove(a(k0));
/*     */     try
/*     */     {
/*  93 */       save();
/*     */     } catch (IOException ioexception) {
/*  95 */       a.warn("Could not save the list after removing a user.", ioexception);
/*     */     }
/*     */   }
/*     */   
/*     */   public String[] getEntries()
/*     */   {
/* 101 */     return (String[])this.d.keySet().toArray(new String[this.d.size()]);
/*     */   }
/*     */   
/*     */   public Collection<V> getValues()
/*     */   {
/* 106 */     return this.d.values();
/*     */   }
/*     */   
/*     */   public boolean isEmpty()
/*     */   {
/* 111 */     return this.d.size() < 1;
/*     */   }
/*     */   
/*     */   protected String a(K k0) {
/* 115 */     return k0.toString();
/*     */   }
/*     */   
/*     */   protected boolean d(K k0) {
/* 119 */     return this.d.containsKey(a(k0));
/*     */   }
/*     */   
/*     */   private void h() {
/* 123 */     ArrayList arraylist = Lists.newArrayList();
/* 124 */     Iterator iterator = this.d.values().iterator();
/*     */     
/* 126 */     while (iterator.hasNext()) {
/* 127 */       JsonListEntry jsonlistentry = (JsonListEntry)iterator.next();
/*     */       
/* 129 */       if (jsonlistentry.hasExpired()) {
/* 130 */         arraylist.add(jsonlistentry.getKey());
/*     */       }
/*     */     }
/*     */     
/* 134 */     iterator = arraylist.iterator();
/*     */     
/* 136 */     while (iterator.hasNext()) {
/* 137 */       Object object = iterator.next();
/*     */       
/* 139 */       this.d.remove(object);
/*     */     }
/*     */   }
/*     */   
/*     */   protected JsonListEntry<K> a(JsonObject jsonobject)
/*     */   {
/* 145 */     return new JsonListEntry(null, jsonobject);
/*     */   }
/*     */   
...
/* 217 */         JsonListEntry jsonlistentry = JsonList.this.a(jsonobject);
/*     */         
/* 219 */         return jsonlistentry;
/*     */       }
/* 221 */       return null;
/*     */     }
/*     */     
...
/*     */     {
/* 226 */       return a(object, type, jsonserializationcontext);
/*     */     }
/*     */     
...
/* 230 */       return a(jsonelement, type, jsondeserializationcontext);
/*     */     }
/*     */     
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\net\minecraft\server\v1_8_R3\JsonList.class

...
/*  478 */       return false;
/*      */     }
/*  480 */     int tmp17_16 = index; byte[] tmp17_13 = this._values;tmp17_13[tmp17_16] = ((byte)(tmp17_13[tmp17_16] + amount));
/*  481 */     return true;
/*      */   }
/*      */   
/*      */ 
...
/*      */     {
/*  515 */       return new TShortByteHashMap.TShortByteKeyHashIterator(TShortByteHashMap.this, TShortByteHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  807 */       return new TShortByteHashMap.TShortByteValueHashIterator(TShortByteHashMap.this, TShortByteHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */       
/* 1233 */       public boolean execute(short key, byte value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TShortByteHashMap.class

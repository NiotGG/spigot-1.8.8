...
/*  478 */       return false;
/*      */     }
/*  480 */     int tmp20_18 = index; byte[] tmp20_15 = this._values;tmp20_15[tmp20_18] = ((byte)(tmp20_15[tmp20_18] + amount));
/*  481 */     return true;
/*      */   }
/*      */   
/*      */ 
...
/*  493 */         tmp25_23 = index; byte[] tmp25_20 = this._values;byte newValue = tmp25_20[tmp25_23] = (byte)(tmp25_20[tmp25_23] + adjust_amount);
...
/*      */     {
/*  515 */       return new TDoubleByteHashMap.TDoubleByteKeyHashIterator(TDoubleByteHashMap.this, TDoubleByteHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  807 */       return new TDoubleByteHashMap.TDoubleByteValueHashIterator(TDoubleByteHashMap.this, TDoubleByteHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */       
/* 1233 */       public boolean execute(double key, byte value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TDoubleByteHashMap.class

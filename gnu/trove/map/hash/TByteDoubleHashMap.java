...
/*      */     {
/*  515 */       return new TByteDoubleHashMap.TByteDoubleKeyHashIterator(TByteDoubleHashMap.this, TByteDoubleHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  807 */       return new TByteDoubleHashMap.TByteDoubleValueHashIterator(TByteDoubleHashMap.this, TByteDoubleHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */       
/* 1233 */       public boolean execute(byte key, double value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TByteDoubleHashMap.class

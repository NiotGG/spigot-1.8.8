...
/*      */     {
/*  515 */       return new TByteFloatHashMap.TByteFloatKeyHashIterator(TByteFloatHashMap.this, TByteFloatHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  807 */       return new TByteFloatHashMap.TByteFloatValueHashIterator(TByteFloatHashMap.this, TByteFloatHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */       
/* 1233 */       public boolean execute(byte key, float value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TByteFloatHashMap.class

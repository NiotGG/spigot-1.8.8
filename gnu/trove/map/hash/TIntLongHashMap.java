...
/*      */     {
/*  515 */       return new TIntLongHashMap.TIntLongKeyHashIterator(TIntLongHashMap.this, TIntLongHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  807 */       return new TIntLongHashMap.TIntLongValueHashIterator(TIntLongHashMap.this, TIntLongHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */       
/* 1233 */       public boolean execute(int key, long value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TIntLongHashMap.class

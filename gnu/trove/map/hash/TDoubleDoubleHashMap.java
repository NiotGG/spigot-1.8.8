...
/*  492 */       index = -index - 1;
/*  493 */       double newValue = this._values[index] += adjust_amount;
...
/*      */     {
/*  515 */       return new TDoubleDoubleHashMap.TDoubleDoubleKeyHashIterator(TDoubleDoubleHashMap.this, TDoubleDoubleHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     public TDoubleIterator iterator()
/*      */     {
/*  807 */       return new TDoubleDoubleHashMap.TDoubleDoubleValueHashIterator(TDoubleDoubleHashMap.this, TDoubleDoubleHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public double getNoEntryValue()
...
/*      */       
/* 1233 */       public boolean execute(double key, double value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TDoubleDoubleHashMap.class

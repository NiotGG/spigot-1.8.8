...
/*     */     
/* 133 */     this._values = ((Object[])new Object[capacity]);
/* 134 */     return capacity;
/*     */   }
/*     */   
/*     */ 
...
/* 148 */     return (V)doPut(value, index);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 163 */     if (index < 0) {
/* 164 */       return (V)this._values[(-index - 1)];
/*     */     }
/* 166 */     return (V)doPut(value, index);
/*     */   }
/*     */   
...
/* 199 */       return false;
/*     */     }
/* 201 */     Map<K, V> that = (Map)other;
/* 202 */     if (that.size() != size()) {
/* 203 */       return false;
/*     */     }
/* 205 */     return forEachEntry(new EqProcedure(that));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
/* 210 */     TCustomHashMap<K, V>.HashProcedure p = new HashProcedure(null);
/* 211 */     forEachEntry(p);
...
/* 218 */     forEachEntry(new TObjectObjectProcedure() {
/* 219 */       private boolean first = true;
/*     */       
...
/* 375 */         values[i] = function.execute(values[i]);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* 395 */     this._values = ((Object[])new Object[newCapacity]);
/*     */     
/*     */ 
/*     */ 
...
/* 422 */       return null;
/*     */     }
/* 424 */     return (V)this._values[index];
/*     */   }
/*     */   
/*     */ 
/*     */   public void clear()
...
/* 437 */     Arrays.fill(this._values, 0, this._values.length, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 561 */       new TObjectHashIterator(TCustomHashMap.this) {
/*     */         protected V objectAtIndex(int index) {
/* 563 */           return (V)TCustomHashMap.this._values[index];
/*     */         }
/*     */       };
/*     */     }
/*     */     
...
/*     */     {
/* 575 */       Object[] values = TCustomHashMap.this._values;
/* 576 */       Object[] set = TCustomHashMap.this._set;
/*     */       
/* 578 */       for (int i = values.length; i-- > 0;) {
/* 579 */         if (((set[i] != TObjectHash.FREE) && (set[i] != TObjectHash.REMOVED) && (value == values[i])) || ((null != values[i]) && (TCustomHashMap.this.strategy.equals(values[i], value))))
/*     */         {
/*     */ 
/*     */ 
...
/* 593 */     protected EntryView() { super(null); }
/*     */     
...
/*     */       {
/* 604 */         return new TCustomHashMap.Entry(TCustomHashMap.this, TCustomHashMap.this._set[index], TCustomHashMap.this._values[index], index);
/*     */       }
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 611 */       return new EntryIterator(TCustomHashMap.this);
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 651 */       return (V)entry.getValue();
/*     */     }
/*     */     
/*     */     protected K keyForEntry(Map.Entry<K, V> entry)
/*     */     {
/* 656 */       return (K)entry.getKey();
/*     */     }
/*     */   }
/*     */   
...
/*     */     {
/* 674 */       return containsElement(key);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean remove(Object o)
/*     */     {
/* 680 */       return removeElement(o);
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/* 723 */         a = (Object[])Array.newInstance(a.getClass().getComponentType(), size);
/*     */       }
/*     */       
/* 726 */       Iterator<E> it = iterator();
/* 727 */       Object[] result = a;
/* 728 */       for (int i = 0; i < size; i++) {
/* 729 */         result[i] = it.next();
/*     */       }
/*     */       
...
/* 779 */     protected KeyView() { super(null); }
/*     */     
/*     */     public Iterator<K> iterator()
/*     */     {
/* 783 */       return new TObjectHashIterator(TCustomHashMap.this);
/*     */     }
/*     */     
...
/*     */     public K getKey()
/*     */     {
/* 812 */       return (K)this.key;
/*     */     }
/*     */     
/*     */     public V getValue()
/*     */     {
/* 817 */       return (V)this.val;
/*     */     }
/*     */     
...
/* 895 */     while (size-- > 0)
/*     */     {
/* 897 */       K key = in.readObject();
/*     */       
/* 899 */       V val = in.readObject();
/* 900 */       put(key, val);
/*     */     }
/*     */   }
/*     */ }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TCustomHashMap.class

...
/*      */     {
/*  515 */       return new TFloatByteHashMap.TFloatByteKeyHashIterator(TFloatByteHashMap.this, TFloatByteHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  807 */       return new TFloatByteHashMap.TFloatByteValueHashIterator(TFloatByteHashMap.this, TFloatByteHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */       
/* 1233 */       public boolean execute(float key, byte value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TFloatByteHashMap.class

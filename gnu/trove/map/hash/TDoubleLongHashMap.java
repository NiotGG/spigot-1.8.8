...
/*  492 */       index = -index - 1;
/*  493 */       long newValue = this._values[index] += adjust_amount;
...
/*      */     {
/*  515 */       return new TDoubleLongHashMap.TDoubleLongKeyHashIterator(TDoubleLongHashMap.this, TDoubleLongHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  807 */       return new TDoubleLongHashMap.TDoubleLongValueHashIterator(TDoubleLongHashMap.this, TDoubleLongHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */       
/* 1233 */       public boolean execute(double key, long value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TDoubleLongHashMap.class

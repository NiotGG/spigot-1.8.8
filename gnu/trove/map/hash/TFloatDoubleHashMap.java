...
/*      */     {
/*  515 */       return new TFloatDoubleHashMap.TFloatDoubleKeyHashIterator(TFloatDoubleHashMap.this, TFloatDoubleHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  807 */       return new TFloatDoubleHashMap.TFloatDoubleValueHashIterator(TFloatDoubleHashMap.this, TFloatDoubleHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */       
/* 1233 */       public boolean execute(float key, double value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TFloatDoubleHashMap.class

...
/*      */     {
/*  515 */       return new TByteByteHashMap.TByteByteKeyHashIterator(TByteByteHashMap.this, TByteByteHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     public TByteIterator iterator()
/*      */     {
/*  807 */       return new TByteByteHashMap.TByteByteValueHashIterator(TByteByteHashMap.this, TByteByteHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public byte getNoEntryValue()
...
/*      */       
/* 1233 */       public boolean execute(byte key, byte value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TByteByteHashMap.class

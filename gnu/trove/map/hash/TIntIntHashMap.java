...
/*      */     {
/*  515 */       return new TIntIntHashMap.TIntIntKeyHashIterator(TIntIntHashMap.this, TIntIntHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     public TIntIterator iterator()
/*      */     {
/*  807 */       return new TIntIntHashMap.TIntIntValueHashIterator(TIntIntHashMap.this, TIntIntHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int getNoEntryValue()
...
/*      */       
/* 1233 */       public boolean execute(int key, int value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TIntIntHashMap.class

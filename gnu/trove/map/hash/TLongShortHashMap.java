...
/*      */     {
/*  515 */       return new TLongShortHashMap.TLongShortKeyHashIterator(TLongShortHashMap.this, TLongShortHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  807 */       return new TLongShortHashMap.TLongShortValueHashIterator(TLongShortHashMap.this, TLongShortHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */       
/* 1233 */       public boolean execute(long key, short value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TLongShortHashMap.class

...
/*      */     {
/*  515 */       return new TByteLongHashMap.TByteLongKeyHashIterator(TByteLongHashMap.this, TByteLongHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  807 */       return new TByteLongHashMap.TByteLongValueHashIterator(TByteLongHashMap.this, TByteLongHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */       
/* 1233 */       public boolean execute(byte key, long value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TByteLongHashMap.class

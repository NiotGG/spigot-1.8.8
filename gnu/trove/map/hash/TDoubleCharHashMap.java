...
/*  478 */       return false;
/*      */     }
/*  480 */     int tmp20_18 = index; char[] tmp20_15 = this._values;tmp20_15[tmp20_18] = ((char)(tmp20_15[tmp20_18] + amount));
/*  481 */     return true;
/*      */   }
/*      */   
/*      */ 
...
/*      */     {
/*  515 */       return new TDoubleCharHashMap.TDoubleCharKeyHashIterator(TDoubleCharHashMap.this, TDoubleCharHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  807 */       return new TDoubleCharHashMap.TDoubleCharValueHashIterator(TDoubleCharHashMap.this, TDoubleCharHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */       
/* 1233 */       public boolean execute(double key, char value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TDoubleCharHashMap.class

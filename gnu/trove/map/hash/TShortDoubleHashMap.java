...
/*      */     {
/*  515 */       return new TShortDoubleHashMap.TShortDoubleKeyHashIterator(TShortDoubleHashMap.this, TShortDoubleHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  807 */       return new TShortDoubleHashMap.TShortDoubleValueHashIterator(TShortDoubleHashMap.this, TShortDoubleHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */       
/* 1233 */       public boolean execute(short key, double value) { if (this.first) this.first = false; else {
/* 1234 */           buf.append(", ");
/*      */         }
/* 1236 */         buf.append(key);
/* 1237 */         buf.append("=");
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\map\hash\TShortDoubleHashMap.class

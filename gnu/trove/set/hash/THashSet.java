...
/*     */   public int hashCode()
/*     */   {
/* 131 */     THashSet<E>.HashProcedure p = new HashProcedure(null);
/* 132 */     forEach(p);
...
/* 190 */     forEach(new ToObjectArrayProceedure(result));
/* 191 */     return result;
/*     */   }
/*     */   
/*     */ 
...
/* 205 */       a = (Object[])Array.newInstance(a.getClass().getComponentType(), size);
/*     */     }
/*     */     
/* 208 */     forEach(new ToObjectArrayProceedure(a));
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/* 335 */     int size = size();
/* 336 */     Iterator<E> it = iterator();
/* 337 */     while (size-- > 0) {
/* 338 */       if (!collection.contains(it.next())) {
/* 339 */         it.remove();
/* 340 */         changed = true;
/*     */       }
/*     */     }
...
/* 349 */     forEach(new TObjectProcedure() {
/* 350 */       private boolean first = true;
/*     */       
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\set\hash\THashSet.class

...
/*     */   {
/*  75 */     this.order = new TIntArrayList(initialCapacity)
/*     */     {
/*     */ 
/*     */ 
...
/*     */     
/* 109 */     for (Iterator<E> it = iterator(); it.hasNext();) {
/* 110 */       if (first) {
/* 111 */         first = false;
/*     */       } else {
/* 113 */         buf.append(", ");
...
/*     */     throws IOException
/*     */   {
/* 216 */     TLinkedHashSet<E>.WriteProcedure writeProcedure = new WriteProcedure(out);
...
/*     */   {
/* 229 */     new TObjectHashIterator(this) {
...
/*     */   {
/* 316 */     TLinkedHashSet<E>.ForEachProcedure forEachProcedure = new ForEachProcedure(this._set, procedure);
/* 317 */     return this.order.forEach(forEachProcedure);
/*     */   }
/*     */ }


/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\set\hash\TLinkedHashSet.class

...
/*     */     
/* 165 */     int i = states.length; for (int j = 0; i-- > 0;) {
/* 166 */       if (states[i] == 1) {
/* 167 */         result[(j++)] = set[i];
/*     */       }
/*     */     }
...
/*     */     
/* 179 */     int i = states.length; for (int j = 0; i-- > 0;) {
/* 180 */       if (states[i] == 1) {
/* 181 */         dest[(j++)] = set[i];
/*     */       }
/*     */     }
...
/* 457 */     buffy.append("{");
/* 458 */     int i = this._states.length; for (int j = 1; i-- > 0;) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\set\hash\TDoubleHashSet.class

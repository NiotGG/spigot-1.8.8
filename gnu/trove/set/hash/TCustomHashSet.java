...
/*     */   public int hashCode()
/*     */   {
/* 139 */     TCustomHashSet<E>.HashProcedure p = new HashProcedure(null);
/* 140 */     forEach(p);
...
/* 193 */     forEach(new ToObjectArrayProceedure(result));
/* 194 */     return result;
/*     */   }
/*     */   
/*     */ 
...
/* 208 */       a = (Object[])Array.newInstance(a.getClass().getComponentType(), size);
/*     */     }
/*     */     
/* 211 */     forEach(new ToObjectArrayProceedure(a));
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/* 262 */     return new TObjectHashIterator(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 336 */     int size = size();
/* 337 */     Iterator<E> it = iterator();
/* 338 */     while (size-- > 0) {
/* 339 */       if (!collection.contains(it.next())) {
/* 340 */         it.remove();
/* 341 */         changed = true;
/*     */       }
/*     */     }
...
/* 350 */     forEach(new TObjectProcedure() {
/* 351 */       private boolean first = true;
/*     */       
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\set\hash\TCustomHashSet.class

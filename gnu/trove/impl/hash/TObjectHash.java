...
/*  54 */   public static final Object FREE = new Object(); public static final Object REMOVED = new Object();
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 168 */     int hash = hash(obj) & 0x7FFFFFFF;
...
/*     */     }
/* 280 */     int hash = hash(key) & 0x7FFFFFFF;
...
/* 571 */     return (o == null ? "class null" : o.getClass()) + " id= " + System.identityHashCode(o) + " hashCode= " + (o == null ? 0 : o.hashCode()) + " toString= " + String.valueOf(o);
/*     */   }
/*     */   
/*     */   private String dumpKeyTypes(Object newVal, Object oldVal)
/*     */   {
/* 576 */     StringBuilder buf = new StringBuilder();
/* 577 */     Set<Class<?>> types = new HashSet();
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\impl\hash\TObjectHash.class

...
/*  67 */   public double get(int key) { return this.m.get(key); }
/*     */   
...
/*  72 */   public void putAll(Map<? extends Integer, ? extends Double> map) { throw new UnsupportedOperationException(); }
...
/* 127 */   public boolean adjustValue(int key, double amount) { throw new UnsupportedOperationException(); }
/* 128 */   public double adjustOrPutValue(int key, double adjust_amount, double put_amount) { throw new UnsupportedOperationException(); }
/*     */ }


/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\impl\unmodifiable\TUnmodifiableIntDoubleMap.class

...
/*     */   }
/*     */   
/*  64 */   public TSynchronizedIntList(TIntList list, Object mutex) { super(list, mutex);
/*  65 */     this.list = list;
/*     */   }
/*     */   
/*     */   /* Error */
...
/*     */     } }
/*     */   
/*  85 */   public void set(int offset, int[] values, int valOffset, int length) { synchronized (this.mutex) { this.list.set(offset, values, valOffset, length);
/*     */     }
/*     */   }
/*     */   
/*     */   /* Error */
...
/*     */     } }
/*     */   
/* 102 */   public void add(int[] vals, int offset, int length) { synchronized (this.mutex) { this.list.add(vals, offset, length);
/*     */     }
/*     */   }
/*     */   
/* 106 */   public void insert(int offset, int value) { synchronized (this.mutex) { this.list.insert(offset, value);
/*     */     } }
/*     */   
/* 109 */   public void insert(int offset, int[] values) { synchronized (this.mutex) { this.list.insert(offset, values);
/*     */     } }
/*     */   
/* 112 */   public void insert(int offset, int[] values, int valOffset, int len) { synchronized (this.mutex) { this.list.insert(offset, values, valOffset, len);
/*     */     }
/*     */   }
/*     */   
/*     */   /* Error */
...
/*     */     } }
/*     */   
/* 158 */   public void fill(int fromIndex, int toIndex, int val) { synchronized (this.mutex) { this.list.fill(fromIndex, toIndex, val);
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/* 218 */     return (this.list instanceof RandomAccess) ? new TSynchronizedRandomAccessIntList(this.list) : this;
/*     */   }
/*     */ }


/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\gnu\trove\impl\sync\TSynchronizedIntList.class

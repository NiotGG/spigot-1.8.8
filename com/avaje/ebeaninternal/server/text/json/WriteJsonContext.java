...
/* 145 */       return (JsonWriteBeanVisitor)this.visitorMap.get(path);
/*     */     }
/* 147 */     return null;
/*     */   }
/*     */   
...
/*     */   }
/*     */   
/* 170 */   public void appendObjectEnd() { this.buffer.append("}"); }
/*     */   
...
/* 178 */     this.depthOffset += 1;
/*     */   }
/*     */   
/*     */   public void appendArrayEnd() {
/* 182 */     this.depthOffset -= 1;
/* 183 */     if (this.pretty) {
/* 184 */       appendIndent();
/*     */     }
...
/* 198 */     this.depthOffset += 1;
/* 199 */     internalAppendKeyBegin(key);
/* 200 */     appendNull();
/* 201 */     this.depthOffset -= 1;
/*     */   }
/*     */   
...
/*     */     
/* 229 */     this.depthOffset -= 1;
/* 230 */     internalAppendKeyBegin(key);
/* 231 */     this.depthOffset += 1;
...
/*     */     
/* 239 */     if (this.pretty) {
/* 240 */       this.depthOffset -= 1;
/* 241 */       appendIndent();
/* 242 */       this.depthOffset += 1;
/*     */     }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\text\json\WriteJsonContext.class

...
/*     */   {
/*  84 */     this.currentState = new ReadBeanState(bean, beanDescriptor, null);
...
/*  94 */       JsonReadBeanVisitor<?> beanVisitor = (JsonReadBeanVisitor)this.visitorMap.get(path);
/*  95 */       if (beanVisitor != null) {
/*  96 */         this.currentState.visit(beanVisitor);
/*     */       }
...
/* 144 */         this.loadedProps = new HashSet();
/*     */       } else {
/* 146 */         this.ebi = null;
...
/*     */     }
/*     */     
/* 151 */     public String toString() { return this.bean.getClass().getSimpleName() + " loaded:" + this.loadedProps; }
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/* 165 */         this.unmapped = new LinkedHashMap();
/*     */       }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\text\json\ReadJsonContext.class

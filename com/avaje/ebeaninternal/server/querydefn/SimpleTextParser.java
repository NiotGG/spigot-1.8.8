...
/*  67 */         return -1;
/*     */       }
/*  69 */     } while (!lowerMatch.equals(this.lowerWord));
...
/* 109 */     for (; 
/* 109 */         this.pos < this.eof; this.pos += 1) {
/* 110 */       char c = this.chars[this.pos];
/* 111 */       if (c == '(')
/*     */       {
/* 113 */         this.openParenthesisCount += 1;
/*     */       }
/* 115 */       else if (c == ')') {
/* 116 */         if (this.openParenthesisCount > 0)
/*     */         {
/* 118 */           this.openParenthesisCount -= 1;
/*     */         }
/*     */         else {
/* 121 */           this.pos += 1;
/* 122 */           return;
...
/* 131 */     for (; this.pos < this.eof; this.pos += 1) {
...
/*     */   {
/* 170 */     for (; this.pos < this.eof; this.pos += 1) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\querydefn\SimpleTextParser.class

...
/*     */   
/*     */ 
/*  42 */   private Map<String, Statistics> statisticsMap = new ConcurrentHashMap();
/*     */   
/*     */ 
/*     */ 
/*     */ 
/*  47 */   private Map<String, TunedQueryInfo> tunedQueryInfoMap = new ConcurrentHashMap();
/*     */   
...
/*     */   {
/* 191 */     return (TunedQueryInfo)this.tunedQueryInfoMap.get(originKey);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 198 */     return (Statistics)this.statisticsMap.get(originKey);
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/* 361 */     void incrementNew() { this.newPlan += 1; }
/*     */     
/*     */     void incrementModified() {
/* 364 */       this.modified += 1;
/*     */     }
/*     */     
/* 367 */     void incrementUnchanged() { this.unchanged += 1; }
/*     */     
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\autofetch\DefaultAutoFetchManager.class

...
/*  44 */       while (it.hasNext()) {
/*  45 */         String propertyName = (String)it.next();
...
/*  81 */     int count = 0;
/*  82 */     while (it.hasNext()) {
/*  83 */       Map.Entry<String, Object> entry = (Map.Entry)it.next();
/*  84 */       Object value = entry.getValue();
/*  85 */       String propName = (String)entry.getKey();
/*     */       
/*  87 */       if (count > 0) {
...
/* 115 */       Map.Entry<String, Object> entry = (Map.Entry)it.next();
/* 116 */       Object value = entry.getValue();
/* 117 */       String propName = (String)entry.getKey();
/*     */       
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\expression\AllEqualsExpression.class

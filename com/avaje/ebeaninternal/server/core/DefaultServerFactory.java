...
/*     */   {
/*  99 */     List<String> hitList = new ArrayList();
/*     */     
...
/* 164 */       setNamingConvention(serverConfig);
/*     */       
...
/*     */         {
/*     */ 
/* 192 */           pstmtBatch = new OraclePstmtBatch(pstmtDelegate);
/*     */         }
/* 194 */         if (pstmtBatch == null)
/*     */         {
...
/*     */       
/* 209 */       InternalConfiguration c = new InternalConfiguration(this.xmlConfig, this.clusterManager, cacheManager, bgExecutor, serverConfig, bootupClasses, pstmtBatch);
/*     */       
/*     */ 
...
/* 218 */       MBeanServer mbeanServer; MBeanServer mbeanServer; if (list.size() == 0)
/*     */       {
...
/*     */   {
/* 258 */     if ((ds instanceof DataSourcePool))
/*     */     {
...
/* 294 */       cacheFactory = new DefaultServerCacheFactory();
/*     */     }
/*     */     
/* 297 */     return new DefaultServerCacheManager(cacheFactory, beanOptions, queryOptions);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 356 */       config.setNamingConvention(nc);
/*     */       
...
/*     */     }
/*     */     
/* 431 */     return DataSourceGlobalManager.getDataSource(config.getName(), dsConfig);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 475 */         m = "DataSource [" + serverConfig.getName() + "] has autoCommit defaulting to true!";
...
/* 487 */           c.close();
/*     */         } catch (SQLException ex) {
/* 489 */           logger.log(Level.SEVERE, null, ex);
/*     */         }
/*     */       }
/*     */     }
/*     */   }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\core\DefaultServerFactory.class

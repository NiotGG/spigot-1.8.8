...
/* 104 */       return new SqlAnywherePlatform();
/*     */     }
/*     */     
/* 107 */     if (dbName.equals("mysql")) {
/* 108 */       return new MySqlPlatform();
/*     */     }
/*     */     
/* 111 */     if (dbName.equals("sqlite")) {
/* 112 */       return new SQLitePlatform();
/*     */     }
/*     */     
...
/*     */         }
/*     */       } catch (SQLException ex) {
/* 139 */         logger.log(Level.SEVERE, null, ex);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* 156 */         return new Oracle10Platform();
/*     */       }
/* 158 */       return new Oracle9Platform();
/*     */     }
/*     */     
/* 161 */     if (dbProductName.indexOf("microsoft") > -1) {
/* 162 */       if (majorVersion > 8) {
/* 163 */         return new MsSqlServer2005Platform();
/*     */       }
/* 165 */       return new MsSqlServer2000Platform();
/*     */     }
/*     */     
/*     */ 
/* 169 */     if (dbProductName.indexOf("mysql") > -1) {
/* 170 */       return new MySqlPlatform();
/*     */     }
/* 172 */     if (dbProductName.indexOf("h2") > -1) {
/* 173 */       return new H2Platform();
/*     */     }
/* 175 */     if (dbProductName.indexOf("hsql database engine") > -1) {
/* 176 */       return new HsqldbPlatform();
/*     */     }
/* 178 */     if (dbProductName.indexOf("postgres") > -1) {
/* 179 */       return new PostgresPlatform();
/*     */     }
/* 181 */     if (dbProductName.indexOf("sqlite") > -1) {
/* 182 */       return new SQLitePlatform();
/*     */     }
/* 184 */     if (dbProductName.indexOf("sql anywhere") > -1) {
/* 185 */       return new SqlAnywherePlatform();
/*     */     }
/*     */     
/*     */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\core\DatabasePlatformFactory.class

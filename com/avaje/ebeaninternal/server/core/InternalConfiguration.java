...
/* 128 */     this.expressionFactory = new DefaultExpressionFactory();
/*     */     
/* 130 */     this.subClassManager = new SubClassManager(serverConfig);
/*     */     
/* 132 */     this.typeManager = new DefaultTypeManager(serverConfig, bootupClasses);
...
/*     */     
/* 147 */     this.transactionManager = new TransactionManager(clusterManager, backgroundExecutor, serverConfig, this.beanDescriptorManager, getBootupClasses());
/*     */     
/*     */ 
/* 150 */     this.logControl = new MAdminLogging(serverConfig, this.transactionManager);
/*     */     
/* 152 */     this.cQueryEngine = new CQueryEngine(serverConfig.getDatabasePlatform(), this.logControl, this.binder, backgroundExecutor);
/*     */     
...
/* 156 */       externalTransactionManager = new JtaTransactionManager();
/*     */     }
/* 158 */     if (externalTransactionManager != null) {
/* 159 */       externalTransactionManager.setTransactionManager(this.transactionManager);
/* 160 */       this.transactionScopeManager = new ExternalTransactionScopeManager(this.transactionManager, externalTransactionManager);
/* 161 */       logger.info("Using Transaction Manager [" + externalTransactionManager.getClass() + "]");
/*     */     } else {
/* 163 */       this.transactionScopeManager = new DefaultTransactionScopeManager(this.transactionManager);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/* 175 */     JsonValueAdapter va = new DefaultJsonValueAdapter();
/* 176 */     if (s != null) {
/* 177 */       va = (JsonValueAdapter)ClassUtil.newInstance(s, getClass());
/*     */     }
/* 179 */     return new DJsonContext(server, va, dfltPretty);
/*     */   }
/*     */   
...
/* 191 */     return new DefaultRelationalQueryEngine(this.logControl, this.binder, this.serverConfig.getDatabaseBooleanTrue());
/*     */   }
/*     */   
/*     */   public OrmQueryEngine createOrmQueryEngine() {
/* 195 */     return new DefaultOrmQueryEngine(this.beanDescriptorManager, this.cQueryEngine);
/*     */   }
/*     */   
...
/*     */     }
/* 204 */     return new DefaultPersister(server, this.serverConfig.isValidateOnSave(), this.binder, this.beanDescriptorManager, this.pstmtBatch, ldapCtxFactory);
/*     */   }
/*     */   
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\core\InternalConfiguration.class

...
/*     */     }
/* 306 */     if ((value instanceof java.util.Date)) {
/* 307 */       return Long.valueOf(((java.util.Date)value).getTime());
/*     */     }
...
/*     */     }
/* 355 */     if ((value instanceof java.util.Date))
/*     */     {
/* 357 */       return new Timestamp(((java.util.Date)value).getTime());
/*     */     }
...
/* 397 */       return null;
/*     */     }
/* 399 */     if ((value instanceof java.sql.Date)) {
/* 400 */       return (java.sql.Date)value;
/*     */     }
/* 402 */     if ((value instanceof java.util.Date)) {
/* 403 */       return new java.sql.Date(((java.util.Date)value).getTime());
/*     */     }
/* 405 */     if ((value instanceof Calendar)) {
/* 406 */       return new java.sql.Date(((Calendar)value).getTime().getTime());
/*     */     }
/* 408 */     if ((value instanceof String)) {
/* 409 */       return java.sql.Date.valueOf((String)value);
/*     */     }
/* 411 */     if ((value instanceof Number)) {
/* 412 */       return new java.sql.Date(((Number)value).longValue());
/*     */     }
/*     */     
...
/*     */     {
/* 430 */       return new java.util.Date(((Timestamp)value).getTime());
/*     */     }
/*     */     
/*     */ 
/*     */ 
/* 435 */     if ((value instanceof java.sql.Date)) {
/* 436 */       return new java.util.Date(((java.sql.Date)value).getTime());
/*     */     }
/* 438 */     if ((value instanceof java.util.Date)) {
/* 439 */       return (java.util.Date)value;
/*     */     }
/* 441 */     if ((value instanceof Calendar)) {
/* 442 */       return ((Calendar)value).getTime();
/*     */     }
/* 444 */     if ((value instanceof String)) {
/* 445 */       return new java.util.Date(Timestamp.valueOf((String)value).getTime());
/*     */     }
/* 447 */     if ((value instanceof Number)) {
/* 448 */       return new java.util.Date(((Number)value).longValue());
/*     */     }
/*     */     
...
/*     */     }
/* 466 */     if ((value instanceof java.util.Date)) {
/* 467 */       java.util.Date date = (java.util.Date)value;
/* 468 */       return toCalendarFromDate(date);
/*     */     }
/* 470 */     if ((value instanceof String)) {
/* 471 */       java.util.Date date = toUtilDate(value);
/* 472 */       return toCalendarFromDate(date);
/*     */     }
/* 474 */     if ((value instanceof Number)) {
/* 475 */       long timeMillis = ((Number)value).longValue();
/* 476 */       java.util.Date date = new java.util.Date(timeMillis);
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\core\BasicTypeConverter.class

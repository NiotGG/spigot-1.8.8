...
/* 120 */       BeanCollection<?> bc = (BeanCollection)batch.get(i);
...
/*     */     }
/*     */     
/* 161 */     this.server.findList(query, loadRequest.getTransaction());
/*     */     
/*     */ 
/*     */ 
/* 165 */     for (int i = 0; i < batch.size(); i++) {
/* 166 */       BeanCollection<?> bc = (BeanCollection)batch.get(i);
...
/*     */     
/* 232 */     if (pc == null) {
/* 233 */       pc = new DefaultPersistenceContext();
/* 234 */       pc.put(parentId, parentBean);
/*     */     }
/*     */     
...
/* 280 */     query.setPersistenceContext(pc);
...
/*     */     
/*     */ 
/* 289 */     this.server.findUnique(query, t);
/*     */     
...
/*     */     
/* 321 */     EntityBeanIntercept[] ebis = (EntityBeanIntercept[])batch.toArray(new EntityBeanIntercept[batch.size()]);
/* 322 */     ArrayList<Object> idList = new ArrayList(batchSize);
/*     */     
/* 324 */     for (int i = 0; i < batch.size(); i++) {
/* 325 */       EntityBeanIntercept ebi = (EntityBeanIntercept)batch.get(i);
...
/*     */     
/*     */ 
/* 350 */     for (int i = 0; i < ebis.length; i++) {
/* 351 */       Object parentBean = ebis[i].getParentBean();
...
/*     */     }
/*     */     
/* 378 */     List<?> list = this.server.findList(query, loadRequest.getTransaction());
/*     */     
/* 380 */     if (loadRequest.isLoadCache()) {
/* 381 */       for (int i = 0; i < list.size(); i++) {
/* 382 */         desc.cachePutBeanData(list.get(i));
/*     */       }
/*     */     }
/*     */     
/* 386 */     for (int i = 0; i < ebis.length; i++) {
/* 387 */       if (ebis[i].isReference())
/*     */       {
/*     */ 
/* 390 */         ebis[i].setLazyLoadFailure();
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* 419 */     if (pc == null)
/*     */     {
/* 421 */       pc = new DefaultPersistenceContext();
/* 422 */       pc.put(id, bean);
/* 423 */       if (ebi != null) {
/* 424 */         ebi.setPersistenceContext(pc);
/*     */       }
/*     */     }
/*     */     
/* 428 */     if (ebi != null) {
...
/* 447 */         pc.putIfAbsent(parentId, parentBean);
/*     */       }
/*     */       
...
/* 457 */     query.setPersistenceContext(pc);
/*     */     
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\core\DefaultBeanLoader.class

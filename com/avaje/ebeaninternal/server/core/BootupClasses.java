...
/*     */   
/*  56 */   private ArrayList<Class<?>> xmlBeanList = new ArrayList();
/*     */   
/*  58 */   private ArrayList<Class<?>> embeddableList = new ArrayList();
/*     */   
/*  60 */   private ArrayList<Class<?>> entityList = new ArrayList();
/*     */   
/*  62 */   private ArrayList<Class<?>> scalarTypeList = new ArrayList();
/*     */   
/*  64 */   private ArrayList<Class<?>> scalarConverterList = new ArrayList();
/*     */   
/*  66 */   private ArrayList<Class<?>> compoundTypeList = new ArrayList();
/*     */   
/*  68 */   private ArrayList<Class<?>> beanControllerList = new ArrayList();
/*     */   
/*  70 */   private ArrayList<Class<?>> transactionEventListenerList = new ArrayList();
/*     */   
/*  72 */   private ArrayList<Class<?>> beanFinderList = new ArrayList();
/*     */   
/*  74 */   private ArrayList<Class<?>> beanListenerList = new ArrayList();
/*     */   
/*  76 */   private ArrayList<Class<?>> beanQueryAdapterList = new ArrayList();
/*     */   
/*  78 */   private ArrayList<Class<?>> luceneIndexList = new ArrayList();
/*     */   
/*  80 */   private ArrayList<Class<?>> serverConfigStartupList = new ArrayList();
/*  81 */   private ArrayList<ServerConfigStartup> serverConfigStartupInstances = new ArrayList();
/*     */   
/*  83 */   private List<BeanPersistController> persistControllerInstances = new ArrayList();
/*  84 */   private List<BeanPersistListener<?>> persistListenerInstances = new ArrayList();
/*  85 */   private List<BeanQueryAdapter> queryAdapterInstances = new ArrayList();
/*  86 */   private List<TransactionEventListener> transactionEventListenerInstances = new ArrayList();
/*     */   
...
/*     */   {
/* 423 */     Annotation ann = cls.getAnnotation(Entity.class);
/* 424 */     if (ann != null) {
/* 425 */       return true;
/*     */     }
...
/*     */   {
/* 440 */     Annotation ann = cls.getAnnotation(Embeddable.class);
/* 441 */     if (ann != null) {
/* 442 */       return true;
/*     */     }
/* 444 */     return false;
...
/*     */   {
/* 449 */     Annotation ann = cls.getAnnotation(XmlRootElement.class);
/* 450 */     if (ann != null) {
/* 451 */       return true;
/*     */     }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\core\BootupClasses.class

...
/*     */   {
/*  92 */     List<PooledConnection> copy = new ArrayList(this.conns.length);
...
/*     */     
/*     */ 
/* 117 */     for (int i = 0; i < this.conns.length; i++) {
...
/*     */   {
/* 154 */     i++;return i == this.conns.length ? 0 : i;
/*     */   }
/*     */ }


/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\lib\sql\FreeConnectionBuffer.class

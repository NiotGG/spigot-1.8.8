...
/*  55 */   private final Map<String, DLoadBeanContext> beanMap = new HashMap();
/*  56 */   private final Map<String, DLoadManyContext> manyMap = new HashMap();
/*     */   
...
/*  72 */   private final Map<String, ObjectGraphNode> nodePathMap = new HashMap();
...
/* 136 */         OrmQueryProperties properties = (OrmQueryProperties)this.secQuery.get(i);
/*     */         
...
/* 174 */         OrmQueryProperties props = (OrmQueryProperties)this.secQuery.get(i);
...
/* 182 */         OrmQueryProperties lazyProps = (OrmQueryProperties)lazyQueries.get(i);
...
/*     */   {
/* 204 */     ObjectGraphNode node = (ObjectGraphNode)this.nodePathMap.get(path);
/* 205 */     if (node == null) {
...
/*     */     }
/* 265 */     DLoadBeanContext beanContext = (DLoadBeanContext)this.beanMap.get(path);
...
/*     */     }
/* 292 */     DLoadManyContext ctx = (DLoadManyContext)this.manyMap.get(path);
/* 293 */     if (ctx == null) {
...
/* 310 */       return new DLoadHardList();
/*     */     }
/* 312 */     return new DLoadWeakList();
/*     */   }
/*     */   
/*     */   private DLoadList<BeanCollection<?>> createBeanCollectionLoadList()
/*     */   {
/* 317 */     if (this.hardRefs) {
/* 318 */       return new DLoadHardList();
/*     */     }
/* 320 */     return new DLoadWeakList();
/*     */   }
/*     */   
/*     */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\loadcontext\DLoadContext.class

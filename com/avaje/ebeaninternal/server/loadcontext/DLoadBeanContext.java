...
/*     */       {
/* 194 */         EntityBeanIntercept entityBeanIntercept = (EntityBeanIntercept)batch.get(i);
...
/*     */   {
/* 214 */     List<EntityBeanIntercept> actualLoadBatch = new ArrayList(this.batchSize);
...
/* 222 */         if (!this.desc.loadFromCache((EntityBeanIntercept)batchToCheck.get(i))) {
...
/* 259 */         LoadBeanRequest req = new LoadBeanRequest(this, batch, parentRequest.getTransaction(), requestedBatchSize, false, null, loadCache);
/*     */         
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\loadcontext\DLoadBeanContext.class

...
/*     */   
/*  32 */   protected final ArrayList<WeakReference<T>> list = new ArrayList();
/*     */   
/*     */ 
...
/*  43 */       this.list.add(new WeakReference(e));
/*  44 */       return i;
/*     */     }
/*     */   }
/*     */   
...
/*  50 */       WeakReference<T> wref = (WeakReference)this.list.get(position);
/*  51 */       if (wref == null) {
...
/*     */       }
/*     */       
/*  85 */       ArrayList<T> batch = new ArrayList();
/*     */       
...
/*     */       }
/*     */       
/*  92 */       for (int i = position; i < this.list.size(); i++) {
...
/*     */       
/*     */ 
/* 101 */       for (int i = this.removedFromTop; i < position; i++) {
...
/* 116 */     WeakReference<T> wref = (WeakReference)this.list.get(i);
/* 117 */     if (wref != null) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\loadcontext\DLoadWeakList.class

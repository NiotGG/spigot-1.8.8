...
/*     */       {
/*  93 */         SqlLimitResponse limitSql = this.dbQueryLimiter.limit(new OrmQueryLimitRequest(sql, orderBy, query, this.dbPlatform));
...
/* 106 */       return new CQuery(request, predicates, queryPlan);
/*     */ 
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\query\RawSqlSelectClauseBuilder.class

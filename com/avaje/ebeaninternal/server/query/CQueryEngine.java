...
/*     */       }
/*     */       
/* 199 */       Object beanCollection = cquery.readCollection();
/*     */       
/* 201 */       BeanCollectionTouched collectionTouched = request.getQuery().getBeanCollectionTouched();
/* 202 */       if (collectionTouched != null)
/*     */       {
/*     */ 
/* 205 */         ((BeanCollection)beanCollection).setBeanCollectionTouched(collectionTouched);
/*     */       }
...
/* 213 */         fetch = new BackgroundFetch(cquery);
/*     */         
/* 215 */         FutureTask<Integer> future = new FutureTask(fetch);
/* 216 */         ((BeanCollection)beanCollection).setBackgroundFetch(future);
...
/*     */       
/* 226 */       return (BackgroundFetch)beanCollection;
/*     */     }
/*     */     catch (SQLException e) {
...
/*     */     String originKey;
/* 342 */     String originKey; if ((node == null) || (node.getOriginQueryPoint() == null)) {
/* 343 */       originKey = null;
/*     */     } else {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\query\CQueryEngine.class

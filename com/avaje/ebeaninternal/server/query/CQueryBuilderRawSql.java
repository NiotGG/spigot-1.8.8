...
/*     */   {
/*  48 */     if (!rsql.isParsed()) {
/*  49 */       String sql = rsql.getUnparsedSql();
/*  50 */       BindParams bindParams = request.getQuery().getBindParams();
/*  51 */       if ((bindParams != null) && (bindParams.requiresNamedParamsPrepare()))
/*     */       {
/*  53 */         sql = BindParamsParser.parse(bindParams, sql);
/*     */       }
/*     */       
/*  56 */       return new SqlLimitResponse(sql, false);
/*     */     }
/*     */     
...
/*     */     {
/*  67 */       return this.sqlLimiter.limit(new OrmQueryLimitRequest(sql, orderBy, query, this.dbPlatform));
/*     */     }
/*     */     
/*     */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\query\CQueryBuilderRawSql.class

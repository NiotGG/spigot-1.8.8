...
/*     */     else
/*     */     {
/* 294 */       this.persistenceContext = new DefaultPersistenceContext();
/*     */     }
/*     */     
...
/* 301 */     this.collection = ((BeanCollection)(this.help != null ? this.help.createEmpty(false) : null));
/*     */   }
/*     */   
...
/*     */       }
/*     */     } catch (SQLException e) {
/* 422 */       logger.log(Level.SEVERE, null, e);
/*     */     }
/*     */     try {
...
/*     */     {
/* 636 */       ((BeanCollection)this.currentDetailCollection).setFilterMany(this.filterMany);
/*     */     }
/*     */     
/*     */ 
...
/*     */     }
/*     */     catch (Exception e) {
/* 676 */       logger.log(Level.SEVERE, null, e);
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/* 682 */     if (bufferSize > 0) {
/* 683 */       return new CQueryIteratorWithBuffer(this, request, bufferSize);
/*     */     }
/*     */     
/* 686 */     return new CQueryIteratorSimple(this, request);
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/* 858 */     String path = (String)this.currentPathMap.get(propertyName);
/* 859 */     if (path != null) {
/* 860 */       return path;
/*     */     }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\query\CQuery.class

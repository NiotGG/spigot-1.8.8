...
/*  42 */       this.localCopy = new ArrayList();
/*     */       
/*  44 */       int pgIndex = 0;
/*     */       for (;;) {
/*  46 */         Page<T> page = this.owner.getPage(pgIndex++);
...
/*     */   
/*     */   public void clear() {
/*  61 */     this.localCopy = new ArrayList();
/*     */   }
/*     */   
...
/*     */     
/*     */     public T next() {
/* 220 */       return (T)this.ownerList.get(this.position++);
/*     */     }
/*     */     
...
/*     */     
/*     */     public T previous() {
/* 228 */       return (T)LimitOffsetList.this.get(--this.position);
/*     */     }
/*     */     
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\query\LimitOffsetList.class

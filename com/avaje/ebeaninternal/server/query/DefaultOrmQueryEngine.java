...
/*  92 */     if (finder != null)
/*     */     {
/*  94 */       result = finder.findMany(request);
/*     */     } else {
...
/*     */     {
/* 101 */       descriptor = request.getBeanDescriptor();
...
/* 134 */     if (finder != null) {
/* 135 */       result = finder.find(request);
/*     */     } else {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\query\DefaultOrmQueryEngine.class

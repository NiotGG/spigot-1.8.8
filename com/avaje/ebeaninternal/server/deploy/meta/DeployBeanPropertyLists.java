...
/*  49 */   private final ArrayList<BeanProperty> ids = new ArrayList();
/*     */   
/*  51 */   private final ArrayList<BeanProperty> version = new ArrayList();
/*     */   
/*  53 */   private final ArrayList<BeanProperty> local = new ArrayList();
/*     */   
/*  55 */   private final ArrayList<BeanProperty> manys = new ArrayList();
/*  56 */   private final ArrayList<BeanProperty> nonManys = new ArrayList();
/*     */   
/*  58 */   private final ArrayList<BeanProperty> ones = new ArrayList();
/*     */   
/*  60 */   private final ArrayList<BeanProperty> onesExported = new ArrayList();
/*     */   
/*  62 */   private final ArrayList<BeanProperty> onesImported = new ArrayList();
/*     */   
/*  64 */   private final ArrayList<BeanProperty> embedded = new ArrayList();
/*     */   
/*  66 */   private final ArrayList<BeanProperty> baseScalar = new ArrayList();
/*     */   
/*  68 */   private final ArrayList<BeanPropertyCompound> baseCompound = new ArrayList();
/*     */   
/*  70 */   private final ArrayList<BeanProperty> transients = new ArrayList();
/*     */   
/*  72 */   private final ArrayList<BeanProperty> nonTransients = new ArrayList();
/*     */   
...
/*     */     }
/*     */     
/*  89 */     this.propertyMap = new LinkedHashMap();
/*     */     
/*  91 */     Iterator<DeployBeanProperty> deployIt = deploy.propertiesAll();
/*  92 */     while (deployIt.hasNext()) {
/*  93 */       DeployBeanProperty deployProp = (DeployBeanProperty)deployIt.next();
...
/* 102 */       BeanProperty prop = (BeanProperty)it.next();
...
/* 110 */       this.tableJoins[i] = new TableJoin((DeployTableJoin)deployTableJoins.get(i), this.propertyMap);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */   {
/* 181 */     ArrayList<BeanProperty> list = new ArrayList();
/* 182 */     Iterator<BeanProperty> it = this.propertyMap.values().iterator();
/* 183 */     while (it.hasNext()) {
/* 184 */       BeanProperty property = (BeanProperty)it.next();
/* 185 */       if (property.hasValidationRules(recurse)) {
/* 186 */         list.add(property);
/*     */       }
/*     */     }
/* 189 */     return (BeanProperty[])list.toArray(new BeanProperty[list.size()]);
/*     */   }
/*     */   
...
/*     */   {
/* 209 */     return (BeanProperty[])this.baseScalar.toArray(new BeanProperty[this.baseScalar.size()]);
/*     */   }
/*     */   
/*     */   public BeanPropertyCompound[] getBaseCompound() {
/* 213 */     return (BeanPropertyCompound[])this.baseCompound.toArray(new BeanPropertyCompound[this.baseCompound.size()]);
/*     */   }
/*     */   
/*     */   public BeanProperty getNaturalKey() {
/* 217 */     String naturalKey = this.desc.getCacheOptions().getNaturalKey();
/* 218 */     if (naturalKey != null) {
/* 219 */       return (BeanProperty)this.propertyMap.get(naturalKey);
/*     */     }
/* 221 */     return null;
/*     */   }
/*     */   
/*     */   public BeanProperty[] getId() {
/* 225 */     return (BeanProperty[])this.ids.toArray(new BeanProperty[this.ids.size()]);
/*     */   }
/*     */   
/*     */   public BeanProperty[] getNonTransients() {
/* 229 */     return (BeanProperty[])this.nonTransients.toArray(new BeanProperty[this.nonTransients.size()]);
/*     */   }
/*     */   
/*     */   public BeanProperty[] getTransients() {
/* 233 */     return (BeanProperty[])this.transients.toArray(new BeanProperty[this.transients.size()]);
/*     */   }
/*     */   
/*     */   public BeanProperty[] getVersion() {
/* 237 */     return (BeanProperty[])this.version.toArray(new BeanProperty[this.version.size()]);
/*     */   }
/*     */   
/*     */   public BeanProperty[] getLocal() {
/* 241 */     return (BeanProperty[])this.local.toArray(new BeanProperty[this.local.size()]);
/*     */   }
/*     */   
/*     */   public BeanPropertyAssocOne<?>[] getEmbedded() {
/* 245 */     return (BeanPropertyAssocOne[])this.embedded.toArray(new BeanPropertyAssocOne[this.embedded.size()]);
/*     */   }
/*     */   
/*     */   public BeanPropertyAssocOne<?>[] getOneExported() {
/* 249 */     return (BeanPropertyAssocOne[])this.onesExported.toArray(new BeanPropertyAssocOne[this.onesExported.size()]);
/*     */   }
/*     */   
/*     */   public BeanPropertyAssocOne<?>[] getOneImported() {
/* 253 */     return (BeanPropertyAssocOne[])this.onesImported.toArray(new BeanPropertyAssocOne[this.onesImported.size()]);
/*     */   }
/*     */   
/*     */   public BeanPropertyAssocOne<?>[] getOnes() {
/* 257 */     return (BeanPropertyAssocOne[])this.ones.toArray(new BeanPropertyAssocOne[this.ones.size()]);
/*     */   }
/*     */   
...
/* 277 */     return (BeanProperty[])this.nonManys.toArray(new BeanProperty[this.nonManys.size()]);
/*     */   }
/*     */   
/*     */   public BeanPropertyAssocMany<?>[] getMany() {
/* 281 */     return (BeanPropertyAssocMany[])this.manys.toArray(new BeanPropertyAssocMany[this.manys.size()]);
/*     */   }
/*     */   
...
/*     */     private Mode() {} }
/*     */   
/* 304 */   private BeanPropertyAssocOne<?>[] getOne(boolean imported, Mode mode) { ArrayList<BeanPropertyAssocOne<?>> list = new ArrayList();
...
/*     */     }
/*     */     
/* 330 */     return (BeanPropertyAssocOne[])list.toArray(new BeanPropertyAssocOne[list.size()]);
/*     */   }
/*     */   
/*     */   private BeanPropertyAssocMany<?>[] getMany2Many() {
/* 334 */     ArrayList<BeanPropertyAssocMany<?>> list = new ArrayList();
...
/*     */     }
/*     */     
/* 342 */     return (BeanPropertyAssocMany[])list.toArray(new BeanPropertyAssocMany[list.size()]);
/*     */   }
/*     */   
/*     */   private BeanPropertyAssocMany<?>[] getMany(Mode mode) {
/* 346 */     ArrayList<BeanPropertyAssocMany<?>> list = new ArrayList();
...
/*     */     }
/*     */     
/* 378 */     return (BeanPropertyAssocMany[])list.toArray(new BeanPropertyAssocMany[list.size()]);
/*     */   }
/*     */   
/*     */ 
...
/*     */     {
/* 386 */       return new BeanPropertyAssocOne(owner, this.desc, (DeployBeanPropertyAssocOne)deployProp);
/*     */     }
/* 388 */     if ((deployProp instanceof DeployBeanPropertySimpleCollection))
/*     */     {
/* 390 */       return new BeanPropertySimpleCollection(owner, this.desc, (DeployBeanPropertySimpleCollection)deployProp);
/*     */     }
/* 392 */     if ((deployProp instanceof DeployBeanPropertyAssocMany))
/*     */     {
/* 394 */       return new BeanPropertyAssocMany(owner, this.desc, (DeployBeanPropertyAssocMany)deployProp);
/*     */     }
/* 396 */     if ((deployProp instanceof DeployBeanPropertyCompound))
/*     */     {
/* 398 */       return new BeanPropertyCompound(owner, this.desc, (DeployBeanPropertyCompound)deployProp);
/*     */     }
/*     */     
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\deploy\meta\DeployBeanPropertyLists.class

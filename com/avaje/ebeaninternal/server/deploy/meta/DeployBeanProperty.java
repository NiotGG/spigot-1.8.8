...
/* 104 */   private boolean fetchEager = true;
/*     */   
/*     */ 
/*     */ 
/*     */ 
/* 109 */   private boolean nullable = true;
/*     */   
/*     */ 
...
/*     */ 
/*     */ 
/* 212 */   private HashMap<String, String> extraAttributeMap = new HashMap();
/*     */   
/*     */ 
/*     */ 
...
/*     */   
/*     */ 
/* 233 */   private List<Validator> validators = new ArrayList();
/*     */   
...
/*     */     }
/* 255 */     return new ScalarTypeWrapper(propertyType, scalarType, typeConverter);
/*     */   }
/*     */   
...
/* 428 */       Validator validator = (Validator)it.next();
...
/*     */   {
/* 440 */     return (Validator[])this.validators.toArray(new Validator[this.validators.size()]);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 937 */     return (String)this.extraAttributeMap.get(key);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\deploy\meta\DeployBeanProperty.class

...
/*  85 */     XmlRootElement rootElement = (XmlRootElement)cls.getAnnotation(XmlRootElement.class);
/*  86 */     if (rootElement != null) {
/*  87 */       return true;
/*     */     }
/*  89 */     XmlType xmlType = (XmlType)cls.getAnnotation(XmlType.class);
/*  90 */     if (xmlType != null) {
/*  91 */       return true;
/*     */     }
/*  93 */     return false;
...
/*     */   {
/*  98 */     LdapDomain ldapDomain = (LdapDomain)cls.getAnnotation(LdapDomain.class);
...
/*     */     }
/*     */     
/* 106 */     Entity entity = (Entity)cls.getAnnotation(Entity.class);
/* 107 */     if (entity != null)
/*     */     {
...
/*     */     }
/*     */     
/* 120 */     Embeddable embeddable = (Embeddable)cls.getAnnotation(Embeddable.class);
...
/*     */     }
/*     */     
/* 126 */     UniqueConstraint uc = (UniqueConstraint)cls.getAnnotation(UniqueConstraint.class);
/* 127 */     if (uc != null) {
/* 128 */       this.descriptor.addCompoundUniqueConstraint(new CompoundUniqueContraint(uc.columnNames()));
/*     */     }
/*     */     
/* 131 */     Table table = (Table)cls.getAnnotation(Table.class);
/* 132 */     if (table != null) {
...
/*     */     }
/*     */     
/* 141 */     UpdateMode updateMode = (UpdateMode)cls.getAnnotation(UpdateMode.class);
/* 142 */     if (updateMode != null) {
/* 143 */       this.descriptor.setUpdateChangesOnly(updateMode.updateChangesOnly());
/*     */     }
/*     */     
/* 146 */     NamedQueries namedQueries = (NamedQueries)cls.getAnnotation(NamedQueries.class);
/* 147 */     if (namedQueries != null) {
/* 148 */       readNamedQueries(namedQueries);
/*     */     }
/* 150 */     NamedQuery namedQuery = (NamedQuery)cls.getAnnotation(NamedQuery.class);
/* 151 */     if (namedQuery != null) {
/* 152 */       readNamedQuery(namedQuery);
/*     */     }
/*     */     
/* 155 */     NamedUpdates namedUpdates = (NamedUpdates)cls.getAnnotation(NamedUpdates.class);
/* 156 */     if (namedUpdates != null) {
/* 157 */       readNamedUpdates(namedUpdates);
/*     */     }
/*     */     
/* 160 */     NamedUpdate namedUpdate = (NamedUpdate)cls.getAnnotation(NamedUpdate.class);
/* 161 */     if (namedUpdate != null) {
/* 162 */       readNamedUpdate(namedUpdate);
/*     */     }
/*     */     
/* 165 */     CacheStrategy cacheStrategy = (CacheStrategy)cls.getAnnotation(CacheStrategy.class);
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\deploy\parse\AnnotationClass.class

...
/*     */   {
/*  28 */     ArrayList<BeanPersistListener<T>> addList = new ArrayList(2);
/*  29 */     addList.add(c1);
/*  30 */     addList.add(c2);
/*  31 */     return addList;
/*     */   }
...
/*  49 */       return this;
/*     */     }
/*  51 */     List<BeanPersistListener<T>> newList = new ArrayList();
...
/*  64 */       return this;
/*     */     }
/*  66 */     ArrayList<BeanPersistListener<T>> newList = new ArrayList();
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\deploy\ChainedBeanPersistListener.class

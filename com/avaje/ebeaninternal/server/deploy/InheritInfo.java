...
/*  53 */   private final ArrayList<InheritInfo> children = new ArrayList();
/*     */   
/*     */ 
...
/*     */     
/* 175 */     int i = 0; for (int x = this.children.size(); i < x; i++) {
...
/*     */   {
/* 194 */     int i = 0; for (int x = this.children.size(); i < x; i++) {
...
/*     */   {
/* 299 */     return (InheritInfo)this.discMap.get(discValue);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\deploy\InheritInfo.class

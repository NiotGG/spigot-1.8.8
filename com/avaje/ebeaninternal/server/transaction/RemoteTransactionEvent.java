...
/*     */   implements Runnable
/*     */ {
/*  34 */   private List<BeanPersistIds> beanPersistList = new ArrayList();
/*     */   
...
/* 125 */       this.indexInvalidations = new HashSet();
/*     */     }
...
/* 132 */       this.tableList = new ArrayList(4);
/*     */     }
...
/* 139 */       this.beanDeltaLists = new ArrayList();
/*     */     }
...
/* 153 */       this.indexEventList = new ArrayList(2);
/*     */     }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\transaction\RemoteTransactionEvent.class

...
/*     */ 
/*     */ 
/*  74 */   private final ConcurrentLinkedQueue<TransactionLogBuffer> logBufferQueue = new ConcurrentLinkedQueue();
/*     */   
...
/* 213 */           missCount++;
/*     */         } else {
/* 215 */           TransactionLogBuffer buffer = (TransactionLogBuffer)this.logBufferQueue.remove();
/* 216 */           write(buffer);
/* 217 */           missCount = 0;
/*     */         }
/*     */       }
...
/* 252 */       TransactionLogBuffer.LogEntry msg = (TransactionLogBuffer.LogEntry)messages.get(i);
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\transaction\log\FileTransactionLogger.class

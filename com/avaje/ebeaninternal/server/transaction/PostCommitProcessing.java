...
/*     */     {
/*  99 */       dm = this.manager.getBeanDescriptorManager();
...
/* 132 */     BulkEventListenerMap map; if ((eventTables != null) && (!eventTables.isEmpty())) {
/* 133 */       map = this.manager.getBulkEventListenerMap();
/* 134 */       for (TransactionEventTable.TableIUD tableIUD : eventTables.values()) {
/* 135 */         map.process(tableIUD);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\transaction\PostCommitProcessing.class

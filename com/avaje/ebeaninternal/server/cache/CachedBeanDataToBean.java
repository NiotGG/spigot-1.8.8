...
/*  43 */     this.loadedProps = (this.cacheLoadedProperties == null ? null : new HashSet());
/*     */     
/*  45 */     if (ebi != null) {
...
/*     */       }
/*     */     }
/*  66 */     BeanPropertyAssocMany<?>[] manys = this.desc.propertiesMany();
/*  67 */     for (int i = 0; i < manys.length; i++) {
/*  68 */       BeanPropertyAssocMany<?> prop = manys[i];
...
/*     */       } else {
/*  79 */         HashSet<String> mergeProps = new HashSet();
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\cache\CachedBeanDataToBean.class

...
/*     */   
/*  34 */   private final ConcurrentHashMap<Object, CacheEntry> map = new ConcurrentHashMap();
/*     */   
...
/*     */       
/* 294 */       ArrayList<DefaultServerCache.CacheEntry> activeList = new ArrayList();
/*     */       
...
/* 304 */           trimmedByIdle++;
/*     */         }
/* 306 */         else if ((DefaultServerCache.this.maxSecsToLive > 0) && (ttlExpire > cacheEntry.getCreateTime())) {
/* 307 */           it.remove();
/* 308 */           trimmedByTTL++;
/*     */         }
/* 310 */         else if (trimMaxSize) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\cache\DefaultServerCache.class

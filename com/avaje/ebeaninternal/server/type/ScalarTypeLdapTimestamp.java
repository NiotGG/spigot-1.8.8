...
/*     */       
/*  63 */       return (T)this.baseType.parseDateTime(date.getTime());
/*     */     }
/*     */     catch (Exception e) {
...
/* 126 */     return (T)this.baseType.parse(value);
/*     */   }
/*     */   
/*     */   public T parseDateTime(long systemTimeMillis) {
/* 130 */     return (T)this.baseType.parseDateTime(systemTimeMillis);
/*     */   }
/*     */   
/*     */   public T read(DataReader dataReader) throws SQLException {
/* 134 */     return (T)this.baseType.read(dataReader);
/*     */   }
/*     */   
...
/* 150 */     return (T)this.baseType.jsonFromString(value, ctx);
/*     */   }
/*     */   
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\type\ScalarTypeLdapTimestamp.class

...
/*  56 */     this.nullValue = converter.getNullValue();
...
/*     */   {
/*  72 */     S sv = this.converter.unwrapValue(v);
...
/*     */     } else {
/*  80 */       S sv = this.converter.unwrapValue(value);
...
/*     */   {
/* 107 */     return formatValue(v);
/*     */   }
/*     */   
/*     */   public String formatValue(B v) {
/* 111 */     S sv = this.converter.unwrapValue(v);
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\type\ScalarTypeWrapper.class

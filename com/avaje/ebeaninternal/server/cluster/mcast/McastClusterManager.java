...
/*     */     }
/*     */     catch (Exception e) {
/* 379 */       msg = "Error with Cluster Mcast Manager thread";
...
/*     */     {
/* 392 */       TreeSet<Long> s = new TreeSet();
...
/*     */     try
/*     */     {
/* 427 */       this.totalPacketsResent += 1L;
...
/* 537 */     ArrayList<Message> messages = new ArrayList(1);
...
/*     */       }
/*     */       catch (IOException e) {
/* 552 */         String msg = "Error sending Messages " + messages;
/* 553 */         logger.log(Level.SEVERE, msg, e);
/* 554 */         return false;
/*     */       }
/*     */     }
/*     */   }
...
/* 587 */           this.totalTxnEventsSent += 1L;
/*     */         }
/*     */       } catch (IOException e) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\cluster\mcast\McastClusterManager.class

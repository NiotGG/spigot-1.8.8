...
/*     */     throws SQLException
/*     */   {
/*  94 */     Object bean = persist.getBean();
/*     */     
...
/* 107 */       break;
/*     */     case ALL: 
/* 109 */       Object oldBean = persist.getOldValues();
...
/*     */     
/*     */     case ALL: 
/* 137 */       Object oldValues = request.getOldValues();
/* 138 */       if (oldValues == null) {
/* 139 */         throw new PersistenceException("OldValues are null?");
/*     */       }
/* 141 */       String sql = genDynamicWhere(request.getUpdatedProperties(), request.getLoadedProperties(), oldValues);
...
/*     */ 
/*     */ 
/* 179 */     List<Bindable> list = new ArrayList();
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\persist\dml\UpdateMeta.class

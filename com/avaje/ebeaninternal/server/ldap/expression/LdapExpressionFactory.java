...
/*  62 */     return new LdLogicExpression.And(expOne, expTwo);
/*     */   }
/*     */   
...
/*  83 */     return new LdJunctionExpression.Conjunction(query, query.where());
/*     */   }
/*     */   
/*     */   public <T> Junction<T> disjunction(Query<T> query)
/*     */   {
/*  88 */     return new LdJunctionExpression.Disjunction(query, query.where());
/*     */   }
/*     */   
/*     */   public <T> Junction<T> conjunction(Query<T> query, ExpressionList<T> parent) {
/*  92 */     return new LdJunctionExpression.Conjunction(query, parent);
/*     */   }
/*     */   
/*     */   public <T> Junction<T> disjunction(Query<T> query, ExpressionList<T> parent) {
/*  96 */     return new LdJunctionExpression.Disjunction(query, parent);
/*     */   }
/*     */   
...
/* 107 */     return new LdSimpleExpression(propertyName, LdSimpleExpression.Op.EQ, value);
/*     */   }
/*     */   
...
/* 127 */     return new LdSimpleExpression(propertyName, LdSimpleExpression.Op.GT_EQ, value);
/*     */   }
/*     */   
/*     */   public Expression gt(String propertyName, Object value) {
/* 131 */     return new LdSimpleExpression(propertyName, LdSimpleExpression.Op.GT, value);
/*     */   }
/*     */   
...
/* 158 */     return new LdSimpleExpression(propertyName, LdSimpleExpression.Op.EQ, value);
/*     */   }
/*     */   
...
/* 166 */     return new LdLikeExpression(propertyName, value);
/*     */   }
/*     */   
/*     */ 
...
/* 204 */     return new LdPresentExpression(propertyName);
/*     */   }
/*     */   
...
/* 220 */     return new LdSimpleExpression(propertyName, LdSimpleExpression.Op.LT_EQ, value);
/*     */   }
/*     */   
/*     */   public Expression like(String propertyName, String value) {
/* 224 */     return new LdLikeExpression(propertyName, value);
/*     */   }
/*     */   
/*     */   public Expression lt(String propertyName, Object value) {
/* 228 */     return new LdSimpleExpression(propertyName, LdSimpleExpression.Op.LT, value);
/*     */   }
/*     */   
/*     */   public Expression ne(String propertyName, Object value) {
/* 232 */     return new LdSimpleExpression(propertyName, LdSimpleExpression.Op.NOT_EQ, value);
/*     */   }
/*     */   
/*     */   public Expression not(Expression exp) {
/* 236 */     return new LdNotExpression(exp);
/*     */   }
/*     */   
/*     */   public Expression or(Expression expOne, Expression expTwo) {
/* 240 */     return new LdLogicExpression.Or(expOne, expTwo);
/*     */   }
/*     */   
...
/*     */   {
/* 253 */     return new LdRawExpression(raw, values);
/*     */   }
/*     */   
/*     */   public Expression raw(String raw) {
/* 257 */     return new LdRawExpression(raw, null);
/*     */   }
/*     */   
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\ldap\expression\LdapExpressionFactory.class

...
/*     */   public BindParams()
/*     */   {
/*  44 */     this.positionedParameters = new ArrayList();
/*     */     
/*  46 */     this.namedParameters = new HashMap();
/*     */     
/*     */ 
/*     */ 
/*     */ 
/*  51 */     this.queryPlanHash = 1;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*  69 */     while (it.hasNext()) {
/*  70 */       Map.Entry<String, Param> entry = (Map.Entry)it.next();
...
/* 122 */       Map.Entry<String, Param> e = (Map.Entry)this.namedParameters.entrySet().iterator().next();
/* 123 */       return new NaturalKeyBindParam((String)e.getKey(), ((Param)e.getValue()).getInValue());
/*     */     }
/* 125 */     return null;
/*     */   }
/*     */   
...
/* 182 */     Param p = (Param)this.namedParameters.get(name);
/* 183 */     if (p == null) {
/* 184 */       p = new Param();
...
/*     */       }
/*     */     }
/* 197 */     return (Param)this.positionedParameters.get(position - 1);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\api\BindParams.class

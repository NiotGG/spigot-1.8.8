...
/* 219 */       return new ModifySet(this, s);
/*     */     }
...
/* 249 */       modifyRemoval(o);
/*     */     }
/* 251 */     return (E)this.map.put(key, value);
/*     */   }
/*     */   
...
/* 259 */       Iterator it = t.entrySet().iterator();
/* 260 */       while (it.hasNext()) {
/* 261 */         Map.Entry entry = (Map.Entry)it.next();
/* 262 */         Object o = this.map.put(entry.getKey(), entry.getValue());
/* 263 */         modifyAddition(entry.getValue());
/* 264 */         modifyRemoval(o);
/*     */       }
/*     */     }
...
/* 276 */       return o;
/*     */     }
/* 278 */     return (E)this.map.remove(key);
/*     */   }
/*     */   
/*     */   public int size() {
/* 282 */     init();
...
/* 293 */       return new ModifyCollection(this, c);
/*     */     }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\common\BeanMap.class

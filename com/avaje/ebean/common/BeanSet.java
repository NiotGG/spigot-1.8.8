...
/* 255 */     init();
/* 256 */     if (isReadOnly()) {
/* 257 */       return new ReadOnlyIterator(this.set.iterator());
/*     */     }
/* 259 */     if (this.modifyListening) {
/* 260 */       return new ModifyIterator(this, this.set.iterator());
/*     */     }
...
/*     */     }
/*     */     
/* 341 */     public boolean hasNext() { return this.it.hasNext(); }
/*     */     
/*     */     public E next()
/*     */     {
/* 345 */       return (E)this.it.next();
/*     */     }
/*     */     
/*     */     public void remove() {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\common\BeanSet.class

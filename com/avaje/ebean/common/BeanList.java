...
/*     */   {
/*  83 */     this.list.add(bean);
/*     */   }
/*     */   
/*     */   public void internalAdd(Object bean)
/*     */   {
/*  88 */     this.list.add(bean);
/*     */   }
/*     */   
...
/* 279 */     init();
/* 280 */     return (E)this.list.get(index);
/*     */   }
/*     */   
...
/* 294 */     init();
/* 295 */     if (isReadOnly()) {
/* 296 */       return new ReadOnlyListIterator(this.list.listIterator());
/*     */     }
/* 298 */     if (this.modifyListening) {
/* 299 */       Iterator<E> it = this.list.iterator();
/* 300 */       return new ModifyIterator(this, it);
/*     */     }
...
/* 311 */     init();
/* 312 */     if (isReadOnly()) {
/* 313 */       return new ReadOnlyListIterator(this.list.listIterator());
/*     */     }
/* 315 */     if (this.modifyListening) {
/* 316 */       ListIterator<E> it = this.list.listIterator();
/* 317 */       return new ModifyListIterator(this, it);
/*     */     }
...
/* 323 */     init();
/* 324 */     if (isReadOnly()) {
/* 325 */       return new ReadOnlyListIterator(this.list.listIterator(index));
/*     */     }
/* 327 */     if (this.modifyListening) {
/* 328 */       ListIterator<E> it = this.list.listIterator(index);
/* 329 */       return new ModifyListIterator(this, it);
/*     */     }
...
/* 340 */       return o;
/*     */     }
/* 342 */     return (E)this.list.remove(index);
/*     */   }
/*     */   
...
/* 402 */       return o;
/*     */     }
/* 404 */     return (E)this.list.set(index, element);
/*     */   }
/*     */   
/*     */   public int size() {
/* 408 */     init();
...
/* 418 */       return new ModifyList(this, this.list.subList(fromIndex, toIndex));
/*     */     }
...
/*     */     }
/*     */     
/* 444 */     public void add(E o) { throw new IllegalStateException("This collection is in ReadOnly mode"); }
/*     */     
/*     */     public void remove() {
/* 447 */       throw new IllegalStateException("This collection is in ReadOnly mode");
/*     */     }
/*     */     
/* 450 */     public void set(E o) { throw new IllegalStateException("This collection is in ReadOnly mode"); }
/*     */     
/*     */     public boolean hasNext() {
/* 453 */       return this.i.hasNext();
/*     */     }
/*     */     
/* 456 */     public boolean hasPrevious() { return this.i.hasPrevious(); }
/*     */     
/*     */     public E next() {
/* 459 */       return (E)this.i.next();
/*     */     }
/*     */     
/* 462 */     public int nextIndex() { return this.i.nextIndex(); }
/*     */     
/*     */     public E previous() {
/* 465 */       return (E)this.i.previous();
/*     */     }
/*     */     
/* 468 */     public int previousIndex() { return this.i.previousIndex(); }
/*     */   }
/*     */ }


/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\common\BeanList.class

...
/*  113 */   private boolean register = true;
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/*  123 */   private boolean validateOnSave = true;
/*      */   
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*  129 */   private List<Class<?>> classes = new ArrayList();
/*      */   
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*  135 */   private List<String> packages = new ArrayList();
/*      */   
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*  141 */   private List<String> searchJars = new ArrayList();
/*      */   
/*      */ 
...
/*      */   
/*      */ 
/*  222 */   private boolean updateChangesOnly = true;
/*      */   
...
/*  227 */   private List<BulkTableEventListener> bulkTableEventListeners = new ArrayList();
/*  228 */   private List<ServerConfigStartup> configStartupListeners = new ArrayList();
/*  229 */   private List<TransactionEventListener> transactionEventListeners = new ArrayList();
/*      */   
/*      */ 
/*      */ 
...
/*      */   
/*      */ 
/*  261 */   private boolean allowSubclassing = true;
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/* 1090 */       this.classes = new ArrayList();
/*      */     }
...
/* 1103 */       this.packages = new ArrayList();
/*      */     }
...
/* 1147 */       this.searchJars = new ArrayList();
/*      */     }
...
/* 1443 */       LdapContextFactory ctxFact = (LdapContextFactory)createInstance(p, LdapContextFactory.class, "ldapContextFactory");
...
/* 1453 */     this.databasePlatform = ((DatabasePlatform)createInstance(p, DatabasePlatform.class, "databasePlatform"));
/* 1454 */     this.encryptKeyManager = ((EncryptKeyManager)createInstance(p, EncryptKeyManager.class, "encryptKeyManager"));
/* 1455 */     this.encryptDeployManager = ((EncryptDeployManager)createInstance(p, EncryptDeployManager.class, "encryptDeployManager"));
/* 1456 */     this.encryptor = ((Encryptor)createInstance(p, Encryptor.class, "encryptor"));
/* 1457 */     this.dbEncrypt = ((DbEncrypt)createInstance(p, DbEncrypt.class, "dbEncrypt"));
/* 1458 */     this.serverCacheFactory = ((ServerCacheFactory)createInstance(p, ServerCacheFactory.class, "serverCacheFactory"));
/* 1459 */     this.serverCacheManager = ((ServerCacheManager)createInstance(p, ServerCacheManager.class, "serverCacheManager"));
/*      */     
...
/* 1515 */       logValue = "SQL";
/*      */     }
/* 1517 */     return (LogLevel)Enum.valueOf(LogLevel.class, logValue.toUpperCase());
/*      */   }
/*      */   
/*      */   private NamingConvention createNamingConvention(GlobalProperties.PropertySource p)
/*      */   {
/* 1522 */     NamingConvention nc = (NamingConvention)createInstance(p, NamingConvention.class, "namingconvention");
/* 1523 */     if (nc == null) {
/* 1524 */       return null;
/*      */     }
...
/*      */     }
/*      */     
/* 1558 */     ArrayList<Class<?>> classes = new ArrayList();
/*      */     
...
/*      */   {
/* 1577 */     List<String> hitList = new ArrayList();
/*      */     
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\config\ServerConfig.class

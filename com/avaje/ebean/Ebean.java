...
/*      */ 
/*      */ 
/*  141 */   private static final ServerManager serverMgr = new ServerManager(null);
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/*  152 */     private final ConcurrentHashMap<String, EbeanServer> concMap = new ConcurrentHashMap();
/*      */     
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*  158 */     private final HashMap<String, EbeanServer> syncMap = new HashMap();
/*      */     
...
/*      */       }
/*      */       
/*  207 */       EbeanServer server = (EbeanServer)this.concMap.get(name);
/*  208 */       if (server != null) {
/*  209 */         return server;
/*      */       }
/*      */       
...
/*      */       {
/*  222 */         EbeanServer server = (EbeanServer)this.syncMap.get(name);
/*  223 */         if (server == null)
/*      */         {
...
/*  238 */         EbeanServer existingServer = (EbeanServer)this.syncMap.put(server.getName(), server);
...
/*      */   {
/*  749 */     return (T)serverMgr.getPrimaryServer().getReference(beanType, id);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  843 */     return (T)serverMgr.getPrimaryServer().find(beanType, id);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1304 */     return (T)serverMgr.getPrimaryServer().execute(scope, c);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1336 */     return (T)serverMgr.getPrimaryServer().execute(c);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\Ebean.class

...
/* 361 */       this.dbColumnMap = new LinkedHashMap();
/* 362 */       for (int i = 0; i < columns.size(); i++) {
/* 363 */         Column c = (Column)columns.get(i);
...
/* 377 */       this.dbColumnMap = new LinkedHashMap();
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */       
/* 390 */       HashMap<String, Column> pcMap = new HashMap();
/* 391 */       HashMap<String, String> pMap = new HashMap();
/*     */       
...
/* 427 */         this.dbColumnMap.put(dbColumn, new Column(pos, dbColumn, null, propertyName, null));
/*     */       } else {
/* 429 */         Column column = (Column)this.dbColumnMap.get(dbColumn);
/* 430 */         if (column == null) {
...
/*     */     {
/* 486 */       Column c = (Column)this.propertyColumnMap.get(property);
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\RawSql.class

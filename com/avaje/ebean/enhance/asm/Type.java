...
/* 446 */       return "double";
/*     */     case 9: 
/* 448 */       StringBuffer b = new StringBuffer(getElementType().getClassName());
/* 449 */       for (int i = getDimensions(); i > 0; i--) {
/* 450 */         b.append("[]");
/*     */       }
...
/* 625 */     Class d = c;
/*     */     for (;;) {
/* 627 */       if (d.isPrimitive()) { char car;
/*     */         char car;
/* 629 */         if (d == Integer.TYPE) {
/* 630 */           car = 'I'; } else { char car;
/* 631 */           if (d == Void.TYPE) {
/* 632 */             car = 'V'; } else { char car;
/* 633 */             if (d == Boolean.TYPE) {
/* 634 */               car = 'Z'; } else { char car;
/* 635 */               if (d == Byte.TYPE) {
/* 636 */                 car = 'B'; } else { char car;
/* 637 */                 if (d == Character.TYPE) {
/* 638 */                   car = 'C'; } else { char car;
/* 639 */                   if (d == Short.TYPE) {
/* 640 */                     car = 'S'; } else { char car;
/* 641 */                     if (d == Double.TYPE) {
/* 642 */                       car = 'D'; } else { char car;
/* 643 */                       if (d == Float.TYPE) {
/* 644 */                         car = 'F';
/*     */                       } else
/* 646 */                         car = 'J';
...
/* 648 */         buf.append(car);
/* 649 */         return; }
/* 650 */       if (!d.isArray()) break;
/* 651 */       buf.append('[');
/* 652 */       d = d.getComponentType();
/*     */     }
/* 654 */     buf.append('L');
...
/* 761 */         return false;
/*     */       }
/* 763 */       int i = this.off;int j = t.off; for (int end = i + this.len; i < end; j++) {
...
/* 780 */       int i = this.off; for (int end = i + this.len; i < end; i++) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\enhance\asm\Type.class

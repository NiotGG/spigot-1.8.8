...
/*      */       case 10: 
/*      */       case 11: 
/*  289 */         int nameType = this.items[readUnsignedShort(index + 2)];
...
/*  468 */     int w = 0;
/*  469 */     u += 8;
/*  470 */     for (int i = 0; i < implementedItfs.length; i++) {
...
/*  909 */               v += 12;
/*  910 */             case 14: case 1: case 3: case 10: case 2: case 5: case 6: case 11: case 12: case 7: case 15: default:  while (j > 0) {
...
/* 1178 */                 int delta; if (tag < 64)
/*      */                 {
/* 1180 */                   int delta = tag;
/* 1181 */                   frameMode = 3;
/* 1182 */                   frameStackCount = 0;
/* 1183 */                 } else if (tag < 128) {
/* 1184 */                   int delta = tag - 64;
/*      */                   
...
/* 1265 */             int label; switch (ClassWriter.TYPE[opcode]) {
/*      */             case 0: 
...
/*      */             case 6: 
/*      */             case 7: 
/* 1363 */               int cpIndex = this.items[readUnsignedShort(v + 1)];
...
/*      */     
/* 1488 */     for (int i = 0; i < synthetics; i++)
/*      */     {
...
/* 1640 */           zv[i] = (readInt(this.items[readUnsignedShort(v)]) != 0 ? 1 : false);
/* 1641 */           v += 3;
/*      */         }
...
/* 1890 */     long l0 = readInt(index + 4) & 0xFFFFFFFF;
...
/* 1912 */     return this.strings[item] = readUTF(index + 2, readUnsignedShort(index), buf);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\enhance\asm\ClassReader.class

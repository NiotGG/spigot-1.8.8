...
/*  610 */     String t; switch (desc.charAt(index)) {
/*      */     case 'V': 
/*  612 */       return 0;
/*      */     case 'B': 
/*      */     case 'C': 
...
/*  666 */       data = 0x1700000 | cw.addType(t);
/*      */     }
...
/*      */ 
/*  753 */     if (t == 16777222) {
/*  754 */       s = 0x1700000 | cw.addType(cw.thisName); } else { int s;
/*  755 */       if ((t & 0xFFF00000) == 25165824) {
...
/*  949 */         t2 = get(arg - 1);
/*      */         
/*  951 */         if ((t2 == 16777220) || (t2 == 16777219)) {
...
/*      */     case 60: case 61: case 62: case 63: case 64: case 65: case 66: case 67: case 68: case 69: case 70: case 71: case 72: case 73: case 74: case 75: case 76: case 77: case 78: case 186: case 196: case 197: default: 
/* 1229 */       pop(arg);
...
/*      */     }
/*      */     
/* 1258 */     for (int i = 0; i < nLocal; i++) { int t;
...
/* 1266 */           int t; if (kind == 33554432) {
/* 1267 */             t = dim + this.inputLocals[(s & 0xFFFFFF)]; } else { int t;
/* 1268 */             if (kind == 50331648) {
...
/* 1310 */       int s = this.outputStack[i];
/* 1311 */       int dim = s & 0xF0000000;
/* 1312 */       int kind = s & 0xF000000;
/* 1313 */       int t; int t; if (kind == 33554432) {
/* 1314 */         t = dim + this.inputLocals[(s & 0xFFFFFF)]; } else { int t;
/* 1315 */         if (kind == 50331648) {
...
/*      */       {
/* 1367 */         return false; }
/* 1368 */       int v; if ((t & 0xFFF00000) == (u & 0xFFF00000)) { int v;
...
/*      */       } else { int v;
/* 1380 */         if (((t & 0xFF00000) == 24117248) || ((t & 0xF0000000) != 0))
/*      */         {
/*      */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\enhance\asm\Frame.class

...
/*  72 */       FieldMeta fieldMeta = (FieldMeta)fields.get(i);
...
/*     */     {
/* 143 */       FieldMeta fieldMeta = (FieldMeta)fields.get(i);
/*     */       
/* 145 */       mv.visitLabel(switchLabels[i]);
/* 146 */       mv.visitLineNumber(1, switchLabels[i]);
...
/* 222 */       FieldMeta fieldMeta = (FieldMeta)fields.get(i);
/*     */       
/* 224 */       mv.visitLabel(switchLabels[i]);
/* 225 */       mv.visitLineNumber(1, switchLabels[i]);
...
/*     */     {
/* 287 */       FieldMeta fieldMeta = (FieldMeta)fields.get(i);
...
/* 337 */       FieldMeta fieldMeta = (FieldMeta)fields.get(i);
/* 338 */       mv.visitInsn(89);
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\enhance\agent\IndexFieldWeaver.class

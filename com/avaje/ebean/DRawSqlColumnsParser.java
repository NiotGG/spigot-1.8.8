...
/*    */   {
/* 35 */     ArrayList<RawSql.ColumnMapping.Column> columns = new ArrayList();
...
/* 52 */       ArrayList<String> tmp = new ArrayList(split.length);
...
/* 70 */         String msg = "Expecting AS keyword parsing column " + colInfo;
/* 71 */         throw new PersistenceException(msg);
/*    */       }
/* 73 */       return new RawSql.ColumnMapping.Column(this.indexPos++, split[0], split[2]);
/*    */     }
/*    */     
/* 76 */     String msg = "Expecting Max 3 words parsing column " + colInfo + ". Got " + Arrays.toString(split);
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\DRawSqlColumnsParser.class

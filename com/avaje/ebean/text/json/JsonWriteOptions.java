...
/* 122 */       copy.visitorMap = new HashMap(this.visitorMap);
/*     */     }
/* 124 */     return copy;
/*     */   }
/*     */   
...
/* 169 */       this.visitorMap = new HashMap();
/*     */     }
...
/*     */   {
/* 206 */     return setPathProperties(null, parseProps(propertiesToInclude));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 216 */     return setPathProperties(null, propertiesToInclude);
/*     */   }
/*     */   
/*     */   private Set<String> parseProps(String propertiesToInclude)
/*     */   {
/* 221 */     LinkedHashSet<String> props = new LinkedHashSet();
/*     */     
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\text\json\JsonWriteOptions.class

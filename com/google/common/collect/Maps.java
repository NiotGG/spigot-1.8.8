...
/*      */       public V next()
/*      */       {
/*  130 */         return (V)((Map.Entry)this.val$entryIterator.next()).getValue();
/*      */       }
/*      */     };
/*      */   }
/*      */   
...
/*      */     {
/*      */ 
/* 1871 */       public Map.Entry<K, V2> apply(Map.Entry<K, V1> entry) { return Maps.transformEntry(this.val$transformer, entry); }
/*      */     };
/*      */   }
/*      */   
...
/*      */       public Iterator<Map.Entry<K, V>> iterator()
/*      */       {
/* 2705 */         new TransformedIterator(Maps.FilteredEntryMap.this.filteredEntrySet.iterator())
/*      */         {
...
/*      */     public NavigableSet<K> navigableKeySet()
/*      */     {
/* 2909 */       new Maps.NavigableKeySet(this)
/*      */       {
/*      */         public boolean removeAll(Collection<?> c) {
...
/*      */     public V get(@Nullable Object key)
/*      */     {
/* 2947 */       return (V)this.filteredDelegate.get(key);
/*      */     }
/*      */     
/*      */     public boolean containsKey(@Nullable Object key)
/*      */     {
...
/*      */     public V put(K key, V value)
/*      */     {
/* 2957 */       return (V)this.filteredDelegate.put(key, value);
/*      */     }
/*      */     
/*      */     public V remove(@Nullable Object key)
/*      */     {
/* 2962 */       return (V)this.filteredDelegate.remove(key);
/*      */     }
/*      */     
...
/*      */     public K lowerKey(K key)
/*      */     {
/* 3126 */       return (K)this.delegate.lowerKey(key);
/*      */     }
/*      */     
...
/*      */     public K floorKey(K key)
/*      */     {
/* 3136 */       return (K)this.delegate.floorKey(key);
/*      */     }
/*      */     
...
/*      */     public K ceilingKey(K key)
/*      */     {
/* 3146 */       return (K)this.delegate.ceilingKey(key);
/*      */     }
/*      */     
...
/*      */     public K higherKey(K key)
/*      */     {
/* 3156 */       return (K)this.delegate.higherKey(key);
/*      */     }
/*      */     
...
/*      */     public K first()
/*      */     {
/* 3558 */       return (K)map().firstKey();
/*      */     }
/*      */     
/*      */     public K last()
/*      */     {
/* 3563 */       return (K)map().lastKey();
/*      */     }
/*      */   }
/*      */   
/*      */   @GwtIncompatible("NavigableMap")
...
/*      */     public K lower(K e)
/*      */     {
/* 3580 */       return (K)map().lowerKey(e);
/*      */     }
/*      */     
/*      */     public K floor(K e)
/*      */     {
/* 3585 */       return (K)map().floorKey(e);
/*      */     }
/*      */     
/*      */     public K ceiling(K e)
/*      */     {
/* 3590 */       return (K)map().ceilingKey(e);
/*      */     }
/*      */     
/*      */     public K higher(K e)
/*      */     {
/* 3595 */       return (K)map().higherKey(e);
/*      */     }
/*      */     
/*      */     public K pollFirst()
/*      */     {
/* 3600 */       return (K)Maps.keyOrNull(map().pollFirstEntry());
/*      */     }
/*      */     
/*      */     public K pollLast()
/*      */     {
/* 3605 */       return (K)Maps.keyOrNull(map().pollLastEntry());
/*      */     }
/*      */     
...
/*      */     public K firstKey()
/*      */     {
/* 3822 */       return (K)forward().lastKey();
/*      */     }
/*      */     
/*      */     public K lastKey()
/*      */     {
/* 3827 */       return (K)forward().firstKey();
/*      */     }
/*      */     
/*      */     public Map.Entry<K, V> lowerEntry(K key)
/*      */     {
...
/*      */     public K lowerKey(K key)
/*      */     {
/* 3837 */       return (K)forward().higherKey(key);
/*      */     }
/*      */     
/*      */     public Map.Entry<K, V> floorEntry(K key)
/*      */     {
...
/*      */     public K floorKey(K key)
/*      */     {
/* 3847 */       return (K)forward().ceilingKey(key);
/*      */     }
/*      */     
/*      */     public Map.Entry<K, V> ceilingEntry(K key)
/*      */     {
...
/*      */     public K ceilingKey(K key)
/*      */     {
/* 3857 */       return (K)forward().floorKey(key);
/*      */     }
/*      */     
/*      */     public Map.Entry<K, V> higherEntry(K key)
/*      */     {
...
/*      */     public K higherKey(K key)
/*      */     {
/* 3867 */       return (K)forward().lowerKey(key);
/*      */     }
/*      */     
/*      */     public Map.Entry<K, V> firstEntry()
/*      */     {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\google\common\collect\Maps.class

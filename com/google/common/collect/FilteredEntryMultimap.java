...
/* 254 */                 Map.Entry<K, Collection<V>> entry = (Map.Entry)this.backingIterator.next();
/* 255 */                 K key = entry.getKey();
/* 256 */                 Collection<V> collection = FilteredEntryMultimap.filterCollection((Collection)entry.getValue(), new FilteredEntryMultimap.ValuePredicate(FilteredEntryMultimap.this, key));
/*     */                 
...
/* 296 */               Collection<V> collection = FilteredEntryMultimap.filterCollection((Collection)entry.getValue(), new FilteredEntryMultimap.ValuePredicate(FilteredEntryMultimap.this, key));
/*     */               
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\google\common\collect\FilteredEntryMultimap.class

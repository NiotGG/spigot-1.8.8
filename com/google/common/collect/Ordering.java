...
/*     */   
/*     */   @VisibleForTesting
/* 263 */   static class ArbitraryOrdering extends Ordering<Object> { private Map<Object, Integer> uids = Platform.tryWeakKeys(new MapMaker()).makeComputingMap(new Function()
/*     */     {
/*     */ 
/*     */ 
...
/*     */   {
/* 480 */     return (E)min(iterable.iterator());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 556 */     return (E)max(iterable.iterator());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 621 */         E[] array = (Object[])collection.toArray();
...
/*     */     
/* 679 */     E[] buffer = (Object[])new Object[bufferCap];
...
/* 714 */             } else { if (pivotNewIndex >= k) break;
...
/*     */   {
/* 814 */     E[] array = (Object[])Iterables.toArray(elements);
...
/*     */   {
/* 840 */     E[] array = (Object[])Iterables.toArray(elements);
/* 841 */     for (E e : array) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\google\common\collect\Ordering.class

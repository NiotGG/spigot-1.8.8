...
/*      */     public V get()
/*      */     {
/*  163 */       return (V)this.value;
/*      */     }
/*      */     
/*      */     public V checkedGet()
/*      */     {
/*  168 */       return (V)this.value;
/*      */     }
/*      */     
...
/*      */                 } else
/*  485 */                   Futures.FallbackFuture.this.setException(t); } }, MoreExecutors.sameThreadExecutor());
/*      */ 
/*      */           }
/*      */           catch (Throwable e)
/*      */           {
/*  490 */             Futures.FallbackFuture.this.setException(e); } } }, executor);
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */   {
/*  608 */     ChainingListenableFuture<I, O> output = new ChainingListenableFuture(function, input, null);
/*      */     
...
/*  712 */     AsyncFunction<I, O> wrapperFunction = new AsyncFunction()
/*      */     {
/*      */       public ListenableFuture<O> apply(I input) {
/*  715 */         O output = this.val$function.apply(input);
...
/*      */       {
/*  768 */         return (O)applyTransformation(this.val$input.get());
/*      */       }
/*      */       
/*      */       public O get(long timeout, TimeUnit unit)
/*      */         throws InterruptedException, ExecutionException, TimeoutException
/*      */       {
/*  774 */         return (O)applyTransformation(this.val$input.get(timeout, unit));
/*      */       }
/*      */       
...
/*      */         I sourceResult;
/*      */         try {
/*  850 */           sourceResult = Uninterruptibles.getUninterruptibly(this.inputFuture);
/*      */ 
/*      */         }
/*      */         catch (CancellationException e)
/*      */         {
/*  855 */           cancel(false); return;
/*      */         }
/*      */         catch (ExecutionException e)
/*      */         {
/*  859 */           setException(e.getCause()); return;
/*      */         }
/*      */         
/*      */ 
...
/*      */               }
/*      */               finally {
/*  887 */                 Futures.ChainingListenableFuture.this.outputFuture = null; } } }, MoreExecutors.sameThreadExecutor());
/*      */         }
/*      */         
/*      */       }
...
/*      */           } else
/* 1022 */             Futures.NonCancellationPropagatingFuture.this.setException(t); } }, MoreExecutors.sameThreadExecutor());
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */   {
/* 1091 */     ConcurrentLinkedQueue<AsyncSettableFuture<T>> delegates = Queues.newConcurrentLinkedQueue();
/*      */     
...
/*      */       {
/* 1111 */         public void run() { ((AsyncSettableFuture)this.val$delegates.remove()).setFuture(future); } }, executor);
/*      */       
/*      */ 
...
/* 1464 */       X instance = (Exception)newFromConstructor(constructor, cause);
...
/*      */           
/*      */ 
/* 1567 */           Futures.CombinedFuture.this.combiner = null; } }, MoreExecutors.sameThreadExecutor());
/*      */       
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/* 1592 */       int i = 0;
/* 1593 */       for (final ListenableFuture<? extends V> listenable : this.futures) {
/* 1594 */         final int index = i++;
/* 1595 */         listenable.addListener(new Runnable()
/*      */         {
/*      */ 
/* 1598 */           public void run() { Futures.CombinedFuture.this.setOneValue(index, listenable); } }, listenerExecutor);
/*      */       }
/*      */     }
/*      */     
/*      */ 
...
/*      */         
/* 1656 */         V returnValue = Uninterruptibles.getUninterruptibly(future);
...
/*      */         Futures.FutureCombiner<V, C> localCombiner;
/* 1667 */         setExceptionAndMaybeLog(e.getCause()); } catch (Throwable t) { int newRemaining;
/*      */         Futures.FutureCombiner<V, C> localCombiner;
/* 1669 */         setExceptionAndMaybeLog(t); } finally { int newRemaining;
/*      */         Futures.FutureCombiner<V, C> localCombiner;
...
/*      */   {
/* 1690 */     new CombinedFuture(futures, allMustSucceed, listenerExecutor, new FutureCombiner()
/*      */     {
/*      */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\google\common\util\concurrent\Futures.class

...
/*     */   implements Service
/*     */ {
/*  57 */   private static final ListenerCallQueue.Callback<Service.Listener> STARTING_CALLBACK = new ListenerCallQueue.Callback("starting()")
/*     */   {
/*     */     void call(Service.Listener listener) {
/*  60 */       listener.starting();
/*     */     }
/*     */   };
/*  63 */   private static final ListenerCallQueue.Callback<Service.Listener> RUNNING_CALLBACK = new ListenerCallQueue.Callback("running()")
/*     */   {
/*     */     void call(Service.Listener listener) {
/*  66 */       listener.running();
/*     */     }
...
/*     */   {
/*  82 */     new ListenerCallQueue.Callback("terminated({from = " + from + "})") {
/*     */       void call(Service.Listener listener) {
...
/*  90 */     new ListenerCallQueue.Callback("stopping({from = " + from + "})") {
/*     */       void call(Service.Listener listener) {
...
/*     */   {
/* 482 */     new ListenerCallQueue.Callback("failed({from = " + from + ", cause = " + cause + "})")
/*     */     {
/* 484 */       void call(Service.Listener listener) { listener.failed(from, cause); } }.enqueueOn(this.listeners);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\google\common\util\concurrent\AbstractService.class

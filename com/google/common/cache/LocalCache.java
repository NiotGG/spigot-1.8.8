...
/*      */ 
/*      */ 
/* 1137 */     public void setNextInAccessQueue(LocalCache.ReferenceEntry<K, V> next) { this.nextAccess = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1183 */     public void setNextInWriteQueue(LocalCache.ReferenceEntry<K, V> next) { this.nextWrite = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1229 */     public void setNextInAccessQueue(LocalCache.ReferenceEntry<K, V> next) { this.nextAccess = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1269 */     public void setNextInWriteQueue(LocalCache.ReferenceEntry<K, V> next) { this.nextWrite = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1427 */     public void setNextInAccessQueue(LocalCache.ReferenceEntry<K, V> next) { this.nextAccess = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1474 */     public void setNextInWriteQueue(LocalCache.ReferenceEntry<K, V> next) { this.nextWrite = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1521 */     public void setNextInAccessQueue(LocalCache.ReferenceEntry<K, V> next) { this.nextAccess = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1561 */     public void setNextInWriteQueue(LocalCache.ReferenceEntry<K, V> next) { this.nextWrite = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/* 2188 */             if (((LocalCache.ValueReference)valueReference).isLoading()) {
/* 2189 */               return (V)waitForLoadingValue(e, key, (LocalCache.ValueReference)valueReference);
/*      */             }
/*      */           }
/*      */         }
/*      */         
...
/* 2433 */             Object loadingValueReference = new LocalCache.LoadingValueReference(valueReference);
/*      */             
/* 2435 */             e.setValueReference((LocalCache.ValueReference)loadingValueReference);
/* 2436 */             return (LocalCache.LoadingValueReference<K, V>)loadingValueReference;
/*      */           }
/*      */         }
/*      */         
/* 2440 */         this.modCount += 1;
/* 2441 */         LocalCache.LoadingValueReference<K, V> loadingValueReference = new LocalCache.LoadingValueReference();
...
/*      */         
/* 3027 */         for (LocalCache.ReferenceEntry<K, V> e = first; e != null; e = e.getNext()) {
...
/*      */         
/* 3074 */         for (LocalCache.ReferenceEntry<K, V> e = first; e != null; e = e.getNext()) {
...
/* 3332 */             LocalCache.ReferenceEntry<K, V> newFirst; if (v == valueReference) {
...
/* 3366 */             LocalCache.ReferenceEntry<K, V> newFirst; if (v == valueReference) {
...
/*      */       public void setWriteTime(long time) {}
/*      */       
/* 3606 */       public LocalCache.ReferenceEntry<K, V> getNextInWriteQueue() { return this.nextWrite; }
/*      */       
/*      */ 
/*      */       public void setNextInWriteQueue(LocalCache.ReferenceEntry<K, V> next)
/*      */       {
...
/*      */       public void setAccessTime(long time) {}
/*      */       
/* 3743 */       public LocalCache.ReferenceEntry<K, V> getNextInAccessQueue() { return this.nextAccess; }
/*      */       
/*      */ 
/*      */       public void setNextInAccessQueue(LocalCache.ReferenceEntry<K, V> next)
/*      */       {
...
/*      */   }
/*      */   
/* 4358 */   final class KeyIterator extends LocalCache<K, V>.HashIterator<K> { KeyIterator() { super(); }
/*      */     
/*      */ 
/*      */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\google\common\cache\LocalCache.class

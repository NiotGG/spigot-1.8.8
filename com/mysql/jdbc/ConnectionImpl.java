...
/*  268 */     if (Util.isJdbc4()) {
/*      */       try {
/*  270 */         JDBC_4_CONNECTION_CTOR = Class.forName("com.mysql.jdbc.JDBC4Connection").getConstructor(new Class[] { String.class, Integer.TYPE, Properties.class, String.class, String.class });
/*      */ 
/*      */       }
...
/*      */       try
/*      */       {
/*  346 */         Constructor ctr = Timer.class.getConstructor(new Class[] { String.class, Boolean.TYPE });
/*      */         
...
/*      */   
/*      */ 
/*  409 */   private boolean autoCommit = true;
/*      */   
/*      */ 
/*      */ 
...
/*      */   
/*      */ 
/*  449 */   private java.sql.DatabaseMetaData dbmd = null;
/*      */   
/*      */ 
...
/*      */   
/*  463 */   private boolean hasIsolationLevels = false;
/*      */   
/*      */ 
/*  466 */   private boolean hasQuotedIdentifiers = false;
/*      */   
/*      */ 
...
/*      */   
/*  480 */   private boolean isClientTzUTC = false;
/*      */   
/*      */ 
/*  483 */   private boolean isClosed = true;
/*      */   
/*      */ 
/*  486 */   private boolean isInGlobalTx = false;
/*      */   
/*      */ 
/*  489 */   private boolean isRunningOnJDK13 = false;
/*      */   
/*      */ 
/*  492 */   private int isolationLevel = 2;
/*      */   
/*  494 */   private boolean isServerTzUTC = false;
/*      */   
/*      */ 
...
/*      */   
/*      */ 
/*  509 */   private boolean lowerCaseTableNames = false;
/*      */   
/*      */ 
...
/*      */   
/*      */ 
/*  517 */   private boolean maxRowsChanged = false;
/*      */   
/*      */ 
...
/*      */   
/*      */ 
/*  531 */   private boolean needsPing = false;
/*      */   
/*  533 */   private int netBufferLength = 16384;
/*      */   
/*  535 */   private boolean noBackslashEscapes = false;
/*      */   
...
/*      */   
/*  558 */   private boolean parserKnowsUnicode = false;
/*      */   
/*      */ 
...
/*      */   
/*      */ 
/*  577 */   private boolean readInfoMsg = false;
/*      */   
/*      */ 
/*  580 */   private boolean readOnly = false;
/*      */   
/*      */ 
...
/*      */   
/*      */ 
/*  599 */   private boolean transactionsSupported = false;
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/*  608 */   private boolean useAnsiQuotes = false;
/*      */   
/*      */ 
...
/*      */ 
/*      */ 
/*  617 */   private boolean useServerPreparedStmts = false;
/*      */   
...
/*      */   
/*      */ 
/*  640 */   private boolean hasTriedMasterFlag = false;
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try
/*      */     {
/*  705 */       Blob.class.getMethod("truncate", new Class[] { Long.TYPE });
/*      */       
...
/*  802 */       cleanup(ex);
/*      */       
/*  804 */       StringBuffer mesg = new StringBuffer(128);
/*      */       
/*  806 */       if (!getParanoid()) {
...
/*  894 */           histogramCounts[i] += numberOfTimes;
/*      */           
/*  896 */           break;
/*      */         }
/*      */       }
...
/*      */       
/*      */ 
/*  940 */       java.sql.Statement stmt = null;
...
/*      */     throws SQLException
/*      */   {
/* 1416 */     java.sql.PreparedStatement pStmt = clientPrepareStatement(sql);
/*      */     
...
/*      */       } finally {
/* 1681 */         jsr 5; } localObject2 = returnAddress;this.needsPing = getReconnectAtTxEnd();ret;
/*      */       
/*      */ 
/* 1684 */       return;
/*      */     }
...
/* 2136 */       lowerBound = (lowerBound + bucketSize);
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */     
/* 2179 */     for (int attemptCount = 0; 
/* 2180 */         (attemptCount < getMaxReconnects()) && (!connectionGood); attemptCount++) {
/*      */       try {
...
/*      */         
/*      */ 
/* 2224 */         if (!connectionGood) break label167; }
/* 2225 */       break;
/*      */       
/*      */       label167:
/* 2228 */       if (attemptCount > 0) {
/*      */         try {
/* 2230 */           Thread.sleep(timeout * 1000L);
/*      */         }
...
/*      */           }
/*      */           
/* 2620 */           ResultSetInternalMethods localResultSetInternalMethods = this.io.sqlQueryDirect(callingStatement, sql, encoding, null, maxRows, resultSetType, resultSetConcurrency, streamResults, catalog, cachedMetadata);jsr 237;return localResultSetInternalMethods;
/*      */         }
/*      */         
/*      */ 
/*      */ 
/*      */ 
/* 2626 */         String encoding = this.io.sqlQueryDirect(callingStatement, null, null, packet, maxRows, resultSetType, resultSetConcurrency, streamResults, catalog, cachedMetadata);jsr 203;return encoding;
/*      */ 
/*      */ 
/*      */       }
/*      */       catch (SQLException sqlE)
...
/* 2671 */         throw sqlEx;
/*      */       } finally {
/* 2673 */         jsr 6; } localObject2 = returnAddress; if (getMaintainTimeStats()) {
...
/*      */           {
/* 3005 */             java.sql.Statement stmt = null;
...
/* 3077 */     java.sql.Statement stmt = createStatement();
/*      */     
...
/* 3180 */       java.sql.Statement stmt = null;
...
/* 3305 */       this.numberOfPreparedExecutes += 1L;
/*      */       
/*      */ 
/*      */ 
/*      */ 
/* 3310 */       this.numberOfQueriesIssued += 1L;
/*      */     }
/*      */   }
/*      */   
/*      */   public void incrementNumberOfPrepares() {
/* 3315 */     if (getGatherPerformanceMetrics()) {
/* 3316 */       this.numberOfPrepares += 1L;
/*      */     }
/*      */   }
/*      */   
/*      */   public void incrementNumberOfResultSetsCreated() {
/* 3321 */     if (getGatherPerformanceMetrics()) {
/* 3322 */       this.numberOfResultSetsCreated += 1L;
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/* 3654 */         java.sql.Statement stmt = null;
/*      */         try
/*      */         {
...
/*      */   }
/*      */   
/* 3811 */   private boolean usingCachedConfig = false;
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */     }
/*      */     
/* 3835 */     java.sql.Statement stmt = null;
...
/*      */       }
/*      */       
/* 3859 */       String versionComment = "/* " + version + " */";
/*      */       
/*      */ 
...
/*      */   {
/* 3943 */     return this.lowerCaseTableNames;
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 4178 */     java.sql.PreparedStatement pStmt = prepareStatement(sql);
/*      */     
...
/*      */     throws SQLException
/*      */   {
/* 4298 */     java.sql.PreparedStatement pStmt = prepareStatement(sql);
/*      */     
...
/*      */     throws SQLException
/*      */   {
/* 4312 */     java.sql.PreparedStatement pStmt = prepareStatement(sql);
/*      */     
...
/*      */     }
/*      */     
/* 4455 */     this.numberOfQueriesIssued += 1L;
/*      */     
...
/*      */       } finally {
/* 4758 */         jsr 5; } localObject2 = returnAddress;this.needsPing = getReconnectAtTxEnd();ret;
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */           
/* 4796 */           java.sql.Statement stmt = null;
/*      */           try
/*      */           {
...
/*      */           }
/*      */         } finally {
/* 4839 */           jsr 6; } localObject4 = returnAddress;this.needsPing = getReconnectAtTxEnd();ret;
/*      */       }
/*      */       
/*      */     } else {
...
/*      */         
/* 5199 */         java.sql.Statement stmt = null;
/*      */         try
/*      */         {
...
/*      */       
/* 5235 */       java.sql.Statement stmt = null;
/*      */       try
/*      */       {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\ConnectionImpl.class

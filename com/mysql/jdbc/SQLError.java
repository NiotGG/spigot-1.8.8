...
/*  817 */     TreeMap allErrorNumbers = new TreeMap();
...
/*      */ 
/*      */ 
/*  826 */     Iterator mysqlErrorNumbers = mysqlToSql99State.keySet().iterator();
...
/*      */     }
/*      */     
/*  832 */     Iterator mysqlErrorNumbers = mysqlToSqlState.keySet().iterator();
...
/*  948 */     return createSQLException(message, sqlState, cause, interceptor, null);
/*      */   }
/*      */   
...
/*  996 */           if (isTransient) {
/*  997 */             if (!Util.isJdbc4()) {
/*  998 */               sqlEx = new MySQLTransientConnectionException(message, sqlState, vendorErrorCode);
/*      */             }
/*      */             else {
/* 1001 */               sqlEx = (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLTransientConnectionException", new Class[] { String.class, String.class, Integer.TYPE }, new Object[] { message, sqlState, Constants.integerValueOf(vendorErrorCode) }, interceptor);
/*      */ 
/*      */ 
/*      */             }
/*      */             
...
/* 1010 */             sqlEx = new MySQLNonTransientConnectionException(message, sqlState, vendorErrorCode);
/*      */           }
/*      */           else {
/* 1013 */             sqlEx = (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLNonTransientConnectionException", new Class[] { String.class, String.class, Integer.TYPE }, new Object[] { message, sqlState, Constants.integerValueOf(vendorErrorCode) }, interceptor);
/*      */ 
/*      */           }
/*      */           
/*      */ 
...
/* 1022 */             sqlEx = new MySQLDataException(message, sqlState, vendorErrorCode);
/*      */           }
/*      */           else {
/* 1025 */             sqlEx = (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLDataException", new Class[] { String.class, String.class, Integer.TYPE }, new Object[] { message, sqlState, Constants.integerValueOf(vendorErrorCode) }, interceptor);
/*      */ 
/*      */ 
/*      */           }
/*      */           
...
/* 1036 */             sqlEx = new MySQLIntegrityConstraintViolationException(message, sqlState, vendorErrorCode);
/*      */           }
/*      */           else {
/* 1039 */             sqlEx = (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException", new Class[] { String.class, String.class, Integer.TYPE }, new Object[] { message, sqlState, Constants.integerValueOf(vendorErrorCode) }, interceptor);
/*      */ 
/*      */ 
/*      */           }
/*      */           
...
/* 1049 */             sqlEx = new MySQLSyntaxErrorException(message, sqlState, vendorErrorCode);
/*      */           }
/*      */           else {
/* 1052 */             sqlEx = (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException", new Class[] { String.class, String.class, Integer.TYPE }, new Object[] { message, sqlState, Constants.integerValueOf(vendorErrorCode) }, interceptor);
/*      */ 
/*      */           }
/*      */           
/*      */ 
...
/* 1061 */             sqlEx = new MySQLTransactionRollbackException(message, sqlState, vendorErrorCode);
/*      */           }
/*      */           else {
/* 1064 */             sqlEx = (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLTransactionRollbackException", new Class[] { String.class, String.class, Integer.TYPE }, new Object[] { message, sqlState, Constants.integerValueOf(vendorErrorCode) }, interceptor);
/*      */ 
/*      */           }
/*      */           
/*      */ 
...
/*      */ 
/*      */       }
/* 1273 */       else if ((underlyingException instanceof BindException)) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\SQLError.class

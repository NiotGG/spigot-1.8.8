...
/*      */   static
/*      */   {
/*   81 */     HashMap tempNumBytesMap = new HashMap();
/*      */     
...
/*      */     
/*  296 */     INDEX_TO_CHARSET = new String['ÿ'];
/*      */     try
/*      */     {
...
/*      */       
/*  498 */       INDEX_TO_CHARSET[''] = getJavaEncodingForMysqlEncoding("ucs2", null);
/*      */       
/*  500 */       INDEX_TO_CHARSET[''] = getJavaEncodingForMysqlEncoding("ucs2", null);
/*      */       
/*  502 */       INDEX_TO_CHARSET[''] = getJavaEncodingForMysqlEncoding("ucs2", null);
/*      */       
/*  504 */       INDEX_TO_CHARSET[''] = getJavaEncodingForMysqlEncoding("ucs2", null);
/*      */       
/*      */ 
/*  507 */       for (int i = 147; i < 192; i++) {
/*  508 */         INDEX_TO_CHARSET[i] = "ISO8859_1";
/*      */       }
/*      */       
/*  511 */       INDEX_TO_CHARSET['À'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  513 */       INDEX_TO_CHARSET['Á'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  515 */       INDEX_TO_CHARSET['Â'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  517 */       INDEX_TO_CHARSET['Ã'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  519 */       INDEX_TO_CHARSET['Ä'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  521 */       INDEX_TO_CHARSET['Å'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  523 */       INDEX_TO_CHARSET['Æ'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  525 */       INDEX_TO_CHARSET['Ç'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  527 */       INDEX_TO_CHARSET['È'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  529 */       INDEX_TO_CHARSET['É'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  531 */       INDEX_TO_CHARSET['Ê'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  533 */       INDEX_TO_CHARSET['Ë'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  535 */       INDEX_TO_CHARSET['Ì'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  537 */       INDEX_TO_CHARSET['Í'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  539 */       INDEX_TO_CHARSET['Î'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  541 */       INDEX_TO_CHARSET['Ï'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  543 */       INDEX_TO_CHARSET['Ð'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  545 */       INDEX_TO_CHARSET['Ñ'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*  547 */       INDEX_TO_CHARSET['Ò'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*      */ 
/*  550 */       INDEX_TO_CHARSET['Ó'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*      */ 
/*  553 */       for (int i = 212; i < 224; i++) {
/*  554 */         INDEX_TO_CHARSET[i] = "ISO8859_1";
/*      */       }
/*      */       
/*  557 */       for (int i = 224; i <= 243; i++) {
/*  558 */         INDEX_TO_CHARSET[i] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       }
/*      */       
/*      */ 
/*  562 */       for (int i = 101; i <= 120; i++) {
/*  563 */         INDEX_TO_CHARSET[i] = getJavaEncodingForMysqlEncoding("utf16", null);
/*      */       }
/*      */       
/*      */ 
/*  567 */       for (int i = 160; i <= 179; i++) {
/*  568 */         INDEX_TO_CHARSET[i] = getJavaEncodingForMysqlEncoding("utf32", null);
/*      */       }
/*      */       
/*      */ 
/*  572 */       for (int i = 244; i < 254; i++) {
/*  573 */         INDEX_TO_CHARSET[i] = "ISO8859_1";
/*      */       }
/*      */       
/*  576 */       INDEX_TO_CHARSET['þ'] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */ 
/*  590 */     INDEX_TO_COLLATION = new String['ÿ'];
/*      */     
...
/*  683 */     INDEX_TO_COLLATION[''] = "ucs2_unicode_ci";
/*  684 */     INDEX_TO_COLLATION[''] = "ucs2_icelandic_ci";
/*  685 */     INDEX_TO_COLLATION[''] = "ucs2_latvian_ci";
/*  686 */     INDEX_TO_COLLATION[''] = "ucs2_romanian_ci";
/*  687 */     INDEX_TO_COLLATION[''] = "ucs2_slovenian_ci";
/*  688 */     INDEX_TO_COLLATION[''] = "ucs2_polish_ci";
/*  689 */     INDEX_TO_COLLATION[''] = "ucs2_estonian_ci";
/*  690 */     INDEX_TO_COLLATION[''] = "ucs2_spanish_ci";
/*  691 */     INDEX_TO_COLLATION[''] = "ucs2_swedish_ci";
/*  692 */     INDEX_TO_COLLATION[''] = "ucs2_turkish_ci";
/*  693 */     INDEX_TO_COLLATION[''] = "ucs2_czech_ci";
/*  694 */     INDEX_TO_COLLATION[''] = "ucs2_danish_ci";
/*  695 */     INDEX_TO_COLLATION[''] = "ucs2_lithuanian_ci ";
/*  696 */     INDEX_TO_COLLATION[''] = "ucs2_slovak_ci";
/*  697 */     INDEX_TO_COLLATION[''] = "ucs2_spanish2_ci";
/*  698 */     INDEX_TO_COLLATION[''] = "ucs2_roman_ci";
/*  699 */     INDEX_TO_COLLATION[''] = "ucs2_persian_ci";
/*  700 */     INDEX_TO_COLLATION[''] = "ucs2_esperanto_ci";
/*  701 */     INDEX_TO_COLLATION[''] = "ucs2_hungarian_ci";
/*  702 */     INDEX_TO_COLLATION['À'] = "utf8_unicode_ci";
/*  703 */     INDEX_TO_COLLATION['Á'] = "utf8_icelandic_ci";
/*  704 */     INDEX_TO_COLLATION['Â'] = "utf8_latvian_ci";
/*  705 */     INDEX_TO_COLLATION['Ã'] = "utf8_romanian_ci";
/*  706 */     INDEX_TO_COLLATION['Ä'] = "utf8_slovenian_ci";
/*  707 */     INDEX_TO_COLLATION['Å'] = "utf8_polish_ci";
/*  708 */     INDEX_TO_COLLATION['Æ'] = "utf8_estonian_ci";
/*  709 */     INDEX_TO_COLLATION['Ç'] = "utf8_spanish_ci";
/*  710 */     INDEX_TO_COLLATION['È'] = "utf8_swedish_ci";
/*  711 */     INDEX_TO_COLLATION['É'] = "utf8_turkish_ci";
/*  712 */     INDEX_TO_COLLATION['Ê'] = "utf8_czech_ci";
/*  713 */     INDEX_TO_COLLATION['Ë'] = "utf8_danish_ci";
/*  714 */     INDEX_TO_COLLATION['Ì'] = "utf8_lithuanian_ci ";
/*  715 */     INDEX_TO_COLLATION['Í'] = "utf8_slovak_ci";
/*  716 */     INDEX_TO_COLLATION['Î'] = "utf8_spanish2_ci";
/*  717 */     INDEX_TO_COLLATION['Ï'] = "utf8_roman_ci";
/*  718 */     INDEX_TO_COLLATION['Ð'] = "utf8_persian_ci";
/*  719 */     INDEX_TO_COLLATION['Ñ'] = "utf8_esperanto_ci";
/*  720 */     INDEX_TO_COLLATION['Ò'] = "utf8_hungarian_ci";
/*      */     
/*      */ 
/*      */ 
/*  724 */     INDEX_TO_COLLATION[33] = "utf8mb3_general_ci";
/*  725 */     INDEX_TO_COLLATION[83] = "utf8mb3_bin";
/*  726 */     INDEX_TO_COLLATION['À'] = "utf8mb3_unicode_ci";
/*  727 */     INDEX_TO_COLLATION['Á'] = "utf8mb3_icelandic_ci";
/*  728 */     INDEX_TO_COLLATION['Â'] = "utf8mb3_latvian_ci";
/*  729 */     INDEX_TO_COLLATION['Ã'] = "utf8mb3_romanian_ci";
/*  730 */     INDEX_TO_COLLATION['Ä'] = "utf8mb3_slovenian_ci";
/*  731 */     INDEX_TO_COLLATION['Å'] = "utf8mb3_polish_ci";
/*  732 */     INDEX_TO_COLLATION['Æ'] = "utf8mb3_estonian_ci";
/*  733 */     INDEX_TO_COLLATION['Ç'] = "utf8mb3_spanish_ci";
/*  734 */     INDEX_TO_COLLATION['È'] = "utf8mb3_swedish_ci";
/*  735 */     INDEX_TO_COLLATION['É'] = "utf8mb3_turkish_ci";
/*  736 */     INDEX_TO_COLLATION['Ê'] = "utf8mb3_czech_ci";
/*  737 */     INDEX_TO_COLLATION['Ë'] = "utf8mb3_danish_ci";
/*  738 */     INDEX_TO_COLLATION['Ì'] = "utf8mb3_lithuanian_ci";
/*  739 */     INDEX_TO_COLLATION['Í'] = "utf8mb3_slovak_ci";
/*  740 */     INDEX_TO_COLLATION['Î'] = "utf8mb3_spanish2_ci";
/*  741 */     INDEX_TO_COLLATION['Ï'] = "utf8mb3_roman_ci";
/*  742 */     INDEX_TO_COLLATION['Ð'] = "utf8mb3_persian_ci";
/*  743 */     INDEX_TO_COLLATION['Ñ'] = "utf8mb3_esperanto_ci";
/*  744 */     INDEX_TO_COLLATION['Ò'] = "utf8mb3_hungarian_ci";
/*  745 */     INDEX_TO_COLLATION['Ó'] = "utf8mb3_sinhala_ci";
/*  746 */     INDEX_TO_COLLATION['þ'] = "utf8mb3_general_cs";
/*      */     
/*      */ 
...
/*  774 */     INDEX_TO_COLLATION[' '] = "utf32_unicode_ci";
/*  775 */     INDEX_TO_COLLATION['¡'] = "utf32_icelandic_ci";
/*  776 */     INDEX_TO_COLLATION['¢'] = "utf32_latvian_ci";
/*  777 */     INDEX_TO_COLLATION['£'] = "utf32_romanian_ci";
/*  778 */     INDEX_TO_COLLATION['¤'] = "utf32_slovenian_ci";
/*  779 */     INDEX_TO_COLLATION['¥'] = "utf32_polish_ci";
/*  780 */     INDEX_TO_COLLATION['¦'] = "utf32_estonian_ci";
/*  781 */     INDEX_TO_COLLATION['§'] = "utf32_spanish_ci";
/*  782 */     INDEX_TO_COLLATION['¨'] = "utf32_swedish_ci";
/*  783 */     INDEX_TO_COLLATION['©'] = "utf32_turkish_ci";
/*  784 */     INDEX_TO_COLLATION['ª'] = "utf32_czech_ci";
/*  785 */     INDEX_TO_COLLATION['«'] = "utf32_danish_ci";
/*  786 */     INDEX_TO_COLLATION['¬'] = "utf32_lithuanian_ci";
/*  787 */     INDEX_TO_COLLATION['­'] = "utf32_slovak_ci";
/*  788 */     INDEX_TO_COLLATION['®'] = "utf32_spanish2_ci";
/*  789 */     INDEX_TO_COLLATION['¯'] = "utf32_roman_ci";
/*  790 */     INDEX_TO_COLLATION['°'] = "utf32_persian_ci";
/*  791 */     INDEX_TO_COLLATION['±'] = "utf32_esperanto_ci";
/*  792 */     INDEX_TO_COLLATION['²'] = "utf32_hungarian_ci";
/*  793 */     INDEX_TO_COLLATION['³'] = "utf32_sinhala_ci";
/*      */     
/*  795 */     INDEX_TO_COLLATION['à'] = "utf8mb4_unicode_ci";
/*  796 */     INDEX_TO_COLLATION['á'] = "utf8mb4_icelandic_ci";
/*  797 */     INDEX_TO_COLLATION['â'] = "utf8mb4_latvian_ci";
/*  798 */     INDEX_TO_COLLATION['ã'] = "utf8mb4_romanian_ci";
/*  799 */     INDEX_TO_COLLATION['ä'] = "utf8mb4_slovenian_ci";
/*  800 */     INDEX_TO_COLLATION['å'] = "utf8mb4_polish_ci";
/*  801 */     INDEX_TO_COLLATION['æ'] = "utf8mb4_estonian_ci";
/*  802 */     INDEX_TO_COLLATION['ç'] = "utf8mb4_spanish_ci";
/*  803 */     INDEX_TO_COLLATION['è'] = "utf8mb4_swedish_ci";
/*  804 */     INDEX_TO_COLLATION['é'] = "utf8mb4_turkish_ci";
/*  805 */     INDEX_TO_COLLATION['ê'] = "utf8mb4_czech_ci";
/*  806 */     INDEX_TO_COLLATION['ë'] = "utf8mb4_danish_ci";
/*  807 */     INDEX_TO_COLLATION['ì'] = "utf8mb4_lithuanian_ci";
/*  808 */     INDEX_TO_COLLATION['í'] = "utf8mb4_slovak_ci";
/*  809 */     INDEX_TO_COLLATION['î'] = "utf8mb4_spanish2_ci";
/*  810 */     INDEX_TO_COLLATION['ï'] = "utf8mb4_roman_ci";
/*  811 */     INDEX_TO_COLLATION['ð'] = "utf8mb4_persian_ci";
/*  812 */     INDEX_TO_COLLATION['ñ'] = "utf8mb4_esperanto_ci";
/*  813 */     INDEX_TO_COLLATION['ò'] = "utf8mb4_hungarian_ci";
/*  814 */     INDEX_TO_COLLATION['ó'] = "utf8mb4_sinhala_ci";
/*  815 */     INDEX_TO_COLLATION['ô'] = "utf8mb4_german2_ci";
/*      */     
...
/*      */         
/*      */ 
/*  900 */         if (!propToCheck.isOkayForVersion(conn)) break;
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\CharsetMapping.class

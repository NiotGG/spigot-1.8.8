...
/*     */     
/* 355 */     return b[(this.position++)] & 0xFF | (b[(this.position++)] & 0xFF) << 8 | (b[(this.position++)] & 0xFF) << 16 | (b[(this.position++)] & 0xFF) << 24;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 599 */     b[(this.position++)] = ((byte)(int)(i & 0xFF));
...
/* 617 */     b[(this.position++)] = ((byte)(int)(i & 0xFF));
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\Buffer.class

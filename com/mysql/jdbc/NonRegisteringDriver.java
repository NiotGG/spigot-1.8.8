...
/*     */     
/* 339 */     List<String> hostList = new ArrayList();
/*     */     
/* 341 */     for (int i = 0; i < numHosts; i++) {
/* 342 */       int index = i + 1;
/*     */       
/* 344 */       hostList.add(parsedProps.getProperty(new StringBuilder().append("HOST.").append(index).toString()) + ":" + parsedProps.getProperty(new StringBuilder().append("PORT.").append(index).toString()));
/*     */     }
/*     */     
/*     */ 
...
/*     */     
/*     */ 
/* 351 */     return (java.sql.Connection)Proxy.newProxyInstance(getClass().getClassLoader(), new Class[] { Connection.class }, proxyBal);
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/*     */ 
/* 371 */     List<String> hostList = new ArrayList();
/*     */     
/* 373 */     for (int i = 0; i < numHosts; i++) {
/* 374 */       int index = i + 1;
/*     */       
/* 376 */       hostList.add(parsedProps.getProperty(new StringBuilder().append("HOST.").append(index).toString()) + ":" + parsedProps.getProperty(new StringBuilder().append("PORT.").append(index).toString()));
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     
/*     */ 
/* 385 */     return (java.sql.Connection)Proxy.newProxyInstance(getClass().getClassLoader(), new Class[] { Connection.class }, connProxy);
/*     */   }
/*     */   
/*     */ 
...
/* 681 */           urlProps.setProperty("PORT." + numHosts, hostPortPair[1]);
/*     */         } else {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\NonRegisteringDriver.class

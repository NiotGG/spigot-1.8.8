...
/* 166 */       int tmp206_204 = i; char[] tmp206_202 = chars;tmp206_202[tmp206_204] = ((char)(tmp206_202[tmp206_204] ^ (char)tmp206_204));
/*     */     }
/*     */     
...
/* 184 */         nr ^= ((nr & 0x3F) + add) * tmp + (nr << 8);
/* 185 */         nr2 += (nr2 << 8 ^ nr);
/* 186 */         add += tmp;
/*     */       }
/*     */     }
/* 189 */     long[] result = new long[2];
/* 190 */     result[0] = (nr & 0x7FFFFFFF);
/* 191 */     result[1] = (nr2 & 0x7FFFFFFF);
/*     */     
/* 193 */     return result;
/*     */   }
/*     */   
...
/* 241 */         nr ^= ((nr & 0x3F) + nr2) * tmp + (nr << 8);
/* 242 */         nr2 += tmp;
/*     */       }
/*     */     }
/* 245 */     return nr & 0x7FFFFFFF;
/*     */   }
/*     */   
/*     */   private static RandStructcture randomInit(long seed1, long seed2) {
/* 249 */     Util tmp7_4 = enclosingInstance;tmp7_4.getClass();RandStructcture randStruct = new RandStructcture(tmp7_4);
/*     */     
...
/* 328 */         int tmp141_139 = i; byte[] tmp141_138 = to;tmp141_138[tmp141_139] = ((byte)(tmp141_138[tmp141_139] ^ extra));
/*     */       }
/*     */       
...
/*     */     try
/*     */     {
/* 446 */       Class networkInterfaceClass = Class.forName("java.net.NetworkInterface");
/*     */       
/* 448 */       return networkInterfaceClass.getMethod("getByName", (Class[])null).invoke(networkInterfaceClass, new Object[] { hostname }) != null;
/*     */     }
/*     */     catch (Throwable t) {}
/* 451 */     return false;
/*     */   }
...
/*     */ 
/*     */         }
/* 532 */         else if ((value1 instanceof Short)) {
/* 533 */           diffMap.put(key, new Short((short)(((Short)value2).shortValue() - ((Short)value1).shortValue())));
/*     */         }
/* 535 */         else if ((value1 instanceof Integer)) {
/* 536 */           diffMap.put(key, new Integer(((Integer)value2).intValue() - ((Integer)value1).intValue()));
/*     */ 
/*     */         }
/* 539 */         else if ((value1 instanceof Long)) {
/* 540 */           diffMap.put(key, new Long(((Long)value2).longValue() - ((Long)value1).longValue()));
/*     */ 
/*     */         }
/* 543 */         else if ((value1 instanceof Float)) {
/* 544 */           diffMap.put(key, new Float(((Float)value2).floatValue() - ((Float)value1).floatValue()));
/*     */         }
/* 546 */         else if ((value1 instanceof Double)) {
/* 547 */           diffMap.put(key, new Double(((Double)value2).shortValue() - ((Double)value1).shortValue()));
/*     */ 
/*     */         }
/* 550 */         else if ((value1 instanceof BigDecimal)) {
/* 551 */           diffMap.put(key, ((BigDecimal)value2).subtract((BigDecimal)value1));
/*     */         }
/* 553 */         else if ((value1 instanceof BigInteger)) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\Util.class

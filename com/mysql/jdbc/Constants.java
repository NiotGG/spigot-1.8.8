...
/*     */ 
/*     */ 
/*  55 */   private static final Character[] CHARACTER_CACHE = new Character[''];
/*     */   
/*     */   private static final int BYTE_CACHE_OFFSET = 128;
/*     */   
/*  59 */   private static final Byte[] BYTE_CACHE = new Byte['Ā'];
/*     */   
/*     */   private static final int INTEGER_CACHE_OFFSET = 128;
/*     */   
/*  63 */   private static final Integer[] INTEGER_CACHE = new Integer['Ā'];
/*     */   
/*     */   private static final int SHORT_CACHE_OFFSET = 128;
/*     */   
/*  67 */   private static final Short[] SHORT_CACHE = new Short['Ā'];
/*     */   
/*  69 */   private static final Long[] LONG_CACHE = new Long['Ā'];
/*     */   private static final int LONG_CACHE_OFFSET = 128;
/*     */   
/*     */   static
/*     */   {
/*  74 */     for (int i = 0; i < CHARACTER_CACHE.length; i++) {
/*  75 */       CHARACTER_CACHE[i] = new Character((char)i);
/*     */     }
/*     */     
/*  78 */     for (int i = 0; i < INTEGER_CACHE.length; i++) {
/*  79 */       INTEGER_CACHE[i] = new Integer(i - 128);
/*     */     }
/*     */     
/*  82 */     for (int i = 0; i < SHORT_CACHE.length; i++) {
/*  83 */       SHORT_CACHE[i] = new Short((short)(i - 128));
/*     */     }
/*     */     
/*  86 */     for (int i = 0; i < LONG_CACHE.length; i++) {
/*  87 */       LONG_CACHE[i] = new Long(i - 128);
/*     */     }
/*     */     
/*  90 */     for (int i = 0; i < BYTE_CACHE.length; i++) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\Constants.class

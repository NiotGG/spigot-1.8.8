...
/*     */     String str;
/* 439 */     if (paramInt < 100) {
/* 440 */       str = "Unknown Status";
/* 441 */     } else if (paramInt < 200) {
/* 442 */       str = "Informational";
/* 443 */     } else if (paramInt < 300) {
/* 444 */       str = "Successful";
/* 445 */     } else if (paramInt < 400) {
/* 446 */       str = "Redirection";
/* 447 */     } else if (paramInt < 500) {
/* 448 */       str = "Client Error";
/* 449 */     } else if (paramInt < 600) {
/* 450 */       str = "Server Error";
/*     */     } else {
/* 452 */       str = "Unknown Status";
/*     */     }
/*     */     
/* 455 */     return new HttpResponseStatus(paramInt, str + " (" + paramInt + ')');
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 468 */     this(paramInt, paramString, false);
/*     */   }
/*     */   
/*     */   private HttpResponseStatus(int paramInt, String paramString, boolean paramBoolean) {
/* 472 */     if (paramInt < 0) {
/* 473 */       throw new IllegalArgumentException("code: " + paramInt + " (expected: 0+)");
/*     */     }
/*     */     
/*     */ 
...
/*     */     }
/*     */     
/* 481 */     for (int i = 0; i < paramString.length(); i++) {
/* 482 */       int j = paramString.charAt(i);
/*     */       
/* 484 */       switch (j) {
/*     */       case 10: case 13: 
...
/*     */     
/*     */ 
/* 492 */     this.code = paramInt;
/* 493 */     this.reasonPhrase = paramString;
/* 494 */     if (paramBoolean) {
/* 495 */       this.bytes = (paramInt + " " + paramString).getBytes(CharsetUtil.US_ASCII);
/*     */     } else {
/* 497 */       this.bytes = null;
/*     */     }
/*     */   }
...
/*     */   {
/* 526 */     if (!(paramObject instanceof HttpResponseStatus)) {
/* 527 */       return false;
/*     */     }
/*     */     
/* 530 */     return code() == ((HttpResponseStatus)paramObject).code();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 539 */     return code() - paramHttpResponseStatus.code();
/*     */   }
/*     */   
/*     */   public String toString()
/*     */   {
/* 544 */     StringBuilder localStringBuilder = new StringBuilder(this.reasonPhrase.length() + 5);
/* 545 */     localStringBuilder.append(this.code);
/* 546 */     localStringBuilder.append(' ');
/* 547 */     localStringBuilder.append(this.reasonPhrase);
/* 548 */     return localStringBuilder.toString();
/*     */   }
/*     */   
/*     */   void encode(ByteBuf paramByteBuf) {
/* 552 */     if (this.bytes == null) {
/* 553 */       HttpHeaders.encodeAscii0(String.valueOf(code()), paramByteBuf);
/* 554 */       paramByteBuf.writeByte(32);
/* 555 */       HttpHeaders.encodeAscii0(String.valueOf(reasonPhrase()), paramByteBuf);
/*     */     } else {
/* 557 */       paramByteBuf.writeBytes(this.bytes);
/*     */     }
/*     */   }
/*     */ }

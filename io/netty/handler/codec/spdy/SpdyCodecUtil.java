...
/*     */   {
/* 245 */     return (paramByteBuf.getByte(paramInt) & 0xFF) << 8 | paramByteBuf.getByte(paramInt + 1) & 0xFF;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 253 */     return (paramByteBuf.getByte(paramInt) & 0xFF) << 16 | (paramByteBuf.getByte(paramInt + 1) & 0xFF) << 8 | paramByteBuf.getByte(paramInt + 2) & 0xFF;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 262 */     return (paramByteBuf.getByte(paramInt) & 0x7F) << 24 | (paramByteBuf.getByte(paramInt + 1) & 0xFF) << 16 | (paramByteBuf.getByte(paramInt + 2) & 0xFF) << 8 | paramByteBuf.getByte(paramInt + 3) & 0xFF;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 272 */     return (paramByteBuf.getByte(paramInt) & 0xFF) << 24 | (paramByteBuf.getByte(paramInt + 1) & 0xFF) << 16 | (paramByteBuf.getByte(paramInt + 2) & 0xFF) << 8 | paramByteBuf.getByte(paramInt + 3) & 0xFF;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 283 */     return paramInt % 2 == 0;
/*     */   }
/*     */   
/*     */ 
/*     */ 
/*     */   static void validateHeaderName(String paramString)
/*     */   {
/* 290 */     if (paramString == null) {
/* 291 */       throw new NullPointerException("name");
/*     */     }
/* 293 */     if (paramString.isEmpty()) {
/* 294 */       throw new IllegalArgumentException("name cannot be length zero");
/*     */     }
/*     */     
/*     */ 
/*     */ 
/* 299 */     if (paramString.length() > 65535) {
/* 300 */       throw new IllegalArgumentException("name exceeds allowable length: " + paramString);
/*     */     }
/*     */     
/* 303 */     for (int i = 0; i < paramString.length(); i++) {
/* 304 */       int j = paramString.charAt(i);
/* 305 */       if (j == 0) {
/* 306 */         throw new IllegalArgumentException("name contains null character: " + paramString);
/*     */       }
/*     */       
/* 309 */       if (j > 127) {
/* 310 */         throw new IllegalArgumentException("name contains non-ascii character: " + paramString);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */ 
/*     */ 
/*     */   static void validateHeaderValue(String paramString)
/*     */   {
/* 320 */     if (paramString == null) {
/* 321 */       throw new NullPointerException("value");
/*     */     }
/* 323 */     for (int i = 0; i < paramString.length(); i++) {
/* 324 */       int j = paramString.charAt(i);
/* 325 */       if (j == 0) {
/* 326 */         throw new IllegalArgumentException("value contains null character: " + paramString);
/*     */       }
/*     */     }
/*     */   }
/*     */ }

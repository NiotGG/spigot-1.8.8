...
/*     */     }
/*     */     
/* 124 */     paramString = paramString.trim().toUpperCase();
/* 125 */     if (paramString.isEmpty()) {
/* 126 */       throw new IllegalArgumentException("empty name");
/*     */     }
/*     */     
/* 129 */     HttpMethod localHttpMethod = (HttpMethod)methodMap.get(paramString);
/* 130 */     if (localHttpMethod != null) {
/* 131 */       return localHttpMethod;
/*     */     }
/* 133 */     return new HttpMethod(paramString);
/*     */   }
/*     */ }

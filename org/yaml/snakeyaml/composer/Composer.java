...
/* 225 */       Node itemKey = composeNode(node);
/* 226 */       if (itemKey.getTag().equals(Tag.MERGE)) {
/* 227 */         node.setMerged(true);
/*     */       }
/* 229 */       Node itemValue = composeNode(node);
/* 230 */       children.add(new NodeTuple(itemKey, itemValue));
/*     */     }
/* 232 */     Event endEvent = this.parser.getEvent();
/* 233 */     node.setEndMark(endEvent.getEndMark());
/* 234 */     return node;
/*     */   }
/*     */ }


/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\yaml\snakeyaml\composer\Composer.class

...
/*     */ {
/*  24 */   private static Queue<CustomTimingsHandler> HANDLERS = new ConcurrentLinkedQueue();
/*     */   
...
/*     */       }
/*     */     }
/*  91 */     org.bukkit.command.defaults.TimingsCommand.timingStart = System.nanoTime();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */         {
/* 106 */           CustomTimingsHandler tmp45_44 = timings;tmp45_44.violations = ((tmp45_44.violations + Math.ceil(tmp45_44.curTickTotal / 50000000L)));
/*     */         }
/* 108 */         tmp45_44.curTickTotal = 0L;
/* 109 */         tmp45_44.timingDepth = 0L;
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* 123 */       if (this.parent != null) { if (++this.parent.timingDepth == 1L)
/*     */         {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\spigotmc\CustomTimingsHandler.class

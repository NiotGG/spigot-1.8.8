...
/*     */   
/*  66 */   private static final short[] ANSI_FOREGROUND_COLOR_MAP = { 0, Kernel32.FOREGROUND_RED, Kernel32.FOREGROUND_GREEN, FOREGROUND_YELLOW, Kernel32.FOREGROUND_BLUE, FOREGROUND_MAGENTA, FOREGROUND_CYAN, FOREGROUND_WHITE };
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*  77 */   private static final short[] ANSI_BACKGROUND_COLOR_MAP = { 0, Kernel32.BACKGROUND_RED, Kernel32.BACKGROUND_GREEN, BACKGROUND_YELLOW, Kernel32.BACKGROUND_BLUE, BACKGROUND_MAGENTA, BACKGROUND_CYAN, BACKGROUND_WHITE };
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */     case 2: 
/* 144 */       Kernel32.COORD topLeft = new Kernel32.COORD();
/* 145 */       topLeft.x = 0;
/* 146 */       topLeft.y = this.info.window.top;
/* 147 */       int screenLength = this.info.window.height() * this.info.size.x;
/* 148 */       Kernel32.FillConsoleOutputCharacterW(console, ' ', screenLength, topLeft, written);
/* 149 */       break;
/*     */     case 1: 
/* 151 */       Kernel32.COORD topLeft2 = new Kernel32.COORD();
/* 152 */       topLeft2.x = 0;
/* 153 */       topLeft2.y = this.info.window.top;
/* 154 */       int lengthToCursor = (this.info.cursorPosition.y - this.info.window.top) * this.info.size.x + this.info.cursorPosition.x;
/*     */       
/* 156 */       Kernel32.FillConsoleOutputCharacterW(console, ' ', lengthToCursor, topLeft2, written);
/* 157 */       break;
/*     */     case 0: 
/* 159 */       int lengthToEnd = (this.info.window.bottom - this.info.cursorPosition.y) * this.info.size.x + (this.info.size.x - this.info.cursorPosition.x);
/*     */       
...
/*     */     case 2: 
/* 171 */       Kernel32.COORD leftColCurrRow = this.info.cursorPosition.copy();
/* 172 */       leftColCurrRow.x = 0;
/* 173 */       Kernel32.FillConsoleOutputCharacterW(console, ' ', this.info.size.x, leftColCurrRow, written);
/* 174 */       break;
/*     */     case 1: 
/* 176 */       Kernel32.COORD leftColCurrRow2 = this.info.cursorPosition.copy();
...
/* 179 */       break;
/*     */     case 0: 
/* 181 */       int lengthToLastCol = this.info.size.x - this.info.cursorPosition.x;
...
/*     */   {
/* 243 */     this.info.attributes = ((short)(this.info.attributes & 0xFF00 | this.originalColors));
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\fusesource\jansi\WindowsAnsiOutputStream.class

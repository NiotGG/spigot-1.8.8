...
/*     */   {
/* 182 */     return crypt(paramArrayOfByte, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 200 */       localObject = new Random();
/* 201 */       i = SALT_CHARS.length;
/* 202 */       paramString = "" + SALT_CHARS[localObject.nextInt(i)] + SALT_CHARS[localObject.nextInt(i)];
/*     */     }
/* 204 */     else if (!paramString.matches("^[./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz]{2,}$")) {
/* 205 */       throw new IllegalArgumentException("Invalid salt value: " + paramString);
/*     */     }
/*     */     
/* 208 */     Object localObject = new StringBuilder("             ");
/* 209 */     int i = paramString.charAt(0);
/* 210 */     char c = paramString.charAt(1);
/* 211 */     ((StringBuilder)localObject).setCharAt(0, i);
/* 212 */     ((StringBuilder)localObject).setCharAt(1, c);
/* 213 */     int j = CON_SALT[i];
/* 214 */     int k = CON_SALT[c] << 4;
/* 215 */     byte[] arrayOfByte1 = new byte[8];
/* 216 */     for (int m = 0; m < arrayOfByte1.length; m++) {
/* 217 */       arrayOfByte1[m] = 0;
/*     */     }
/*     */     
/* 220 */     for (m = 0; (m < arrayOfByte1.length) && (m < paramArrayOfByte.length); m++) {
/* 221 */       int n = paramArrayOfByte[m];
/* 222 */       arrayOfByte1[m] = ((byte)(n << 1));
/*     */     }
/*     */     
/* 225 */     int[] arrayOfInt1 = desSetKey(arrayOfByte1);
/* 226 */     int[] arrayOfInt2 = body(arrayOfInt1, j, k);
/* 227 */     byte[] arrayOfByte2 = new byte[9];
/* 228 */     intToFourBytes(arrayOfInt2[0], arrayOfByte2, 0);
/* 229 */     intToFourBytes(arrayOfInt2[1], arrayOfByte2, 4);
/* 230 */     arrayOfByte2[8] = 0;
/* 231 */     int i1 = 2;
/* 232 */     int i2 = 0;
/* 233 */     int i3 = 128;
/* 234 */     for (; i1 < 13; i1++) {
...
/* 245 */           i3 = 128;
/*     */         }
/* 247 */         ((StringBuilder)localObject).setCharAt(i1, (char)COV2CHAR[i5]);
/*     */       }
/*     */     }
/* 250 */     return ((StringBuilder)localObject).toString();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 263 */     return crypt(paramString.getBytes(Charsets.UTF_8));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 278 */     return crypt(paramString1.getBytes(Charsets.UTF_8), paramString2);
/*     */   }
/*     */   
...
/* 283 */     int j = 0;
/* 284 */     int k = 0;
/* 285 */     for (int m = 0; m < 25; m++) {
/* 286 */       for (int n = 0; n < 32; n += 4) {
/* 287 */         i = dEncrypt(i, j, n, paramInt1, paramInt2, paramArrayOfInt);
/* 288 */         j = dEncrypt(j, i, n + 2, paramInt1, paramInt2, paramArrayOfInt);
/*     */       }
/* 290 */       k = i;
/* 291 */       i = j;
/* 292 */       j = k;
...
/* 296 */     j = i >>> 1 | i << 31;
/* 297 */     i = k >>> 1 | k << 31;
/* 298 */     int[] arrayOfInt1 = new int[2];
/* 299 */     permOp(j, i, 1, 1431655765, arrayOfInt1);
/* 300 */     j = arrayOfInt1[0];
/* 301 */     i = arrayOfInt1[1];
/* 302 */     permOp(i, j, 8, 16711935, arrayOfInt1);
/* 303 */     i = arrayOfInt1[0];
/* 304 */     j = arrayOfInt1[1];
/* 305 */     permOp(j, i, 2, 858993459, arrayOfInt1);
/* 306 */     j = arrayOfInt1[0];
/* 307 */     i = arrayOfInt1[1];
/* 308 */     permOp(i, j, 16, 65535, arrayOfInt1);
/* 309 */     i = arrayOfInt1[0];
/* 310 */     j = arrayOfInt1[1];
/* 311 */     permOp(j, i, 4, 252645135, arrayOfInt1);
/* 312 */     j = arrayOfInt1[0];
/* 313 */     i = arrayOfInt1[1];
/* 314 */     int[] arrayOfInt2 = new int[2];
/* 315 */     arrayOfInt2[0] = i;
/* 316 */     arrayOfInt2[1] = j;
...
/* 321 */     int i = paramByte;
/* 322 */     return i < 0 ? i + 256 : i;
/*     */   }
/*     */   
/*     */   private static int dEncrypt(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int[] paramArrayOfInt) {
/* 326 */     int i = paramInt2 ^ paramInt2 >>> 16;
/* 327 */     int j = i & paramInt4;
/* 328 */     i &= paramInt5;
/* 329 */     j = j ^ j << 16 ^ paramInt2 ^ paramArrayOfInt[paramInt3];
/* 330 */     int k = i ^ i << 16 ^ paramInt2 ^ paramArrayOfInt[(paramInt3 + 1)];
/* 331 */     k = k >>> 4 | k << 28;
/* 332 */     paramInt1 ^= (SPTRANS[1][(k & 0x3F)] | SPTRANS[3][(k >>> 8 & 0x3F)] | SPTRANS[5][(k >>> 16 & 0x3F)] | SPTRANS[7][(k >>> 24 & 0x3F)] | SPTRANS[0][(j & 0x3F)] | SPTRANS[2][(j >>> 8 & 0x3F)] | SPTRANS[4][(j >>> 16 & 0x3F)] | SPTRANS[6][(j >>> 24 & 0x3F)]);
/*     */     
/*     */ 
/* 335 */     return paramInt1;
/*     */   }
/*     */   
/*     */   private static int[] desSetKey(byte[] paramArrayOfByte) {
/* 339 */     int[] arrayOfInt1 = new int[32];
/* 340 */     int i = fourBytesToInt(paramArrayOfByte, 0);
/* 341 */     int j = fourBytesToInt(paramArrayOfByte, 4);
/* 342 */     int[] arrayOfInt2 = new int[2];
/* 343 */     permOp(j, i, 4, 252645135, arrayOfInt2);
/* 344 */     j = arrayOfInt2[0];
/* 345 */     i = arrayOfInt2[1];
/* 346 */     i = hPermOp(i, -2, -859045888);
/* 347 */     j = hPermOp(j, -2, -859045888);
/* 348 */     permOp(j, i, 1, 1431655765, arrayOfInt2);
/* 349 */     j = arrayOfInt2[0];
/* 350 */     i = arrayOfInt2[1];
/* 351 */     permOp(i, j, 8, 16711935, arrayOfInt2);
/* 352 */     i = arrayOfInt2[0];
/* 353 */     j = arrayOfInt2[1];
/* 354 */     permOp(j, i, 1, 1431655765, arrayOfInt2);
/* 355 */     j = arrayOfInt2[0];
/* 356 */     i = arrayOfInt2[1];
/* 357 */     j = (j & 0xFF) << 16 | j & 0xFF00 | (j & 0xFF0000) >>> 16 | (i & 0xF0000000) >>> 4;
/* 358 */     i &= 0xFFFFFFF;
/* 359 */     int k = 0;
/* 360 */     for (int m = 0; m < 16; m++) {
/* 361 */       if (SHIFT2[m] != 0) {
/* 362 */         i = i >>> 2 | i << 26;
/* 363 */         j = j >>> 2 | j << 26;
/*     */       } else {
...
/* 368 */       i &= 0xFFFFFFF;
/* 369 */       j &= 0xFFFFFFF;
/* 370 */       int n = SKB[0][(i & 0x3F)] | SKB[1][(i >>> 6 & 0x3 | i >>> 7 & 0x3C)] | SKB[2][(i >>> 13 & 0xF | i >>> 14 & 0x30)] | SKB[3][(i >>> 20 & 0x1 | i >>> 21 & 0x6 | i >>> 22 & 0x38)];
/*     */       
/*     */ 
/* 373 */       int i1 = SKB[4][(j & 0x3F)] | SKB[5][(j >>> 7 & 0x3 | j >>> 8 & 0x3C)] | SKB[6][(j >>> 15 & 0x3F)] | SKB[7][(j >>> 21 & 0xF | j >>> 22 & 0x30)];
/*     */       
/* 375 */       arrayOfInt1[(k++)] = (i1 << 16 | n & 0xFFFF);
/* 376 */       n = n >>> 16 | i1 & 0xFFFF0000;
/* 377 */       n = n << 4 | n >>> 28;
/* 378 */       arrayOfInt1[(k++)] = n;
/*     */     }
/*     */     
/* 381 */     return arrayOfInt1;
/*     */   }
/*     */   
/*     */   private static int fourBytesToInt(byte[] paramArrayOfByte, int paramInt) {
/* 385 */     int i = byteToUnsigned(paramArrayOfByte[(paramInt++)]);
/* 386 */     i |= byteToUnsigned(paramArrayOfByte[(paramInt++)]) << 8;
/* 387 */     i |= byteToUnsigned(paramArrayOfByte[(paramInt++)]) << 16;
/* 388 */     i |= byteToUnsigned(paramArrayOfByte[(paramInt++)]) << 24;
/* 389 */     return i;
/*     */   }
/*     */   
/*     */   private static int hPermOp(int paramInt1, int paramInt2, int paramInt3) {
/* 393 */     int i = (paramInt1 << 16 - paramInt2 ^ paramInt1) & paramInt3;
/* 394 */     paramInt1 = paramInt1 ^ i ^ i >>> 16 - paramInt2;
/* 395 */     return paramInt1;
/*     */   }
/*     */   
/*     */   private static void intToFourBytes(int paramInt1, byte[] paramArrayOfByte, int paramInt2) {
/* 399 */     paramArrayOfByte[(paramInt2++)] = ((byte)(paramInt1 & 0xFF));
/* 400 */     paramArrayOfByte[(paramInt2++)] = ((byte)(paramInt1 >>> 8 & 0xFF));
/* 401 */     paramArrayOfByte[(paramInt2++)] = ((byte)(paramInt1 >>> 16 & 0xFF));
/* 402 */     paramArrayOfByte[(paramInt2++)] = ((byte)(paramInt1 >>> 24 & 0xFF));
/*     */   }
/*     */   
/*     */   private static void permOp(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt) {
/* 406 */     int i = (paramInt1 >>> paramInt3 ^ paramInt2) & paramInt4;
/* 407 */     paramInt1 ^= i << paramInt3;
/* 408 */     paramInt2 ^= i;
/* 409 */     paramArrayOfInt[0] = paramInt1;
/* 410 */     paramArrayOfInt[1] = paramInt2;
/*     */   }
/*     */ }


/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\apache\commons\codec\digest\UnixCrypt.class

...
/* 1556 */         int start = i;
/* 1557 */         for (;;) { i++; if (i < this.size) {
/* 1558 */             if (this.buffer[i] != ch)
/*      */               break;
/*      */           }
/*      */         }
...
/* 1877 */     int leftIdx = 0; for (int rightIdx = this.size - 1; leftIdx < half; rightIdx--) {
/* 1878 */       char swap = buf[leftIdx];
/* 1879 */       buf[leftIdx] = buf[rightIdx];
/* 1880 */       buf[rightIdx] = swap;leftIdx++;
/*      */     }
/*      */     
/*      */ 
/* 1882 */     return this;
...
/* 2687 */         return -1;
/*      */       }
/* 2689 */       return StrBuilder.this.charAt(this.pos++);
/*      */     }
/*      */     
...
/* 2699 */         return 0;
/*      */       }
/* 2701 */       if (this.pos >= StrBuilder.this.size()) {
/* 2702 */         return -1;
/*      */       }
/* 2704 */       if (this.pos + len > StrBuilder.this.size()) {
/* 2705 */         len = StrBuilder.this.size() - this.pos;
/*      */       }
/* 2707 */       StrBuilder.this.getChars(this.pos, this.pos + len, b, off);
/* 2708 */       this.pos += len;
/* 2709 */       return len;
/*      */     }
/*      */     
...
/*      */     {
/* 2714 */       if (this.pos + n > StrBuilder.this.size()) {
/* 2715 */         n = StrBuilder.this.size() - this.pos;
/*      */       }
/* 2717 */       if (n < 0L) {
/* 2718 */         return 0L;
/*      */       }
...
/*      */     {
/* 2726 */       return this.pos < StrBuilder.this.size();
/*      */     }
/*      */     
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\apache\commons\lang\text\StrBuilder.class

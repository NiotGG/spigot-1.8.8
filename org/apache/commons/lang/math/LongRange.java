...
/* 373 */       this.hashCode = (37 * this.hashCode + (int)(this.min ^ this.min >> 32));
/* 374 */       this.hashCode = (37 * this.hashCode + (int)(this.max ^ this.max >> 32));
/*     */     }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\apache\commons\lang\math\LongRange.class

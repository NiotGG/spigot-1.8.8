...
/* 391 */       this.hashCode = (37 * this.hashCode + (int)(lng ^ lng >> 32));
/* 392 */       lng = Double.doubleToLongBits(this.max);
/* 393 */       this.hashCode = (37 * this.hashCode + (int)(lng ^ lng >> 32));
/*     */     }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\apache\commons\lang\math\DoubleRange.class

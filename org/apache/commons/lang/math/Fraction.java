...
/* 745 */     if (d1 == 1)
/*     */     {
/* 747 */       int uvp = mulAndCheck(this.numerator, fraction.denominator);
/* 748 */       int upv = mulAndCheck(fraction.numerator, this.denominator);
/* 749 */       return new Fraction(isAdd ? addAndCheck(uvp, upv) : subAndCheck(uvp, upv), mulPosAndCheck(this.denominator, fraction.denominator));
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\apache\commons\lang\math\Fraction.class

...
/*      */     String mant;
/*  520 */     String mant; String dec; if (decPos > -1) { String dec;
/*      */       String dec;
/*  522 */       if (expPos > -1) {
...
/*  540 */       dec = null;
/*      */     }
/*  542 */     if ((!Character.isDigit(lastChar)) && (lastChar != '.')) { String exp;
/*  543 */       String exp; if ((expPos > -1) && (expPos < str.length() - 1)) {
...
/*      */       }
/* 1507 */       for (; 
/* 1507 */           i < chars.length; i++) {
/* 1508 */         if (((chars[i] < '0') || (chars[i] > '9')) && ((chars[i] < 'a') || (chars[i] > 'f')) && ((chars[i] < 'A') || (chars[i] > 'F')))
/*      */         {
/*      */ 
/* 1511 */           return false;
/*      */         }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\apache\commons\lang\math\NumberUtils.class

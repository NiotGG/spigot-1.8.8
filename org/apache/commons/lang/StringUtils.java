...
/*      */   {
/*  661 */     return str1 == null ? false : str2 == null ? true : str1.equals(str2);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* 2950 */           i++;
/*      */         } }
/* 2952 */     if (separatorChars.length() == 1)
/*      */     {
...
/* 3814 */     increase *= (max > 64 ? 64 : max < 0 ? 16 : max);
...
/* 4011 */       if ((noMoreMatchesForReplIndex[i] == 0) && (searchList[i] != null) && (searchList[i].length() != 0) && (replacementList[i] != null))
/*      */       {
/*      */ 
/*      */ 
/*      */ 
...
/* 4070 */         if ((noMoreMatchesForReplIndex[i] == 0) && (searchList[i] != null) && (searchList[i].length() != 0) && (replacementList[i] != null))
/*      */         {
/*      */ 
/*      */ 
/*      */ 
...
/* 4620 */       for (int i = repeat * 2 - 2; i >= 0; i--) {
/* 4621 */         output2[i] = ch0;
/* 4622 */         output2[(i + 1)] = ch1;i--;
/*      */       }
/*      */       
...
/*      */     }
/*      */     
/* 6065 */     for (int i = 0; (i < str1.length()) && (i < str2.length()); i++) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\apache\commons\lang\StringUtils.class

...
/* 385 */         Object result; if (!componentType.isPrimitive()) {
/* 386 */           result = ((Object[])o).clone();
/*     */         } else {
/* 388 */           int length = Array.getLength(o);
/* 389 */           Object result = Array.newInstance(componentType, length);
/* 390 */           while (length-- > 0) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\apache\commons\lang\ObjectUtils.class

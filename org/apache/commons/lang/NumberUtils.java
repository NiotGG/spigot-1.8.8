...
/*     */     String mant;
/* 165 */     String mant; String dec; if (decPos > -1) { String dec;
/*     */       String dec;
/* 167 */       if (expPos > -1) {
...
/* 182 */       dec = null;
/*     */     }
/* 184 */     if (!Character.isDigit(lastChar)) { String exp;
/* 185 */       String exp; if ((expPos > -1) && (expPos < val.length() - 1)) {
...
/*     */       }
/* 639 */       for (; 
/* 639 */           i < chars.length; i++) {
/* 640 */         if (((chars[i] < '0') || (chars[i] > '9')) && ((chars[i] < 'a') || (chars[i] > 'f')) && ((chars[i] < 'A') || (chars[i] > 'F')))
/*     */         {
/*     */ 
/* 643 */           return false;
/*     */         }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\apache\commons\lang\NumberUtils.class

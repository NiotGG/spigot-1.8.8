...
/*  559 */     this.mRules = ((Rule[])rulesList.toArray(new Rule[rulesList.size()]));
/*      */     
/*  561 */     int len = 0;
/*  562 */     int i = this.mRules.length; for (;;) { i--; if (i < 0) break;
...
/*      */       Rule rule;
/*  604 */       Rule rule; Rule rule; Rule rule; Rule rule; Rule rule; switch (c) {
/*      */       case 'G': 
...
/*      */       case 'M': 
/*  616 */         if (tokenLen >= 4) {
/*  617 */           rule = new TextField(2, months); } else { Rule rule;
/*  618 */           if (tokenLen == 3) {
/*  619 */             rule = new TextField(2, shortMonths); } else { Rule rule;
/*  620 */             if (tokenLen == 2) {
...
/*      */     {
/* 1152 */       int max = 0;
/* 1153 */       int i = this.mValues.length; for (;;) { i--; if (i < 0) break;
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\apache\commons\lang\time\FastDateFormat.class

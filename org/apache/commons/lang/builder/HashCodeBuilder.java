...
/*  185 */         if ((!ArrayUtils.contains(excludeFields, field.getName())) && (field.getName().indexOf('$') == -1) && ((useTransients) || (!Modifier.isTransient(field.getModifiers()))) && (!Modifier.isStatic(field.getModifiers())))
/*      */         {
/*      */           try
/*      */           {
/*      */ 
...
/*      */   {
/*  847 */     this.iTotal = (this.iTotal * this.iConstant + (int)(value ^ value >> 32));
/*  848 */     return this;
/*      */   }
/*      */   
/*      */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\apache\commons\lang\builder\HashCodeBuilder.class

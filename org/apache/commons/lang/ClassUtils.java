...
/*      */   static
/*      */   {
/*   75 */     primitiveWrapperMap.put(Boolean.TYPE, Boolean.class);
/*   76 */     primitiveWrapperMap.put(Byte.TYPE, Byte.class);
/*   77 */     primitiveWrapperMap.put(Character.TYPE, Character.class);
/*   78 */     primitiveWrapperMap.put(Short.TYPE, Short.class);
/*   79 */     primitiveWrapperMap.put(Integer.TYPE, Integer.class);
/*   80 */     primitiveWrapperMap.put(Long.TYPE, Long.class);
/*   81 */     primitiveWrapperMap.put(Double.TYPE, Double.class);
/*   82 */     primitiveWrapperMap.put(Float.TYPE, Float.class);
/*   83 */     primitiveWrapperMap.put(Void.TYPE, Void.TYPE);
/*      */     
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*   89 */     wrapperPrimitiveMap = new HashMap();
/*      */     
/*   91 */     for (Iterator it = primitiveWrapperMap.keySet().iterator(); it.hasNext();) {
/*   92 */       Class primitiveClass = (Class)it.next();
...
/*      */ 
/*      */ 
/*  103 */     abbreviationMap = new HashMap();
/*      */     
/*      */ 
/*      */ 
/*      */ 
/*  108 */     reverseAbbreviationMap = new HashMap();
/*      */     
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/*  475 */     if (!ArrayUtils.isSameLength(classArray, toClassArray)) {
/*  476 */       return false;
/*      */     }
...
/*  581 */         return (Long.TYPE.equals(toClass)) || (Float.TYPE.equals(toClass)) || (Double.TYPE.equals(toClass));
/*      */       }
/*      */       
/*      */ 
/*  585 */       if (Long.TYPE.equals(cls)) {
/*  586 */         return (Float.TYPE.equals(toClass)) || (Double.TYPE.equals(toClass));
/*      */       }
/*      */       
...
/*  599 */         return (Integer.TYPE.equals(toClass)) || (Long.TYPE.equals(toClass)) || (Float.TYPE.equals(toClass)) || (Double.TYPE.equals(toClass));
/*      */       }
/*      */       
/*      */ 
/*      */ 
/*  604 */       if (Short.TYPE.equals(cls)) {
/*  605 */         return (Integer.TYPE.equals(toClass)) || (Long.TYPE.equals(toClass)) || (Float.TYPE.equals(toClass)) || (Double.TYPE.equals(toClass));
/*      */       }
/*      */       
/*      */ 
/*      */ 
/*  610 */       if (Byte.TYPE.equals(cls)) {
/*  611 */         return (Short.TYPE.equals(toClass)) || (Integer.TYPE.equals(toClass)) || (Long.TYPE.equals(toClass)) || (Float.TYPE.equals(toClass)) || (Double.TYPE.equals(toClass));
/*      */       }
/*      */       
/*      */ 
/*      */ 
...
/*      */       }
/*  757 */       return Class.forName(toCanonicalName(className), initialize, classLoader);
/*      */ 
/*      */     }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\apache\commons\lang\ClassUtils.class

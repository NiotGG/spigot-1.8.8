...
/* 280 */     Color[] arrayOfColor; int i = (arrayOfColor = colors).length; for (int j = 0; j < i; j++) { Color color = arrayOfColor[j];
...
/* 314 */       "RED", Integer.valueOf(getRed()), 
/* 315 */       "BLUE", Integer.valueOf(getBlue()), 
/* 316 */       "GREEN", Integer.valueOf(getGreen()));
/*     */   }
/*     */   
/*     */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\Color.class

...
/*     */ {
/*  36 */   private static final List<String> TIMINGS_SUBCOMMANDS = ImmutableList.of("report", "reset", "on", "off", "paste");
...
/*     */   {
/* 193 */     Validate.notNull(sender, "Sender cannot be null");
/* 194 */     Validate.notNull(args, "Arguments cannot be null");
/* 195 */     Validate.notNull(alias, "Alias cannot be null");
/*     */     
/* 197 */     if (args.length == 1) {
/* 198 */       return (List)StringUtil.copyPartialMatches(args[0], TIMINGS_SUBCOMMANDS, new ArrayList(TIMINGS_SUBCOMMANDS.size()));
/*     */     }
...
/*     */     {
/* 212 */       super();
/* 213 */       this.sender = sender;
/* 214 */       this.bout = bout;
/*     */     }
/*     */     
/*     */     public synchronized void start()
/*     */     {
/* 219 */       if ((this.sender instanceof RemoteConsoleCommandSender)) {
/* 220 */         run();
/*     */       } else {
/* 222 */         super.start();
/*     */       }
...
/*     */       try
/*     */       {
/* 231 */         HttpURLConnection con = (HttpURLConnection)new URL("http://paste.ubuntu.com/").openConnection();
/* 232 */         con.setDoOutput(true);
/* 233 */         con.setRequestMethod("POST");
/* 234 */         con.setInstanceFollowRedirects(false);
/*     */         
/* 236 */         OutputStream out = con.getOutputStream();
/* 237 */         out.write("poster=Spigot&syntax=text&content=".getBytes("UTF-8"));
/* 238 */         out.write(URLEncoder.encode(this.bout.toString("UTF-8"), "UTF-8").getBytes("UTF-8"));
/* 239 */         out.close();
/* 240 */         con.getInputStream().close();
/*     */         
/* 242 */         String location = con.getHeaderField("Location");
/* 243 */         String pasteID = location.substring("http://paste.ubuntu.com/".length(), location.length() - 1);
/* 244 */         this.sender.sendMessage(ChatColor.GREEN + "Timings results can be viewed at http://www.spigotmc.org/go/timings?url=" + pasteID);
/*     */       }
/*     */       catch (IOException ex) {
/* 247 */         this.sender.sendMessage(ChatColor.RED + "Error pasting timings, check your console for more information");
/* 248 */         Bukkit.getServer().getLogger().log(Level.WARNING, "Could not paste timings", ex);
/*     */       }
/*     */     }
/*     */   }
/*     */ }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\command\defaults\TimingsCommand.class

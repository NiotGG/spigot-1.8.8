...
/*  20 */   private final Map<String, Class<?>> classes = new ConcurrentHashMap();
/*     */   
...
/*     */   {
/*  53 */     super(new java.net.URL[] { file.toURI().toURL() }, parent);
...
/*     */       } catch (ClassNotFoundException ex) { Class<?> jarClass;
...
/*     */       } catch (ClassCastException ex) { Class<? extends JavaPlugin> pluginClass;
/*  73 */         throw new InvalidPluginException("main class `" + description.getMain() + "' does not extend JavaPlugin", ex);
/*     */       }
/*     */       Class<? extends JavaPlugin> pluginClass;
/*  76 */       this.plugin = ((JavaPlugin)pluginClass.newInstance());
...
/*     */     }
/*  93 */     Class<?> result = (Class)this.classes.get(name);
/*     */     
/*  95 */     if (result == null) {
/*  96 */       if (checkGlobal) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\plugin\java\PluginClassLoader.class

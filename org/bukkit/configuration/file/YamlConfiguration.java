...
/*  30 */   private final Yaml yaml = new Yaml(new YamlConstructor(), this.yamlRepresenter, this.yamlOptions);
/*     */   
...
/*     */     } catch (YAMLException e) { Map<?, ?> input;
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\configuration\file\YamlConfiguration.class

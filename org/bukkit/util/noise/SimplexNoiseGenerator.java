...
/*  36 */     { 0, 1, 2, 3 }, { 0, 1, 3, 2 }, new int[4], { 0, 2, 3, 1 }, new int[4], new int[4], new int[4], { 1, 2, 3 }, 
/*  37 */     { 0, 2, 1, 3 }, new int[4], { 0, 3, 1, 2 }, { 0, 3, 2, 1 }, new int[4], new int[4], new int[4], { 1, 3, 2 }, 
/*  38 */     new int[4], new int[4], new int[4], new int[4], new int[4], new int[4], new int[4], new int[4], 
/*  39 */     { 1, 2, 0, 3 }, new int[4], { 1, 3, 0, 2 }, new int[4], new int[4], new int[4], { 2, 3, 0, 1 }, { 2, 3, 1 }, 
/*  40 */     { 1, 0, 2, 3 }, { 1, 0, 3, 2 }, new int[4], new int[4], new int[4], { 2, 0, 3, 1 }, new int[4], { 2, 1, 3 }, 
/*  41 */     new int[4], new int[4], new int[4], new int[4], new int[4], new int[4], new int[4], new int[4], 
/*  42 */     { 2, 0, 1, 3 }, new int[4], new int[4], new int[4], { 3, 0, 1, 2 }, { 3, 0, 2, 1 }, new int[4], { 3, 1, 2 }, 
/*  43 */     { 2, 1, 0, 3 }, new int[4], new int[4], new int[4], { 3, 1, 0, 2 }, new int[4], { 3, 2, 0, 1 }, { 3, 2, 1 } };
...
/* 244 */     double n0; double n0; if (t0 < 0.0D) {
/* 245 */       n0 = 0.0D;
/*     */     } else {
/* 247 */       t0 *= t0;
...
/* 252 */     double n1; double n1; if (t1 < 0.0D) {
/* 253 */       n1 = 0.0D;
/*     */     } else {
/* 255 */       t1 *= t1;
...
/* 260 */     double n2; double n2; if (t2 < 0.0D) {
/* 261 */       n2 = 0.0D;
/*     */     } else {
/* 263 */       t2 *= t2;
...
/* 268 */     double n3; double n3; if (t3 < 0.0D) {
/* 269 */       n3 = 0.0D;
/*     */     } else {
/* 271 */       t3 *= t3;
...
/* 328 */     double n0; double n0; if (t0 < 0.0D) {
/* 329 */       n0 = 0.0D;
/*     */     } else {
/* 331 */       t0 *= t0;
...
/* 336 */     double n1; double n1; if (t1 < 0.0D) {
/* 337 */       n1 = 0.0D;
/*     */     } else {
/* 339 */       t1 *= t1;
...
/* 344 */     double n2; double n2; if (t2 < 0.0D) {
/* 345 */       n2 = 0.0D;
/*     */     } else {
/* 347 */       t2 *= t2;
...
/* 469 */     double n0; double n0; if (t0 < 0.0D) {
/* 470 */       n0 = 0.0D;
/*     */     } else {
/* 472 */       t0 *= t0;
...
/* 477 */     double n1; double n1; if (t1 < 0.0D) {
/* 478 */       n1 = 0.0D;
/*     */     } else {
/* 480 */       t1 *= t1;
...
/* 485 */     double n2; double n2; if (t2 < 0.0D) {
/* 486 */       n2 = 0.0D;
/*     */     } else {
/* 488 */       t2 *= t2;
...
/* 493 */     double n3; double n3; if (t3 < 0.0D) {
/* 494 */       n3 = 0.0D;
/*     */     } else {
/* 496 */       t3 *= t3;
...
/* 501 */     double n4; double n4; if (t4 < 0.0D) {
/* 502 */       n4 = 0.0D;
/*     */     } else {
/* 504 */       t4 *= t4;

...
/*     */ {
/*  13 */   protected static final int[][] grad3 = { { 1, 1 }, { -1, 1 }, { 1, -1 }, { -1, -1 }, 
...
/*     */     
/* 163 */     return lerp(fZ, lerp(fY, lerp(fX, grad(this.perm[AA], x, y, z), 
/* 164 */       grad(this.perm[BA], x - 1.0D, y, z)), 
/* 165 */       lerp(fX, grad(this.perm[AB], x, y - 1.0D, z), 
/* 166 */       grad(this.perm[BB], x - 1.0D, y - 1.0D, z))), 
/* 167 */       lerp(fY, lerp(fX, grad(this.perm[(AA + 1)], x, y, z - 1.0D), 
/* 168 */       grad(this.perm[(BA + 1)], x - 1.0D, y, z - 1.0D)), 
/* 169 */       lerp(fX, grad(this.perm[(AB + 1)], x, y - 1.0D, z - 1.0D), 
/* 170 */       grad(this.perm[(BB + 1)], x - 1.0D, y - 1.0D, z - 1.0D))));
/*     */   }
/*     */   
/*     */ 
/*     */ 

...
/*  16 */     this.collection = new ArrayList();
/*     */   }
/*     */   
...
/*  29 */       ret |= values.add(new WeakReference(value));
/*     */     }
/*  31 */     return ret;
/*     */   }
/*     */   
...
/*     */         
/*  72 */         while (it.hasNext()) {
/*  73 */           WeakReference<T> ref = (WeakReference)it.next();
/*  74 */           value = ref.get();
/*  75 */           if (value == null) {
/*  76 */             it.remove();
/*     */           } else {
...
/*     */   public int size() {
/* 147 */     int s = 0;
/* 148 */     for (Iterator localIterator = iterator(); localIterator.hasNext();) { ((Object)localIterator.next());
/* 149 */       s++;
/*     */     }
/* 151 */     return s;
/*     */   }
...
/* 163 */     ArrayList<T> collection = new ArrayList();
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\v1_8_R3\util\WeakCollection.class

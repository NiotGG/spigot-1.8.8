...
/* 138 */     ((net.minecraft.server.v1_8_R3.EntityInsentient)this.entity.getHandle()).dropChances[slot] = (chance - 0.1F);
/*     */   }
/*     */   
/*     */   private float getDropChance(int slot) {
/* 142 */     return ((net.minecraft.server.v1_8_R3.EntityInsentient)this.entity.getHandle()).dropChances[slot] + 0.1F;
/*     */   }
/*     */ }


/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\v1_8_R3\inventory\CraftEntityEquipment.class

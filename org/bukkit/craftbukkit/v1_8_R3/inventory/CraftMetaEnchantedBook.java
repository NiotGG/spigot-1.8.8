...
/*  33 */       this.enchantments = new HashMap(that.enchantments);
/*     */     }
/*     */   }
/*     */   
...
/*     */       
/*  83 */       return (that.hasStoredEnchants()) && (this.enchantments.equals(that.enchantments));
/*     */     }
/*  85 */     return true;
/*     */   }
/*     */   
...
/*     */   {
/*     */     int original;
/*  96 */     int hash = original = super.applyHash();
/*     */     
...
/* 110 */       meta.enchantments = new HashMap(this.enchantments);
/*     */     }
/*     */     
/* 113 */     return meta;
/*     */   }
...
/* 134 */     Integer level = hasStoredEnchants() ? (Integer)this.enchantments.get(ench) : null;
/* 135 */     if (level == null) {
/* 136 */       return 0;
/*     */     }
...
/* 142 */     return hasStoredEnchants() ? ImmutableMap.copyOf(this.enchantments) : ImmutableMap.of();
/*     */   }
/*     */   
/*     */   public boolean addStoredEnchant(Enchantment ench, int level, boolean ignoreRestrictions) {
/* 146 */     if (this.enchantments == null) {
/* 147 */       this.enchantments = new HashMap(4);
/*     */     }
/*     */     
/* 150 */     if ((ignoreRestrictions) || ((level >= ench.getStartLevel()) && (level <= ench.getMaxLevel()))) {
/* 151 */       Integer old = (Integer)this.enchantments.put(ench, Integer.valueOf(level));
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\v1_8_R3\inventory\CraftMetaEnchantedBook.class

...
/*    */ {
/* 15 */   private LinkedList<Conversation> conversationQueue = new LinkedList();
/*    */   
...
/* 46 */     this.conversationQueue = new LinkedList();
/* 47 */     for (Conversation conversation : oldQueue) {
/*    */       try {
/* 49 */         conversation.abandon(new ConversationAbandonedEvent(conversation, new ManuallyAbandonedConversationCanceller()));
/*    */       } catch (Throwable t) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\v1_8_R3\conversations\ConversationTracker.class

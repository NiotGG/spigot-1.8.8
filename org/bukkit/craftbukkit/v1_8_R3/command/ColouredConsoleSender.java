...
/* 17 */   private final Map<ChatColor, String> replacements = new java.util.EnumMap(ChatColor.class);
...
/* 53 */         ChatColor[] arrayOfChatColor; int i = (arrayOfChatColor = this.colors).length; for (int j = 0; j < i; j++) { ChatColor color = arrayOfChatColor[j];
/* 54 */           if (this.replacements.containsKey(color)) {
/* 55 */             result = result.replaceAll("(?i)" + color.toString(), (String)this.replacements.get(color));
/*    */           } else {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\v1_8_R3\command\ColouredConsoleSender.class

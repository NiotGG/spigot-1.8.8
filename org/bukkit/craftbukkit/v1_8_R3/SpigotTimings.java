...
/*  38 */   public static final CustomTimingsHandler schedulerSyncTimer = new CustomTimingsHandler("** Scheduler - Sync Tasks", org.bukkit.plugin.java.JavaPluginLoader.pluginParentTimer);
/*     */   
...
/*     */   
/*  45 */   public static final HashMap<String, CustomTimingsHandler> entityTypeTimingMap = new HashMap();
/*  46 */   public static final HashMap<String, CustomTimingsHandler> tileEntityTypeTimingMap = new HashMap();
/*  47 */   public static final HashMap<String, CustomTimingsHandler> pluginTaskTimingMap = new HashMap();
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */     String plugin;
/*  62 */     String plugin; if (task.getOwner() != null) {
/*  63 */       plugin = task.getOwner().getDescription().getFullName(); } else { String plugin;
/*  64 */       if (ctask.timingName != null) {
...
/*  75 */       name = name + "(Single)";
/*     */     }
/*  77 */     CustomTimingsHandler result = (CustomTimingsHandler)pluginTaskTimingMap.get(name);
/*  78 */     if (result == null) {
...
/*  92 */     CustomTimingsHandler result = (CustomTimingsHandler)entityTypeTimingMap.get(entityType);
/*  93 */     if (result == null) {
...
/* 107 */     CustomTimingsHandler result = (CustomTimingsHandler)tileEntityTypeTimingMap.get(entityType);
/* 108 */     if (result == null) {
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\v1_8_R3\SpigotTimings.class

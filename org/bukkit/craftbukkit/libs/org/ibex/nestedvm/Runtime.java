...
/*  115 */     if (str2 != null) win32Hacks = Boolean.valueOf(str2).booleanValue(); else
/*  116 */       win32Hacks = (str1 != null) && (str1.toLowerCase().indexOf("windows") != -1);
/*      */   }
/*      */   
/*      */   protected Object clone() throws CloneNotSupportedException {
/*  120 */     Runtime localRuntime = (Runtime)super.clone();
/*  121 */     localRuntime._byteBuf = null;
/*  122 */     localRuntime.startTime = 0L;
/*  123 */     localRuntime.fds = new FD[64];
/*  124 */     for (int i = 0; i < 64; i++) if (this.fds[i] != null) localRuntime.fds[i] = this.fds[i].dup();
/*  125 */     i = this.writePages.length;
/*  126 */     localRuntime.readPages = new int[i][];
/*  127 */     localRuntime.writePages = new int[i][];
/*  128 */     for (int j = 0; j < i; j++) {
/*  129 */       if (this.readPages[j] != null)
/*  130 */         if (this.writePages[j] == null) localRuntime.readPages[j] = this.readPages[j]; else
/*  131 */           localRuntime.readPages[j] = (localRuntime.writePages[j] = (int[])(int[])this.writePages[j].clone());
/*      */     }
/*  133 */     return localRuntime;
/*      */   }
/*      */   
/*  136 */   protected Runtime(int paramInt1, int paramInt2) { this(paramInt1, paramInt2, false); }
/*      */   
/*  138 */   protected Runtime(int paramInt1, int paramInt2, boolean paramBoolean) { if (paramInt1 <= 0) throw new IllegalArgumentException("pageSize <= 0");
...
/*      */     
/*  168 */     if (paramInt2 == 1) {
/*  169 */       this.readPages[0] = (this.writePages[0] = new int[paramInt1 >> 2]);
/*      */     } else {
/*  171 */       for (int i1 = this.stackBottom >>> this.pageShift; i1 < this.writePages.length; i1++) {
/*  172 */         this.readPages[i1] = (this.writePages[i1] = new int[paramInt1 >> 2]);
/*      */       }
/*      */     }
/*      */     
/*  176 */     if (!paramBoolean) {
...
/*      */       
/*  180 */       InputStream localInputStream = win32Hacks ? new Win32ConsoleIS(System.in) : System.in;
/*  181 */       addFD(new TerminalFD(localInputStream));
...
/*  218 */         this.readPages[m] = (this.writePages[m] = new int[i]);
/*      */       } else {
/*  220 */         if (this.writePages[m] == null) this.writePages[m] = this.readPages[m];
/*  221 */         for (int i2 = n; i2 < n + i1; i2++) this.writePages[m][i2] = 0;
/*      */       }
/*  223 */       k += i1;
/*  224 */       paramInt1 += i1 * 4;
/*      */     }
...
/*      */     
/*  234 */     int k = 0;
/*  235 */     if (paramInt2 == 0) return;
/*  236 */     int m; if ((paramInt1 & 0x3) != 0) {
/*  237 */       m = memRead(paramInt1 & 0xFFFFFFFC);
/*  238 */       switch (paramInt1 & 0x3) {
/*  239 */       case 1:  paramArrayOfByte[(k++)] = ((byte)(m >>> 16 & 0xFF));paramInt2--; if (paramInt2 == 0)
/*  240 */           break;  case 2:  paramArrayOfByte[(k++)] = ((byte)(m >>> 8 & 0xFF));paramInt2--; if (paramInt2 == 0)
/*  241 */           break;  case 3:  paramArrayOfByte[(k++)] = ((byte)(m >>> 0 & 0xFF));paramInt2--; if (paramInt2 != 0)
/*      */           break; }
/*  243 */       paramInt1 = (paramInt1 & 0xFFFFFFFC) + 4;
/*      */     }
/*  245 */     if ((paramInt2 & 0xFFFFFFFC) != 0) {
/*  246 */       m = paramInt2 >>> 2;
/*  247 */       int n = paramInt1 >>> 2;
/*  248 */       int i2; for (; m != 0; 
/*      */           
/*      */ 
/*      */ 
...
/*  258 */           m -= i2)
/*      */       {
/*  249 */         int[] arrayOfInt = this.readPages[(n >>> this.pageShift - 2)];
/*  250 */         if (arrayOfInt == null) throw new ReadFaultException(n << 2);
/*  251 */         int i1 = n & j;
/*  252 */         i2 = min(m, i - i1);
/*  253 */         for (int i3 = 0; i3 < i2; k += 4) {
/*  254 */           int i4 = arrayOfInt[(i1 + i3)];
/*  255 */           paramArrayOfByte[(k + 0)] = ((byte)(i4 >>> 24 & 0xFF));paramArrayOfByte[(k + 1)] = ((byte)(i4 >>> 16 & 0xFF));
/*  256 */           paramArrayOfByte[(k + 2)] = ((byte)(i4 >>> 8 & 0xFF));paramArrayOfByte[(k + 3)] = ((byte)(i4 >>> 0 & 0xFF));i3++;
/*      */         }
/*      */         
/*      */ 
/*  258 */         n += i2;
/*      */       }
/*  260 */       paramInt1 = n << 2;paramInt2 &= 0x3;
/*      */     }
/*  262 */     if (paramInt2 != 0) {
/*  263 */       m = memRead(paramInt1);
/*  264 */       switch (paramInt2) {
/*  265 */       case 3:  paramArrayOfByte[(k + 2)] = ((byte)(m >>> 8 & 0xFF));
/*  266 */       case 2:  paramArrayOfByte[(k + 1)] = ((byte)(m >>> 16 & 0xFF));
/*  267 */       case 1:  paramArrayOfByte[(k + 0)] = ((byte)(m >>> 24 & 0xFF));
/*      */       }
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*  278 */     int k = 0;
/*  279 */     if (paramInt2 == 0) return;
/*  280 */     int m; if ((paramInt1 & 0x3) != 0) {
/*  281 */       m = memRead(paramInt1 & 0xFFFFFFFC);
/*  282 */       switch (paramInt1 & 0x3) {
/*  283 */       case 1:  m = m & 0xFF00FFFF | (paramArrayOfByte[(k++)] & 0xFF) << 16;paramInt2--; if (paramInt2 == 0)
/*  284 */           break;  case 2:  m = m & 0xFFFF00FF | (paramArrayOfByte[(k++)] & 0xFF) << 8;paramInt2--; if (paramInt2 == 0)
/*  285 */           break;  case 3:  m = m & 0xFF00 | (paramArrayOfByte[(k++)] & 0xFF) << 0;paramInt2--; if (paramInt2 != 0)
/*      */           break; }
...
/*  297 */         int i1 = n & j;
/*  298 */         i2 = min(m, i - i1);
/*  299 */         for (int i3 = 0; i3 < i2; k += 4) {
/*  300 */           arrayOfInt[(i1 + i3)] = ((paramArrayOfByte[(k + 0)] & 0xFF) << 24 | (paramArrayOfByte[(k + 1)] & 0xFF) << 16 | (paramArrayOfByte[(k + 2)] & 0xFF) << 8 | (paramArrayOfByte[(k + 3)] & 0xFF) << 0);i3++; }
/*  301 */         n += i2;
/*      */       }
...
/*      */     
/*  306 */     if (paramInt2 != 0) {
/*  307 */       m = memRead(paramInt1);
/*  308 */       switch (paramInt2) {
/*  309 */       case 1:  m = m & 0xFFFFFF | (paramArrayOfByte[(k + 0)] & 0xFF) << 24; break;
/*  310 */       case 2:  m = m & 0xFFFF | (paramArrayOfByte[(k + 0)] & 0xFF) << 24 | (paramArrayOfByte[(k + 1)] & 0xFF) << 16; break;
/*  311 */       case 3:  m = m & 0xFF | (paramArrayOfByte[(k + 0)] & 0xFF) << 24 | (paramArrayOfByte[(k + 1)] & 0xFF) << 16 | (paramArrayOfByte[(k + 2)] & 0xFF) << 8;
/*      */       }
...
/*  319 */     int j = i - 1;
/*  320 */     int k; if (((paramInt1 & 0x3) == 0) && ((paramInt2 & 0x3) == 0)) { int m;
...
/*      */       }
/*  338 */       if (paramInt3 != 0) {
/*  339 */         k = memRead(paramInt2);
/*  340 */         m = memRead(paramInt1);
/*  341 */         switch (paramInt3) {
/*  342 */         case 1:  memWrite(paramInt1, k & 0xFF000000 | m & 0xFFFFFF); break;
/*  343 */         case 2:  memWrite(paramInt1, k & 0xFFFF0000 | m & 0xFFFF); break;
/*  344 */         case 3:  memWrite(paramInt1, k & 0xFF00 | m & 0xFF);
/*      */         }
/*      */       }
/*      */     } else {
/*  348 */       for (; paramInt3 > 0; 
...
/*  363 */     int m; if ((paramInt1 & 0x3) != 0) {
/*  364 */       m = memRead(paramInt1 & 0xFFFFFFFC);
/*  365 */       switch (paramInt1 & 0x3) {
/*  366 */       case 1:  m = m & 0xFF00FFFF | (paramInt2 & 0xFF) << 16;paramInt3--; if (paramInt3 == 0)
/*  367 */           break;  case 2:  m = m & 0xFFFF00FF | (paramInt2 & 0xFF) << 8;paramInt3--; if (paramInt3 == 0)
/*  368 */           break;  case 3:  m = m & 0xFF00 | (paramInt2 & 0xFF) << 0;paramInt3--; if (paramInt3 != 0)
/*      */           break; }
...
/*  380 */         i2 = min(m, i - i1);
/*      */         
/*  382 */         for (int i3 = i1; i3 < i1 + i2; i3++) arrayOfInt[i3] = k;
/*  383 */         n += i2;
/*      */       }
/*  385 */       paramInt1 = n << 2;paramInt3 &= 0x3;
/*      */     }
/*  387 */     if (paramInt3 != 0) {
/*  388 */       m = memRead(paramInt1);
/*  389 */       switch (paramInt3) {
/*  390 */       case 1:  m = m & 0xFFFFFF | k & 0xFF000000; break;
/*  391 */       case 2:  m = m & 0xFFFF | k & 0xFFFF0000; break;
/*  392 */       case 3:  m = m & 0xFF | k & 0xFF00;
/*      */       }
...
/*  411 */       throw localArrayIndexOutOfBoundsException;
...
/*  430 */       throw localArrayIndexOutOfBoundsException;
/*      */     } catch (NullPointerException localNullPointerException) {
...
/*  455 */     int j = 0;
/*  456 */     for (int k = 0; k < i; k++) j += paramArrayOfString[k].length() + 1;
/*  457 */     j += (i + 1) * 4;
/*  458 */     k = paramInt - j & 0xFFFFFFFC;
/*  459 */     int m = k + (i + 1) * 4;
/*  460 */     int[] arrayOfInt = new int[i + 1];
/*      */     try {
/*  462 */       for (int n = 0; n < i; n++) {
/*  463 */         byte[] arrayOfByte = getBytes(paramArrayOfString[n]);
/*  464 */         arrayOfInt[n] = m;
...
/*  469 */       m = k;
/*  470 */       for (n = 0; n < i + 1; n++) {
/*  471 */         memWrite(m, arrayOfInt[n]);
/*  472 */         m += 4;
/*      */       }
/*      */     } catch (FaultException localFaultException) {
/*  475 */       throw new RuntimeException(localFaultException.toString());
/*      */     }
/*  477 */     return k;
/*      */   }
/*      */   
...
/*      */     try {
/*  490 */       memWrite(userInfoBase() + paramInt1 * 4, paramInt2);
/*  491 */     } catch (FaultException localFaultException) { throw new RuntimeException(localFaultException.toString());
/*      */     }
/*      */   }
/*      */   
...
/*      */     try {
/*  499 */       return memRead(userInfoBase() + paramInt * 4);
/*  500 */     } catch (FaultException localFaultException) { throw new RuntimeException(localFaultException.toString());
/*      */     }
/*      */   }
/*      */   
...
/*  506 */       _execute();
/*      */     } catch (FaultException localFaultException) {
/*  508 */       localFaultException.printStackTrace();
/*  509 */       exit(139, true);
/*  510 */       this.exitException = localFaultException;
/*      */     } catch (ExecutionException localExecutionException) {
/*  512 */       localExecutionException.printStackTrace();
/*  513 */       exit(132, true);
/*  514 */       this.exitException = localExecutionException;
/*      */     }
/*      */   }
/*      */   
...
/*      */     int i;
/*  561 */     int j = i = this.writePages.length * (1 << this.pageShift);
/*      */     int k;
/*  563 */     int m; try { j = k = addStringArray(paramArrayOfString1, j);
...
/*      */     }
/*      */     
/*  580 */     CPUState localCPUState = new CPUState();
/*  581 */     localCPUState.r[4] = k;
/*  582 */     localCPUState.r[5] = m;
/*  583 */     localCPUState.r[29] = j;
/*  584 */     localCPUState.r[31] = -559038737;
/*  585 */     localCPUState.r[28] = gp();
/*  586 */     localCPUState.pc = entryPoint();
/*  587 */     setCPUState(localCPUState);
/*      */     
/*  589 */     this.state = 2;
/*      */     
/*  591 */     _started();
...
/*  605 */     CPUState localCPUState = new CPUState();
/*  606 */     getCPUState(localCPUState);
/*      */     
/*  608 */     int i = localCPUState.r[29];
/*  609 */     int[] arrayOfInt = new int[paramArrayOfObject.length];
/*  610 */     for (int j = 0; j < paramArrayOfObject.length; j++) {
/*  611 */       Object localObject = paramArrayOfObject[j];
/*  612 */       byte[] arrayOfByte = null;
/*  613 */       if ((localObject instanceof String)) {
/*  614 */         arrayOfByte = getBytes((String)localObject);
/*  615 */       } else if ((localObject instanceof byte[])) {
/*  616 */         arrayOfByte = (byte[])localObject;
/*  617 */       } else if ((localObject instanceof Number)) {
/*  618 */         arrayOfInt[j] = ((Number)localObject).intValue();
/*      */       }
...
/*      */       }
/*      */     }
/*  626 */     j = localCPUState.r[29];
/*  627 */     if (j == i) { return call(paramString, arrayOfInt);
/*      */     }
/*  629 */     localCPUState.r[29] = i;
/*  630 */     setCPUState(localCPUState);
/*  631 */     int k = call(paramString, arrayOfInt);
/*  632 */     localCPUState.r[29] = j;
/*  633 */     setCPUState(localCPUState);
/*  634 */     return k;
/*      */   }
/*      */   
/*  637 */   public final int call(String paramString) throws Runtime.CallException { return call(paramString, new int[0]); }
/*  638 */   public final int call(String paramString, int paramInt) throws Runtime.CallException { return call(paramString, new int[] { paramInt }); }
/*  639 */   public final int call(String paramString, int paramInt1, int paramInt2) throws Runtime.CallException { return call(paramString, new int[] { paramInt1, paramInt2 }); }
/*      */   
...
/*  657 */     CPUState localCPUState1 = new CPUState();
/*  658 */     getCPUState(localCPUState1);
/*  659 */     CPUState localCPUState2 = localCPUState1.dup();
/*      */     
/*  661 */     localCPUState2.r[29] &= 0xFFFFFFF0;
/*  662 */     localCPUState2.r[31] = -559038737;
/*  663 */     localCPUState2.r[4] = paramInt2;
/*  664 */     switch (paramArrayOfInt.length) {
/*  665 */     case 7:  localCPUState2.r[19] = paramArrayOfInt[6];
/*  666 */     case 6:  localCPUState2.r[18] = paramArrayOfInt[5];
/*  667 */     case 5:  localCPUState2.r[17] = paramArrayOfInt[4];
/*  668 */     case 4:  localCPUState2.r[16] = paramArrayOfInt[3];
/*  669 */     case 3:  localCPUState2.r[7] = paramArrayOfInt[2];
/*  670 */     case 2:  localCPUState2.r[6] = paramArrayOfInt[1];
/*  671 */     case 1:  localCPUState2.r[5] = paramArrayOfInt[0];
/*      */     }
/*  673 */     localCPUState2.pc = paramInt1;
/*      */     
/*  675 */     this.state = 0;
/*      */     
/*  677 */     setCPUState(localCPUState2);
/*  678 */     __execute();
/*  679 */     getCPUState(localCPUState2);
/*  680 */     setCPUState(localCPUState1);
/*      */     
/*  682 */     if (this.state != 2) throw new CallException("Process exit()ed while servicing a call() request");
/*  683 */     this.state = i;
/*      */     
/*  685 */     return localCPUState2.r[3];
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     }
/*  694 */     for (int i = 0; (i < 64) && (this.fds[i] != null); i++) {}
/*  695 */     if (i == 64) return -1;
/*  696 */     this.fds[i] = paramFD;
/*  697 */     this.closeOnExec[i] = false;
/*  698 */     return i;
/*      */   }
/*      */   
/*      */ 
...
/*  721 */     if (this.fds[paramInt] == null) return -1;
/*  722 */     for (int i = 0; (i < 64) && (this.fds[i] != null); i++) {}
/*  723 */     if (i == 64) return -1;
/*  724 */     this.fds[i] = this.fds[paramInt].dup();
/*  725 */     return i;
/*      */   }
/*      */   
/*      */ 
...
/*      */   {
/*  741 */     if ((paramInt1 & 0xF1F4) != 0)
/*      */     {
/*  743 */       System.err.println("WARNING: Unsupported flags passed to open(\"" + paramFile + "\"): " + toHex(paramInt1 & 0xF1F4));
/*  744 */       throw new ErrnoException(134);
/*      */     }
/*  746 */     boolean bool = (paramInt1 & 0x3) != 0;
/*      */     
/*  748 */     if ((this.sm != null) && (bool ? !this.sm.allowWrite(paramFile) : !this.sm.allowRead(paramFile))) { throw new ErrnoException(13);
/*      */     }
...
/*      */     try
/*      */     {
/*  764 */       localFile = new Seekable.File(paramFile, bool, (paramInt1 & 0x400) != 0);
/*      */     } catch (FileNotFoundException localFileNotFoundException) {
/*  766 */       if ((localFileNotFoundException.getMessage() != null) && (localFileNotFoundException.getMessage().indexOf("Permission denied") >= 0)) throw new ErrnoException(13);
/*  767 */       return null;
/*  768 */     } catch (IOException localIOException2) { throw new ErrnoException(5);
/*      */     }
/*  770 */     new SeekableFD(localFile, paramInt1) { protected Runtime.FStat _fstat() { return Runtime.this.hostFStat(this.val$f, this.val$sf, this.val$data); }
/*      */     }; }
/*      */   
/*  773 */   FStat hostFStat(File paramFile, Seekable.File paramFile1, Object paramObject) { return new HostFStat(paramFile, paramFile1); }
/*      */   
...
/*  789 */     FD localFD = _open(str, paramInt2, paramInt3);
/*  790 */     if (localFD == null) return -2;
/*  791 */     int i = addFD(localFD);
/*  792 */     if (i == -1) { localFD.close();return -23; }
/*  793 */     return i;
/*      */   }
/*      */   
...
/*  807 */       if (localErrnoException.errno == 32) sys_exit(141);
/*  808 */       throw localErrnoException;
/*      */     }
/*      */   }
/*      */   
...
/*      */     }
/*  828 */     Seekable localSeekable = this.fds[paramInt].seekable();
/*  829 */     if ((paramLong < 0L) || (localSeekable == null)) return -22;
/*  830 */     try { localSeekable.resize(paramLong); } catch (IOException localIOException) { return -5; }
/*  831 */     return 0;
/*      */   }
/*      */   
...
/*      */       try {
/*  956 */         for (int i2 = n; i2 < i1; i2++) this.readPages[i2] = (this.writePages[i2] = new int[m]);
/*      */       } catch (OutOfMemoryError localOutOfMemoryError) {
/*  958 */         System.err.println("WARNING: Caught OOM Exception in sbrk: " + localOutOfMemoryError);
/*  959 */         return -12;
/*      */       }
/*      */     }
/*  962 */     this.heapEnd = j;
...
/*      */       int i;
/*      */       try {
/*  978 */         i = this.callJavaCB.call(paramInt1, paramInt2, paramInt3, paramInt4);
/*      */       } catch (RuntimeException localRuntimeException) {
/*  980 */         System.err.println("Error while executing callJavaCB");
/*  981 */         localRuntimeException.printStackTrace();
/*  982 */         i = 0;
/*      */       }
/*  984 */       this.state = 0;
/*  985 */       return i;
...
/* 1010 */     for (int i = 0; i < this.fds.length; i++) if (this.fds[i] != null) closeFD(i);
/* 1011 */     this.state = 4;
/* 1012 */     _exited();
/*      */   }
/*      */   
...
/* 1025 */     FD localFD = this.fds[paramInt1];
/*      */     
/* 1027 */     switch (paramInt2) {
/*      */     case 0: 
/* 1029 */       if ((paramInt3 < 0) || (paramInt3 >= 64)) return -22;
/* 1030 */       for (int i = paramInt3; (i < 64) && (this.fds[i] != null); i++) {}
/* 1031 */       if (i == 64) return -24;
/* 1032 */       this.fds[i] = localFD.dup();
/* 1033 */       return i;
/*      */     case 3: 
/* 1035 */       return localFD.flags();
/*      */     case 2: 
/* 1037 */       this.closeOnExec[paramInt1] = (paramInt3 != 0 ? 1 : false);
/* 1038 */       return 0;
/*      */     case 1: 
/* 1040 */       return this.closeOnExec[paramInt1] != 0 ? 1 : 0;
/*      */     case 7: 
/*      */     case 8: 
...
/* 1054 */     FD localFD = this.fds[paramInt];
/*      */     
/* 1056 */     Seekable localSeekable = localFD.seekable();
/* 1057 */     if (localSeekable == null) return -22;
/*      */     try
/*      */     {
/* 1060 */       localSeekable.sync();
/* 1061 */       return 0;
...
/*      */     {
/*      */ 
/* 1081 */       return -localErrnoException.errno;
/*      */     } catch (FaultException localFaultException) {
/* 1083 */       return -14;
/*      */     } catch (RuntimeException localRuntimeException) {
/* 1085 */       localRuntimeException.printStackTrace();
...
/* 1143 */   public int xrealloc(int paramInt1, int paramInt2) { int i = realloc(paramInt1, paramInt2); if (i == 0) throw new RuntimeException("realloc() failed"); return i; }
/* 1144 */   public int realloc(int paramInt1, int paramInt2) { try { return call("realloc", paramInt1, paramInt2); } catch (CallException localCallException) {} return 0; }
/* 1145 */   public int malloc(int paramInt) { try { return call("malloc", paramInt); } catch (CallException localCallException) {} return 0; }
/* 1146 */   public void free(int paramInt) { try { if (paramInt != 0) call("free", paramInt);
...
/* 1190 */       throw new RuntimeException(localUnsupportedEncodingException);
/*      */     }
/*      */   }
/*      */   
...
/* 1197 */     StringBuffer localStringBuffer = new StringBuffer();
/*      */     for (;;) {
/* 1199 */       int i = memRead(paramInt & 0xFFFFFFFC);
/* 1200 */       switch (paramInt & 0x3) {
/* 1201 */       case 0:  if ((i >>> 24 & 0xFF) == 0) return localStringBuffer.toString(); localStringBuffer.append((char)(i >>> 24 & 0xFF));paramInt++;
/* 1202 */       case 1:  if ((i >>> 16 & 0xFF) == 0) return localStringBuffer.toString(); localStringBuffer.append((char)(i >>> 16 & 0xFF));paramInt++;
/* 1203 */       case 2:  if ((i >>> 8 & 0xFF) == 0) return localStringBuffer.toString(); localStringBuffer.append((char)(i >>> 8 & 0xFF));paramInt++;
/* 1204 */       case 3:  if ((i >>> 0 & 0xFF) == 0) return localStringBuffer.toString(); localStringBuffer.append((char)(i >>> 0 & 0xFF));paramInt++; }
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/* 1215 */     public void setNormalizedPath(String paramString) { this.normalizedPath = paramString; }
/* 1216 */     public String getNormalizedPath() { return this.normalizedPath; }
/*      */     
/* 1218 */     public void markDeleteOnClose() { this.deleteOnClose = true; }
/* 1219 */     public boolean isMarkedForDeleteOnClose() { return this.deleteOnClose; }
/*      */     
/*      */ 
/* 1222 */     public int read(byte[] paramArrayOfByte, int paramInt1, int paramInt2) throws Runtime.ErrnoException { throw new Runtime.ErrnoException(81); }
/*      */     
/* 1224 */     public int write(byte[] paramArrayOfByte, int paramInt1, int paramInt2) throws Runtime.ErrnoException { throw new Runtime.ErrnoException(81); }
/*      */     
/*      */ 
/* 1227 */     public int seek(int paramInt1, int paramInt2) throws Runtime.ErrnoException { return -1; }
/*      */     
/* 1229 */     public int getdents(byte[] paramArrayOfByte, int paramInt1, int paramInt2) throws Runtime.ErrnoException { throw new Runtime.ErrnoException(81); }
/*      */     
/*      */ 
/*      */ 
...
/*      */     
/* 1237 */     public final Runtime.FStat fstat() { if (this.cachedFStat == null) this.cachedFStat = _fstat();
...
/*      */     
/* 1245 */     public final void close() { if (--this.refCount == 0) _close(); }
/*      */     
/*      */     protected void _close() {}
/* 1248 */     FD dup() { this.refCount += 1;return this;
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/* 1256 */     SeekableFD(Seekable paramSeekable, int paramInt) { this.data = paramSeekable;this.flags = paramInt; }
/*      */     
/*      */     protected abstract Runtime.FStat _fstat();
...
/*      */       try {
/* 1265 */         switch (paramInt2) {
/*      */         case 0: 
/*      */           break; case 1:  paramInt1 += this.data.pos(); break;
/* 1268 */         case 2:  paramInt1 += this.data.length(); break;
/* 1269 */         default:  return -1;
/*      */         }
/* 1271 */         this.data.seek(paramInt1);
/* 1272 */         return paramInt1;
/*      */       } catch (IOException localIOException) {
...
/*      */       try {
/* 1283 */         return this.data.write(paramArrayOfByte, paramInt1, paramInt2);
/*      */       } catch (IOException localIOException) {
...
/*      */       try {
/* 1292 */         int i = this.data.read(paramArrayOfByte, paramInt1, paramInt2);
/* 1293 */         return i < 0 ? 0 : i;
/*      */       } catch (IOException localIOException) {
...
/*      */     }
/*      */     
/* 1299 */     protected void _close() { try { this.data.close();
/*      */       } catch (IOException localIOException) {}
/*      */     } }
/*      */   
...
/*      */     
/* 1306 */     public InputOutputStreamFD(InputStream paramInputStream) { this(paramInputStream, null); }
/* 1307 */     public InputOutputStreamFD(OutputStream paramOutputStream) { this(null, paramOutputStream); }
/*      */     
/* 1309 */     public InputOutputStreamFD(InputStream paramInputStream, OutputStream paramOutputStream) { this.is = paramInputStream;
/* 1310 */       this.os = paramOutputStream;
/* 1311 */       if ((paramInputStream == null) && (paramOutputStream == null)) throw new IllegalArgumentException("at least one stream must be supplied");
/*      */     }
/*      */     
/*      */     public int flags() {
...
/*      */     
/*      */     public void _close() {
/* 1322 */       if (this.is != null) try { this.is.close(); } catch (IOException localIOException1) {}
/* 1323 */       if (this.os != null) try { this.os.close();
/*      */         } catch (IOException localIOException2) {}
/*      */     }
/*      */     
/* 1327 */     public int read(byte[] paramArrayOfByte, int paramInt1, int paramInt2) throws Runtime.ErrnoException { if (this.is == null) return super.read(paramArrayOfByte, paramInt1, paramInt2);
/*      */       try {
/* 1329 */         int i = this.is.read(paramArrayOfByte, paramInt1, paramInt2);
/* 1330 */         return i < 0 ? 0 : i;
/*      */       } catch (IOException localIOException) {
...
/*      */     
/*      */     public int write(byte[] paramArrayOfByte, int paramInt1, int paramInt2) throws Runtime.ErrnoException {
/* 1337 */       if (this.os == null) return super.write(paramArrayOfByte, paramInt1, paramInt2);
/*      */       try {
/* 1339 */         this.os.write(paramArrayOfByte, paramInt1, paramInt2);
/* 1340 */         return paramInt2;
/*      */       } catch (IOException localIOException) {
...
/* 1350 */     public TerminalFD(InputStream paramInputStream) { this(paramInputStream, null); }
/* 1351 */     public TerminalFD(OutputStream paramOutputStream) { this(null, paramOutputStream); }
/* 1352 */     public TerminalFD(InputStream paramInputStream, OutputStream paramOutputStream) { super(paramOutputStream); }
/*      */     public void _close() {}
/* 1354 */     public Runtime.FStat _fstat() { new Runtime.SocketFStat() { public int mode() { return 384; } public int type() { return 8192; }
/*      */       }; }
/*      */   }
/*      */   
...
/*      */     
/* 1361 */     public Win32ConsoleIS(InputStream paramInputStream) { this.parent = paramInputStream; }
/*      */     
/* 1363 */     public int read() throws IOException { if (this.pushedBack != -1) { i = this.pushedBack;this.pushedBack = -1;return i; }
/* 1364 */       int i = this.parent.read();
/* 1365 */       if ((i == 13) && ((i = this.parent.read()) != 10)) { this.pushedBack = i;return 13; }
/* 1366 */       return i; }
/*      */     
/*      */     private final InputStream parent;
/* 1369 */     public int read(byte[] paramArrayOfByte, int paramInt1, int paramInt2) throws IOException { int i = 0;
/* 1370 */       if ((this.pushedBack != -1) && (paramInt2 > 0)) {
/* 1371 */         paramArrayOfByte[0] = ((byte)this.pushedBack);
/* 1372 */         this.pushedBack = -1;
/* 1373 */         paramInt1++;paramInt2--;i = 1;
/*      */       }
/* 1375 */       int j = this.parent.read(paramArrayOfByte, paramInt1, paramInt2);
/* 1376 */       if (j == -1) return i != 0 ? 1 : -1;
/* 1377 */       for (int k = 0; k < j; k++) {
/* 1378 */         if (paramArrayOfByte[(paramInt1 + k)] == 13) {
/* 1379 */           if (k == j - 1) {
/* 1380 */             int m = this.parent.read();
/* 1381 */             if (m == 10) paramArrayOfByte[(paramInt1 + k)] = 10; else
/* 1382 */               this.pushedBack = m;
/* 1383 */           } else if (paramArrayOfByte[(paramInt1 + k + 1)] == 10) {
/* 1384 */             System.arraycopy(paramArrayOfByte, paramInt1 + k + 1, paramArrayOfByte, paramInt1 + k, paramInt2 - k - 1);
/* 1385 */             j--;
/*      */           }
/*      */         }
/*      */       }
/* 1389 */       return j + (i != 0 ? 1 : 0);
/*      */     }
/*      */   }
/*      */   
...
/*      */   
/* 1417 */   public static class SocketFStat extends Runtime.FStat { public int dev() { return -1; }
...
/*      */     
/* 1426 */     public HostFStat(File paramFile, Seekable.File paramFile1) { this(paramFile, paramFile1, false); }
/* 1427 */     public HostFStat(File paramFile, boolean paramBoolean) { this(paramFile, null, paramBoolean); }
/*      */     
/* 1429 */     public HostFStat(File paramFile, Seekable.File paramFile1, boolean paramBoolean) { this.f = paramFile;
/* 1430 */       this.sf = paramFile1;
/* 1431 */       this.executable = paramBoolean; }
/*      */     
...
/*      */     
/*      */     public int size() {
/* 1447 */       try { return this.sf != null ? this.sf.length() : (int)this.f.length();
...
/* 1457 */     public ReadFaultException(int paramInt) { super(); }
/*      */   }
/*      */   
/* 1460 */   public static class WriteFaultException extends Runtime.FaultException { public WriteFaultException(int paramInt) { super(); } }
/*      */   
...
/*      */     
/* 1465 */     public FaultException(int paramInt) { super();this.addr = paramInt;this.cause = null; }
/* 1466 */     public FaultException(RuntimeException paramRuntimeException) { super();this.addr = -1;this.cause = paramRuntimeException; } }
/*      */   
...
/*      */     
/* 1472 */     public ExecutionException(String paramString) { if (paramString != null) this.message = paramString; }
/* 1473 */     void setLocation(String paramString) { this.location = (paramString == null ? "(unknown)" : paramString); }
/* 1474 */     public final String getMessage() { return this.message + " at " + this.location; }
/*      */   }
/*      */   
/* 1477 */   public static class CallException extends Exception { public CallException(String paramString) { super(); }
/*      */   }
/*      */   
/*      */   protected static class ErrnoException extends Exception { public int errno;
/*      */     
/* 1482 */     public ErrnoException(int paramInt) { super();this.errno = paramInt;
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */     public int pc;
/*      */     
/* 1497 */     public CPUState dup() { CPUState localCPUState = new CPUState();
/* 1498 */       localCPUState.hi = this.hi;
/* 1499 */       localCPUState.lo = this.lo;
/* 1500 */       localCPUState.fcsr = this.fcsr;
/* 1501 */       localCPUState.pc = this.pc;
/* 1502 */       for (int i = 0; i < 32; i++) {
/* 1503 */         localCPUState.r[i] = this.r[i];
/* 1504 */         localCPUState.f[i] = this.f[i];
/*      */       }
/* 1506 */       return localCPUState;
/*      */     }
/*      */   }
/*      */   
/*      */   public static class SecurityManager {
/* 1511 */     public boolean allowRead(File paramFile) { return true; }
/* 1512 */     public boolean allowWrite(File paramFile) { return true; }
/* 1513 */     public boolean allowStat(File paramFile) { return true; }
/* 1514 */     public boolean allowUnlink(File paramFile) { return true; }
/*      */   }
/*      */   
...
/* 1536 */     int i = 0;int j = 0;
/* 1537 */     int k = 0; for (int m = 0; m < paramInt; k += 8) {
/* 1538 */       long l = 0L;
/* 1539 */       for (int n = 0; n < 8; n++) { l <<= 7;l |= paramString.charAt(k + n) & 0x7F; }
/* 1540 */       if (j > 0) arrayOfInt[(m++)] = (i | (int)(l >>> 56 - j));
/* 1541 */       if (m < paramInt) arrayOfInt[(m++)] = ((int)(l >>> 24 - j));
/* 1542 */       j = j + 8 & 0x1F;
/* 1543 */       i = (int)(l << j);
/*      */     }
...
/*      */   }
/*      */   
/* 1563 */   static final String toHex(int paramInt) { return "0x" + Long.toString(paramInt & 0xFFFFFFFF, 16); }
/* 1564 */   static final int min(int paramInt1, int paramInt2) { return paramInt1 < paramInt2 ? paramInt1 : paramInt2; }
/* 1565 */   static final int max(int paramInt1, int paramInt2) { return paramInt1 > paramInt2 ? paramInt1 : paramInt2; }
/*      */   

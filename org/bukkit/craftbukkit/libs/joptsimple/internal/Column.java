...
/*     */ public class Column
/*     */ {
/*  43 */   static final Comparator<Column> BY_HEIGHT = new Comparator() {
...
/*     */     
/*  79 */     int start = words.first();
/*  80 */     for (int end = words.next(); end != -1; end = words.next()) {
/*  81 */       nextCell = processNextWord(line, nextCell, start, end);start = end;
/*     */     }
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\libs\joptsimple\internal\Column.class

...
/*     */   HelpFormatter()
/*     */   {
/*  50 */     this.grid = new ColumnarData(new String[] { "Option", "Description" });
/*     */   }
/*     */   
...
/*  57 */     this.grid.clear();
/*     */     
/*  59 */     Comparator<AbstractOptionSpec<?>> comparator = new Comparator()
/*     */     {
...
/*     */       
/*  65 */     };
/*  66 */     Set<AbstractOptionSpec<?>> sorted = new TreeSet(comparator);
...
/*     */     }
/* 109 */     String helpLine = ' ' + Strings.surround(collector.toString(), begin, end);
/*     */     
/*     */ 
...
/* 136 */     return spec.description() + ' ' + Strings.surround(new StringBuilder().append("default: ").append(defaultValuesDisplay).toString(), '(', ')');
/*     */   }
/*     */   
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\libs\joptsimple\HelpFormatter.class

...
/*     */   {
/* 190 */     if ((this.playerOnlyMessage != null) && (!(forWhom instanceof Player))) {
/* 191 */       return new Conversation(this.plugin, forWhom, new NotPlayerMessagePrompt(null));
/*     */     }
/*     */     
/*     */ 
/* 195 */     Map<Object, Object> copiedInitialSessionData = new HashMap();
...
/*     */     
/* 220 */     public String getPromptText(ConversationContext context) { return ConversationFactory.this.playerOnlyMessage; }
/*     */     
/*     */ 
...
/* Location:              C:\Users\USUARIO\Desktop\spigot-1.8.8-R0.1-SNAPSHOT-latest.jar!\org\bukkit\conversations\ConversationFactory.class
